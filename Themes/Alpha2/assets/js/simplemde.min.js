...
!function (e) {
    ...
    return function t(e, n, r) {
                    ...
                    CodeMirror.defineMode("spell-checker", function (e, t) {
                        if (!o) {
                            ...
                            n.open("GET", "https://cdn.jsdelivr.net/codemirror.spell-checker/latest/en_US.aff", !0), n.onload = function (e) {
                                4 === n.readyState && 200 === n.status && (a = n.responseText, i++, 2 == i && (r = new Typo("en_US", a, s, {platform: "any"})))
                            }, n.send(null)
                        }
                        if (!l) {
                            l = !0;
                            ...
                            c.open("GET", "https://cdn.jsdelivr.net/codemirror.spell-checker/latest/en_US.dic", !0), c.onload = function (e) {
                                4 === c.readyState && 200 === c.status && (s = c.responseText, i++, 2 == i && (r = new Typo("en_US", a, s, {platform: "any"})))
                            }, c.send(null)
                        }
                        var u = '!"#$%&()*+,-./:;<=>?@[\\]^_`{|}~ ', d = {
                            token: function (e, t) {
                ...
                (function (e, t, n, r, i) {
                    ...
                    var o = function (e, t, n, r) {
                        if (r = r || {}, this.platform = r.platform || "chrome", this.dictionary = null, this.rules = {}, this.dictionaryTable = {}, this.compoundRules = [], this.compoundRuleCodes = {}, this.replacementTable = [], this.flags = r.flags || {}, e) {
                            if (this.dictionary = e, "chrome" == this.platform)t || (t = this._readFile(chrome.extension.getURL("lib/typo/dictionaries/" + e + "/" + e + ".aff"))), n || (n = this._readFile(chrome.extension.getURL("lib/typo/dictionaries/" + e + "/" + e + ".dic"))); else {
                            ...
                            for (var o = 0, l = this.compoundRules.length; l > o; o++)for (var a = this.compoundRules[o], s = 0, c = a.length; c > s; s++)this.compoundRuleCodes[a[s]] = [];
                        ...
                        load: function (e) {
                            ...
                            for (var n = e.split("\n"), r = 0, i = n.length; i > r; r++) {
                                ...
                                if ("PFX" == a || "SFX" == a) {
                                    ...
                                    t[s] = {type: a, combineable: "Y" == c, entries: d}, r += u
                            ...
                            for (var n = e.split("\n"), r = {}, i = 1, o = n.length; o > i; i++) {
                                ...
                                if (a.length > 1) {
                                    ...
                                    for (var u = 0, d = c.length; d > u; u++) {
                                        ...
                                        if (f)for (var p = this._applyRule(s, f), m = 0, g = p.length; g > m; m++) {
                                            var v = p[m];
                                            if (t(v, []), f.combineable)for (var y = u + 1; d > y; y++) {
                                                var x = c[y], b = this.rules[x];
                                                if (b && b.combineable && f.type != b.type)for (var w = this._applyRule(v, b), k = 0, C = w.length; C > k; k++) {
                                                    var S = w[k];
                                                    t(S, [])
                                                }
                                            }
                            ...
                            for (var n = t.entries, r = [], i = 0, o = n.length; o > i; i++) {
                                ...
                                if (!l.match || e.match(l.match)) {
                                    var a = e;
                                    if (l.remove && (a = a.replace(l.remove, "")), "SFX" === t.type ? a += l.add : a = l.add + a, r.push(a), "continuationClasses" in l)for (var s = 0, c = l.continuationClasses.length; c > s; s++) {
            ...
            !function (i) {
                ...
                e.commands.newlineAndIndentContinueMarkdownList = function (i) {
                    ...
                    for (var o = i.listSelections(), l = [], a = 0; a < o.length; a++) {
                        var s = o[a].head, c = i.getStateAfter(s.line), u = c.list !== !1, d = 0 !== c.quote, h = i.getLine(s.line), f = t.exec(h);
                        if (!o[a].empty() || !u && !d || !f)return void i.execCommand("newlineAndIndent");
                        if (n.test(h))i.replaceRange("", {line: s.line, ch: 0}, {
                            line: s.line,
                            ch: s.ch + 1
                        }), l[a] = "\n"; else {
                            var p = f[1], m = f[5], g = r.test(f[2]) || f[2].indexOf(">") >= 0 ? f[2] : parseInt(f[3], 10) + 1 + f[4];
                            l[a] = "\n" + p + g + m
                        }
                    }
        ...
        6: [function (t, n, r) {
            !function (t) {
                ...
                function e(n, r) {
                    ...
                    this.options = r = r ? Fi(r) : {}, Fi(el, r, !1), f(r);
                    var i = r.value;
                    "string" == typeof i && (i = new Sl(i, r.mode, null, r.lineSeparator)), this.doc = i;
                    var o = new e.inputStyles[r.inputStyle](this), l = this.display = new t(n, i, o);
                    l.wrapper.CodeMirror = this, c(this), a(this), r.lineWrapping && (this.display.wrapper.className += " CodeMirror-wrap"), r.autofocus && !Oo && l.input.focus(), v(this), this.state = {
                        keyMaps: [],
                        overlays: [],
                        modeGen: 0,
                        overwrite: !1,
                    ...
                    }, 20), qt(this), Yi(), wt(this), this.curOp.forceUpdate = !0, Zr(this, i), r.autofocus && !Oo || s.hasFocus() ? setTimeout(Ri(yn, this), 20) : xn(this);
                    for (var u in tl)tl.hasOwnProperty(u) && tl[u](this, r[u], nl);
                    k(this), r.finishInit && r.finishInit(this);
                    for (var d = 0; d < ll.length; ++d)ll[d](this);
                    Ct(this), ko && r.lineWrapping && "optimizelegibility" == getComputedStyle(l.lineDiv).textRendering && (l.lineDiv.style.textRendering = "auto")
                }
                ...
                function i(e) {
                    e.options.lineWrapping ? (Ql(e.display.wrapper, "CodeMirror-wrap"), e.display.sizer.style.minWidth = "", e.display.sizerWidth = null) : (Zl(e.display.wrapper, "CodeMirror-wrap"), h(e)), l(e), Pt(e), st(e), setTimeout(function () {
                        y(e)
                    }, 100)
                }

                function o(e) {
                    var t = xt(e.display), n = e.options.lineWrapping, r = n && Math.max(5, e.display.scroller.clientWidth / bt(e.display) - 3);
                    return function (i) {
                ...
                function c(e) {
                    ...
                    for (var r = 0; r < n.length; ++r) {
                        var i = n[r], o = t.appendChild(qi("div", null, "CodeMirror-gutter " + i));
                ...
                function p(e) {
                    var t = e.display, n = t.gutters.offsetWidth, r = Math.round(e.doc.height + Ue(e.display));
                    return {
                ...
                function m(e, t, n) {
                    this.cm = n;
                    var r = this.vert = qi("div", [qi("div", null, null, "min-width: 1px")], "CodeMirror-vscrollbar"), i = this.horiz = qi("div", [qi("div", null, null, "height: 100%; min-height: 1px")], "CodeMirror-hscrollbar");
                ...
                function v(t) {
                    t.display.scrollbars && (t.display.scrollbars.clear(), t.display.scrollbars.addClass && Zl(t.display.wrapper, t.display.scrollbars.addClass)), t.display.scrollbars = new e.scrollbarModel[t.options.scrollbarStyle](function (e) {
                        ...
                        "horizontal" == n ? ln(t, e) : on(t, e)
                    }, t), t.display.scrollbars.addClass && Ql(t.display.wrapper, t.display.scrollbars.addClass)
                }
                ...
                function b(e, t, n) {
                    ...
                    r = Math.floor(r - Ge(e));
                    var i = n && null != n.bottom ? n.bottom : r + e.wrapper.clientHeight, o = ri(t, r), l = ri(t, i);
                    if (n && n.ensure) {
                        var a = n.ensure.from.line, s = n.ensure.to.line;
                        o > a ? (o = a, l = ri(t, ii(Qr(t, a)) + e.wrapper.clientHeight)) : Math.min(s, t.lastLine()) >= l && (o = ri(t, ii(Qr(t, s)) - e.wrapper.clientHeight), l = s)
                    }
                ...
                function k(e) {
                    ...
                    if (n.length != r.lineNumChars) {
                        var i = r.measure.appendChild(qi("div", [qi("div", n)], "CodeMirror-linenumber CodeMirror-gutter-elt")), o = i.firstChild.offsetWidth, l = i.offsetWidth - o;
                ...
                function L(e, t, n) {
                    var r = e.display;
                    this.viewport = t, this.visible = b(r, e.doc, t), this.editorIsHidden = !r.wrapper.offsetWidth, this.wrapperHeight = r.wrapper.clientHeight, this.wrapperWidth = r.wrapper.clientWidth, this.oldDisplayWidth = Ke(e), this.force = n, this.dims = D(e), this.events = []
                }
                ...
                function M(e, t) {
                    ...
                    n.viewFrom < o && o - n.viewFrom < 20 && (o = Math.max(r.first, n.viewFrom)), n.viewTo > l && n.viewTo - l < 20 && (l = Math.min(i, n.viewTo)), zo && (o = wr(e.doc, o), l = kr(e.doc, l));
                    var a = o != n.viewFrom || l != n.viewTo || n.lastWrapHeight != t.wrapperHeight || n.lastWrapWidth != t.wrapperWidth;
                    _t(e, o, l), n.viewOffset = ii(Qr(e.doc, n.viewFrom)), e.display.mover.style.top = n.viewOffset + "px";
                    var s = jt(e);
                    if (!a && 0 == s && !t.force && n.renderedView == n.view && (null == n.updateLineNumbers || n.updateLineNumbers >= n.viewTo))return !1;
                    var c = $i();
                    return s > 4 && (n.lineDiv.style.display = "none"), E(e, n.updateLineNumbers, t.dims), s > 4 && (n.lineDiv.style.display = ""), n.renderedView = n.view, c && $i() != c && c.offsetHeight && c.focus(), Gi(n.cursorDiv), Gi(n.selectionDiv), n.gutters.style.height = n.sizer.style.minHeight = 0, a && (n.lastWrapHeight = t.wrapperHeight, n.lastWrapWidth = t.wrapperWidth, Be(e, 400)), n.updateLineNumbers = null, !0
                }

                function N(e, t) {
                    for (var n = t.viewport, r = !0; (r && e.options.lineWrapping && t.oldDisplayWidth != Ke(e) || (n && null != n.top && (n = {top: Math.min(e.doc.height + Ue(e.display) - Xe(e), n.top)}), t.visible = b(e.display, e.doc, n), !(t.visible.from >= e.display.viewFrom && t.visible.to <= e.display.viewTo))) && M(e, t); r = !1) {
                        W(e);
                        var i = p(e);
                        Ie(e), O(e, i), y(e, i)
                    }
                ...
                function W(e) {
                    for (var t = e.display, n = t.lineDiv.offsetTop, r = 0; r < t.view.length; r++) {
                        ...
                        if (!o.hidden) {
                            ...
                            if (2 > i && (i = xt(t)), (s > .001 || -.001 > s) && (ti(o.line, i), H(o.line), o.rest))for (var c = 0; c < o.rest.length; c++)H(o.rest[c])
                        }
                    }
                }
                ...
                function E(e, t, n) {
                    function r(t) {
                        var n = t.nextSibling;
                        return ko && Wo && e.display.currentWheelTarget == t ? t.style.display = "none" : t.parentNode.removeChild(t), n
                    }

                    for (var i = e.display, o = e.options.lineNumbers, l = i.lineDiv, a = l.firstChild, s = i.view, c = i.viewFrom, u = 0; u < s.length; u++) {
                        var d = s[u];
                        if (d.hidden); else if (d.node && d.node.parentNode == l) {
                            for (; a != d.node;)a = r(a);
                            var h = o && null != t && c >= t && d.lineNumber;
                            d.changes && (Ei(d.changes, "gutter") > -1 && (h = !1), I(e, d, c, n)), h && (Gi(d.lineNumber), d.lineNumber.appendChild(document.createTextNode(C(e.options, c)))), a = d.node.nextSibling
                        } else {
                            var f = q(e, d, c, n);
                            l.insertBefore(f, a)
                        }
                ...
                function P(e) {
                    return e.node == e.text && (e.node = qi("div", null, null, "position: relative"), e.text.parentNode && e.text.parentNode.replaceChild(e.node, e.text), e.node.appendChild(e.text), bo && 8 > wo && (e.node.style.zIndex = 2)), e.node
                }
                ...
                function F(e, t) {
                    ...
                    return n && n.line == t.line ? (e.display.externalMeasured = null, t.measure = n.measure, n.built) : Rr(e, t)
                }

                function R(e, t) {
                    var n = t.text.className, r = F(e, t);
                ...
                function _(e, t, n, r) {
                    ...
                    if (e.options.lineNumbers || o) {
                        var i = P(t), l = t.gutter = qi("div", null, "CodeMirror-gutter-wrapper", "left: " + (e.options.fixedGutter ? r.fixedPos : -r.gutterTotalWidth) + "px");
                        if (e.display.input.setUneditable(l), i.insertBefore(l, t.text), t.line.gutterClass && (l.className += " " + t.line.gutterClass), !e.options.lineNumbers || o && o["CodeMirror-linenumbers"] || (t.lineNumber = l.appendChild(qi("div", C(e.options, n), "CodeMirror-linenumber CodeMirror-gutter-elt", "left: " + r.gutterLeft["CodeMirror-linenumbers"] + "px; width: " + e.display.lineNumInnerWidth + "px"))), o)for (var a = 0; a < e.options.gutters.length; ++a) {
                            var s = e.options.gutters[a], c = o.hasOwnProperty(s) && o[s];
                            c && l.appendChild(qi("div", [c], "CodeMirror-gutter-elt", "left: " + r.gutterLeft[s] + "px; width: " + r.gutterWidth[s] + "px"))
                        }
                    }
                }
                ...
                function U(e, t, n, r, i) {
                    if (t.widgets)for (var o = P(n), l = 0, a = t.widgets; l < a.length; ++l) {
                        var s = a[l], c = qi("div", [s.node], "CodeMirror-linewidget");
                        s.handleMouseEvents || c.setAttribute("cm-ignore-events", "true"), $(s, c, n, r), e.display.input.setUneditable(c), i && s.above ? o.insertBefore(c, n.gutter || n.text) : o.appendChild(c), Li(s, "redraw")
                    }
                }
                ...
                function Q(e, t, n, r, i) {
                    ...
                    if (l && r.ranges.length > 1)if (Bo && Bo.join("\n") == t) {
                        if (r.ranges.length % Bo.length == 0) {
                            s = [];
                            for (var c = 0; c < Bo.length; c++)s.push(o.splitLines(Bo[c]))
                        }
                    } else a.length == r.ranges.length && (s = Ii(a, function (e) {
                        return [e]
                    }));
                    for (var c = r.ranges.length - 1; c >= 0; c--) {
                        var u = r.ranges[c], d = u.from(), h = u.to();
                        u.empty() && (n && n > 0 ? d = Fo(d.line, d.ch - n) : e.state.overwrite && !l && (h = Fo(h.line, Math.min(Qr(o, h.line).text.length, h.ch + Di(a).length))));
                        ...
                        Mn(e.doc, p), Li(e, "inputRead", e, p)
                    }
                    t && !l && ee(e, t), Rn(e), e.curOp.updateInput = f, e.curOp.typing = !0, e.state.pasteIncoming = e.state.cutIncoming = !1
                }

                function J(e, t) {
                    var n = e.clipboardData && e.clipboardData.getData("text/plain");
                    return n ? (e.preventDefault(), Z(t) || t.options.disableInput || Ot(t, function () {
                        Q(t, n, 0, null, "paste")
                    }), !0) : void 0
                }
                ...
                function ee(e, t) {
                    if (e.options.electricChars && e.options.smartIndent)for (var n = e.doc.sel, r = n.ranges.length - 1; r >= 0; r--) {
                        ...
                        if (!(i.head.ch > 100 || r && n.ranges[r - 1].head.line == i.head.line)) {
                            ...
                            } else o.electricInput && o.electricInput.test(Qr(e.doc, i.head.line).text.slice(0, i.head.ch)) && (l = _n(e, i.head.line, "smart"));
                ...
                function te(e) {
                    for (var t = [], n = [], r = 0; r < e.doc.sel.ranges.length; r++) {
                        var i = e.doc.sel.ranges[r].head.line, o = {anchor: Fo(i, 0), head: Fo(i + 1, 0)};
                ...
                function re(e) {
                    this.cm = e, this.prevInput = "", this.pollingFast = !1, this.polling = new Wi, this.inaccurateSelection = !1, this.hasSelection = !1, this.composing = null
                }

                function ie() {
                    var e = qi("textarea", null, null, "position: absolute; padding: 0; width: 1px; height: 1em; outline: none"), t = qi("div", [e], null, "overflow: hidden; position: relative; width: 3px; height: 0px;");
                    return ko ? e.style.width = "1000px" : e.setAttribute("wrap", "off"), Ao && (e.style.border = "1px solid black"), ne(e), t
                }

                function oe(e) {
                    this.cm = e, this.lastAnchorNode = this.lastAnchorOffset = this.lastFocusNode = this.lastFocusOffset = null, this.polling = new Wi, this.gracePeriod = !1
                }

                function le(e, t) {
                    var n = et(e, t.line);
                    if (!n || n.hidden)return null;
                    var r = Qr(e.doc, t.line), i = Ze(n, r, t.line), o = oi(r), l = "left";
                    if (o) {
                        var a = uo(o, t.ch);
                        l = a % 2 ? "right" : "left"
                    }
                    var s = rt(i.map, t.ch, l);
                ...
                function se(e, t, n) {
                    ...
                    if (t == e.display.lineDiv) {
                        if (r = e.display.lineDiv.childNodes[n], !r)return ae(e.clipPos(Fo(e.display.viewTo - 1)), !0);
                        t = null, n = 0
                ...
                function ce(e, t, n) {
                    function r(t, n, r) {
                        for (var i = -1; i < (u ? u.length : 0); i++)for (var o = 0 > i ? c.map : u[i], l = 0; l < o.length; l += 3) {
                            var a = o[l + 2];
                            if (a == t || a == n) {
                                var s = ni(0 > i ? e.line : e.rest[i]), d = o[l] + r;
                    ...
                    if (!t || !Kl(i, t))return ae(Fo(ni(e.line), 0), !0);
                    if (t == i && (o = !0, t = i.childNodes[n], n = 0, !t)) {
                        var l = e.rest ? Di(e.rest) : e.line;
                        return ae(Fo(ni(l), l.text.length), o)
                    }
                ...
                function fe(e, t) {
                    ...
                    for (var r = 1; r < e.length; r++) {
                        var i = e[r], o = e[r - 1];
                        if (Ro(o.to(), i.from()) >= 0) {
                            var l = X(o.from(), i.from()), a = K(o.to(), i.to()), s = o.empty() ? i.from() == i.head : o.from() == o.head;
                ...
                function ge(e, t) {
                    ...
                    return t.line > n ? Fo(n, Qr(e, n).text.length) : ve(t, Qr(e, t.line).text.length)
                }
                ...
                function be(e, t, n, r) {
                    if (e.cm && e.cm.display.shift || e.extend) {
                        ...
                        if (r) {
                            var o = Ro(n, i) < 0;
                            o != Ro(r, i) < 0 ? (i = n, n = r) : o != Ro(n, r) < 0 && (n = r)
                        }
                        return new he(i, n)
                    }
                    return new he(r || n, n)
                ...
                function Te(e, t, n) {
                    var r = e.history.done, i = Di(r);
                    i && i.ranges ? (r[r.length - 1] = t, Ne(e, t, n)) : Me(e, t, n)
                }

                function Me(e, t, n) {
                    Ne(e, t, n), hi(e, e.sel, e.cm ? e.cm.curOp.id : NaN, n)
                }

                function Ne(e, t, n) {
                    (Ai(e, "beforeSelectionChange") || e.cm && Ai(e.cm, "beforeSelectionChange")) && (t = Le(e, t));
                    var r = n && n.bias || (Ro(t.primary().head, e.sel.primary().head) < 0 ? -1 : 1);
                    Ae(e, We(e, t, r, !0)), n && n.scroll === !1 || !e.cm || Rn(e.cm)
                }

                function Ae(e, t) {
                    t.equals(e.sel) || (e.sel = t, e.cm && (e.cm.curOp.updateInput = e.cm.curOp.selectionChanged = !0, Ni(e.cm)), Li(e, "cursorActivity", e))
                }

                function Oe(e) {
                    Ae(e, We(e, e.sel, null, !1), zl)
                }

                function We(e, t, n, r) {
                    for (var i, o = 0; o < t.ranges.length; o++) {
                        var l = t.ranges[o], a = t.ranges.length == e.sel.ranges.length && e.sel.ranges[o], s = De(e, l.anchor, a && a.anchor, n, r), c = De(e, l.head, a && a.head, n, r);
                        (i || s != l.anchor || c != l.head) && (i || (i = t.ranges.slice(0, o)), i[o] = new he(s, c))
                    }
                ...
                function He(e, t, n, r, i) {
                    ...
                    if (o.markedSpans)for (var l = 0; l < o.markedSpans.length; ++l) {
                        ...
                        if ((null == a.from || (s.inclusiveLeft ? a.from <= t.ch : a.from < t.ch)) && (null == a.to || (s.inclusiveRight ? a.to >= t.ch : a.to > t.ch))) {
                            if (i && (Dl(s, "beforeCursorEnter"), s.explicitlyCleared)) {
                                if (o.markedSpans) {
                                    --l;
                                    continue
                                }
                            ...
                            if (n) {
                                ...
                                if ((0 > r ? s.inclusiveRight : s.inclusiveLeft) && (u = Ee(e, u, -r, o)), u && u.line == t.line && (c = Ro(u, n)) && (0 > r ? 0 > c : c > 0))return He(e, u, t, r, i)
                            }
                            var d = s.find(0 > r ? -1 : 1);
                            return (0 > r ? s.inclusiveLeft : s.inclusiveRight) && (d = Ee(e, d, r, o)), d ? He(e, d, t, r, i) : null
                        }
                    }
                    return t
                }
                ...
                function De(e, t, n, r, i) {
                    var o = r || 1, l = He(e, t, n, o, i) || !i && He(e, t, n, o, !0) || He(e, t, n, -o, i) || !i && He(e, t, n, -o, !0);
                    return l ? l : (e.cantEdit = !0, Fo(e.first, 0))
                }

                function Ee(e, t, n, r) {
                    return 0 > n && 0 == t.ch ? t.line > e.first ? ge(e, Fo(t.line - 1)) : null : n > 0 && t.ch == (r || Qr(e, t.line)).text.length ? t.line < e.first + e.size - 1 ? Fo(t.line + 1, 0) : null : new Fo(t.line, t.ch + n)
                }
                ...
                function Pe(e, t) {
                    for (var n = e.doc, r = {}, i = r.cursors = document.createDocumentFragment(), o = r.selection = document.createDocumentFragment(), l = 0; l < n.sel.ranges.length; l++)if (t !== !1 || l != n.sel.primIndex) {
                        ...
                        (s || e.options.showCursorWhenSelecting) && ze(e, a.head, i), s || Fe(e, a, o)
                    }
                    return r
                }

                function ze(e, t, n) {
                    var r = pt(e, t, "div", null, null, !e.options.singleCursorHeightPerLine), i = n.appendChild(qi("div", " ", "CodeMirror-cursor"));
                ...
                function Fe(e, t, n) {
                    function r(e, t, n, r) {
                        0 > t && (t = 0), t = Math.round(t), r = Math.round(r), a.appendChild(qi("div", null, "CodeMirror-selected", "position: absolute; left: " + e + "px; top: " + t + "px; width: " + (null == n ? u - e : n) + "px; height: " + (r - t) + "px"))
                    }

                    function i(t, n, i) {
                        function o(n, r) {
                            return ft(e, Fo(t, n), "div", d, r)
                        }

                        var a, s, d = Qr(l, t), h = d.text.length;
                        return to(oi(d), n || 0, null == i ? h : i, function (e, t, l) {
                    ...
                    var o = e.display, l = e.doc, a = document.createDocumentFragment(), s = $e(e.display), c = s.left, u = Math.max(o.sizerWidth, Ke(e) - o.sizer.offsetLeft) - s.right, d = t.from(), h = t.to();
                    if (d.line == h.line)i(d.line, d.ch, h.ch); else {
                        var f = Qr(l, d.line), p = Qr(l, h.line), m = xr(f) == xr(p), g = i(d.line, d.ch, m ? f.text.length + 1 : null).end, v = i(h.line, m ? 0 : null, h.ch).start;
                ...
                function Be(e, t) {
                    e.doc.mode.startState && e.doc.frontier < e.display.viewTo && e.state.highlight.set(t, Ri(_e, e))
                }

                function _e(e) {
                    var t = e.doc;
                    if (t.frontier < t.first && (t.frontier = t.first), !(t.frontier >= e.display.viewTo)) {
                        var n = +new Date + e.options.workTime, r = sl(t.mode, qe(e, t.frontier)), i = [];
                        t.iter(t.frontier, Math.min(t.first + t.size, e.display.viewTo + 500), function (o) {
                            if (t.frontier >= e.display.viewFrom) {
                                var l = o.styles, a = o.text.length > e.options.maxHighlightLength, s = Ir(e, o, a ? sl(t.mode, r) : r, !0);
                                o.styles = s.styles;
                                ...
                                d && i.push(t.frontier), o.stateAfter = a ? r : sl(t.mode, r)
                            } else o.text.length <= e.options.maxHighlightLength && zr(e, o.text, r), o.stateAfter = t.frontier % 5 == 0 ? sl(t.mode, r) : null;
                            return ++t.frontier, +new Date > n ? (Be(e, e.options.workDelay), !0) : void 0
                ...
                function je(e, t, n) {
                    for (var r, i, o = e.doc, l = n ? -1 : t - (e.doc.mode.innerMode ? 1e3 : 100), a = t; a > l; --a) {
                        ...
                        var c = Bl(s.text, null, e.options.tabSize);
                ...
                function qe(e, t, n) {
                    ...
                    var o = je(e, t, n), l = o > r.first && Qr(r, o - 1).stateAfter;
                    return l = l ? sl(r.mode, l) : cl(r.mode), r.iter(o, t, function (n) {
                        zr(e, n.text, l);
                        var a = o == t - 1 || o % 5 == 0 || o >= i.viewFrom && o < i.viewTo;
                        n.stateAfter = a ? sl(r.mode, l) : null, ++o
                    }), n && (r.frontier = o), l
                }
                ...
                function $e(e) {
                    ...
                    var t = Ui(e.measure, qi("pre", "x")), n = window.getComputedStyle ? window.getComputedStyle(t) : t.currentStyle, r = {
                ...
                function Ze(e, t, n) {
                    ...
                    for (var r = 0; r < e.rest.length; r++)if (ni(e.rest[r]) > n)return {
                        map: e.measure.maps[r],
                        cache: e.measure.caches[r],
                        before: !0
                    }
                ...
                function Qe(e, t) {
                    t = xr(t);
                    var n = ni(t), r = e.display.externalMeasured = new Et(e.doc, t, n);
                    r.lineN = n;
                    var i = r.built = Rr(e, r);
                    return r.text = i.pre, Ui(e.display.lineMeasure, i.pre), r
                }

                function Je(e, t, n, r) {
                    return nt(e, tt(e, t), n, r)
                }
                ...
                function tt(e, t) {
                    var n = ni(t), r = et(e, n);
                    r && !r.text ? r = null : r && r.changes && (I(e, r, n, D(e)), e.curOp.forceUpdate = !0), r || (r = Qe(e, t));
                    var i = Ze(r, t, n);
                ...
                function nt(e, t, n, r, i) {
                    t.before && (n = -1);
                    var o, l = n + (r || "");
                    return t.cache.hasOwnProperty(l) ? o = t.cache[l] : (t.rect || (t.rect = t.view.text.getBoundingClientRect()), t.hasHeights || (Ye(e, t.view, t.rect), t.hasHeights = !0), o = it(e, t, n, r), o.bogus || (t.cache[l] = o)), {
                        left: o.left,
                        right: o.right,
                        top: i ? o.rtop : o.top,
                ...
                function rt(e, t, n) {
                    for (var r, i, o, l, a = 0; a < e.length; a += 3) {
                        ...
                        if (s > t ? (i = 0, o = 1, l = "left") : c > t ? (i = t - s, o = i + 1) : (a == e.length - 3 || t == c && e[a + 3] > t) && (o = c - s, i = o - 1, t >= c && (l = "right")), null != i) {
                            if (r = e[a + 2], s == c && n == (r.insertLeft ? "left" : "right") && (l = n), "left" == n && 0 == i)for (; a && e[a - 2] == e[a - 3] && e[a - 1].insertLeft;)r = e[(a -= 3) + 2], l = "left";
                            if ("right" == n && i == c - s)for (; a < e.length - 3 && e[a + 3] == e[a + 4] && !e[a + 5].insertLeft;)r = e[(a += 3) + 2], l = "right";
                            break
                        }
                    }
                    return {node: r, start: i, end: o, collapse: l, coverStart: s, coverEnd: c}
                }

                function it(e, t, n, r) {
                    var i, o = rt(t.map, n, r), l = o.node, a = o.start, s = o.end, c = o.collapse;
                    if (3 == l.nodeType) {
                        for (var u = 0; 4 > u; u++) {
                            for (; a && ji(t.line.text.charAt(o.coverStart + a));)--a;
                            for (; o.coverStart + s < o.coverEnd && ji(t.line.text.charAt(o.coverStart + s));)++s;
                            if (bo && 9 > wo && 0 == a && s == o.coverEnd - o.coverStart)i = l.parentNode.getBoundingClientRect(); else if (bo && e.options.lineWrapping) {
                                var d = Gl(l, a, s).getClientRects();
                                i = d.length ? d["right" == r ? d.length - 1 : 0] : Go
                            } else i = Gl(l, a, s).getBoundingClientRect() || Go;
                            if (i.left || i.right || 0 == a)break;
                            s = a, a -= 1, c = "right"
                        }
                        bo && 11 > wo && (i = ot(e.display.measure, i))
                    } else {
                        a > 0 && (c = r = "right");
                        var d;
                        i = e.options.lineWrapping && (d = l.getClientRects()).length > 1 ? d["right" == r ? d.length - 1 : 0] : l.getBoundingClientRect()
                    }
                    if (bo && 9 > wo && !a && (!i || !i.left && !i.right)) {
                        var h = l.parentNode.getClientRects()[0];
                        i = h ? {left: h.left, right: h.left + bt(e.display), top: h.top, bottom: h.bottom} : Go
                    }
                ...
                function ot(e, t) {
                    if (!window.screen || null == screen.logicalXDPI || screen.logicalXDPI == screen.deviceXDPI || !eo(e))return t;
                ...
                function at(e) {
                    e.display.externalMeasure = null, Gi(e.display.lineMeasure);
                ...
                function dt(e, t, n, r) {
                    ...
                    if ("local" == r ? l += Ge(e.display) : l -= e.display.viewOffset, "page" == r || "window" == r) {
                        ...
                        l += a.top + ("window" == r ? 0 : ut());
                        var s = a.left + ("window" == r ? 0 : ct());
                        n.left += s, n.right += s
                    }
                ...
                function ht(e, t, n) {
                    ...
                    if ("page" == n)r -= ct(), i -= ut(); else if ("local" == n || !n) {
                ...
                function ft(e, t, n, r, i) {
                    return r || (r = Qr(e.doc, t.line)), dt(e, r, Je(e, r, t.ch, i), n)
                }

                function pt(e, t, n, r, i, o) {
                    function l(t, l) {
                        var a = nt(e, i, t, l ? "right" : "left", o);
                        return l ? a.left = a.right : a.right = a.left, dt(e, r, a, n)
                    }

                    function a(e, t) {
                        var n = s[t], r = n.level % 2;
                        return e == no(n) && t && n.level < s[t - 1].level ? (n = s[--t], e = ro(n) - (n.level % 2 ? 0 : 1), r = !0) : e == ro(n) && t < s.length - 1 && n.level < s[t + 1].level && (n = s[++t], e = no(n) - n.level % 2, r = !1), r && e == n.to && e > n.from ? l(e - 1) : l(e, r)
                    }

                    r = r || Qr(e.doc, t.line), i || (i = tt(e, r));
                    var s = oi(r), c = t.ch;
                    if (!s)return l(c);
                    var u = uo(s, c), d = a(c, u);
                    return null != la && (d.other = a(c, la)), d
                }

                function mt(e, t) {
                    var n = 0, t = ge(e.doc, t);
                    e.options.lineWrapping || (n = bt(e.display) * t.ch);
                    var r = Qr(e.doc, t.line), i = ii(r) + Ge(e.display);
                ...
                function vt(e, t, n) {
                    var r = e.doc;
                    if (n += e.display.viewOffset, 0 > n)return gt(r.first, 0, !0, -1);
                    var i = ri(r, n), o = r.first + r.size - 1;
                    if (i > o)return gt(r.first + r.size - 1, Qr(r, o).text.length, !0, 1);
                    0 > t && (t = 0);
                    for (var l = Qr(r, i); ;) {
                        var a = yt(e, l, i, t, n), s = vr(l), c = s && s.find(0, !0);
                ...
                function yt(e, t, n, r, i) {
                    ...
                    var l = i - ii(t), a = !1, s = 2 * e.display.wrapper.clientWidth, c = tt(e, t), u = oi(t), d = t.text.length, h = io(t), f = oo(t), p = o(h), m = a, g = o(f), v = a;
                    if (r > g)return gt(n, f, v, 1);
                    for (; ;) {
                        if (u ? f == h || f == fo(t, h, 1) : 1 >= f - h) {
                            for (var y = p > r || g - r >= r - p ? h : f, x = r - (y == h ? p : g); ji(t.text.charAt(y));)++y;
                            var b = gt(n, y, y == h ? m : v, -1 > x ? -1 : x > 1 ? 1 : 0);
                            return b
                        }
                        var w = Math.ceil(d / 2), k = h + w;
                        if (u) {
                            k = h;
                            for (var C = 0; w > C; ++C)k = fo(t, k, 1)
                        }
                        var S = o(k);
                ...
                function xt(e) {
                    ...
                    if (null == _o) {
                        _o = qi("pre");
                        for (var t = 0; 49 > t; ++t)_o.appendChild(document.createTextNode("x")), _o.appendChild(qi("br"));
                        _o.appendChild(document.createTextNode("x"))
                    }
                    Ui(e.measure, _o);
                    var n = _o.offsetHeight / 50;
                    return n > 3 && (e.cachedTextHeight = n), Gi(e.measure), n || 1
                }

                function bt(e) {
                    if (null != e.cachedCharWidth)return e.cachedCharWidth;
                    var t = qi("span", "xxxxxxxxxx"), n = qi("pre", [t]);
                    Ui(e.measure, n);
                ...
                function St(e) {
                    for (var t = e.ops, n = 0; n < t.length; n++)Lt(t[n]);
                ...
                function Nt(e) {
                    var t = e.cm;
                    null != e.adjustWidthTo && (t.display.sizer.style.minWidth = e.adjustWidthTo + "px", e.maxScrollLeft < t.doc.scrollLeft && ln(t, Math.min(t.display.scroller.scrollLeft, e.maxScrollLeft), !0), t.display.maxLineChanged = !1), e.preparedSelection && t.display.input.showSelection(e.preparedSelection), e.updatedDisplay && O(t, e.barMeasure), (e.updatedDisplay || e.startHeight != t.doc.height) && y(t, e.barMeasure), e.selectionChanged && Re(t), t.state.focused && e.updateInput && t.display.input.reset(e.typing), !e.focus || e.focus != $i() || document.hasFocus && !document.hasFocus() || Y(e.cm)
                }

                function At(e) {
                    var t = e.cm, n = t.display, r = t.doc;
                    if (e.updatedDisplay && N(t, e.update), null == n.wheelStartX || null == e.scrollTop && null == e.scrollLeft && !e.scrollToPos || (n.wheelStartX = n.wheelStartY = null), null == e.scrollTop || n.scroller.scrollTop == e.scrollTop && !e.forceScroll || (r.scrollTop = Math.max(0, Math.min(n.scroller.scrollHeight - n.scroller.clientHeight, e.scrollTop)), n.scrollbars.setScrollTop(r.scrollTop), n.scroller.scrollTop = r.scrollTop), null == e.scrollLeft || n.scroller.scrollLeft == e.scrollLeft && !e.forceScroll || (r.scrollLeft = Math.max(0, Math.min(n.scroller.scrollWidth - Ke(t), e.scrollLeft)), n.scrollbars.setScrollLeft(r.scrollLeft), n.scroller.scrollLeft = r.scrollLeft, w(t)), e.scrollToPos) {
                        var i = In(t, ge(r, e.scrollToPos.from), ge(r, e.scrollToPos.to), e.scrollToPos.margin);
                        e.scrollToPos.isCursor && t.state.focused && En(t, i)
                    }
                    var o = e.maybeHiddenMarkers, l = e.maybeUnhiddenMarkers;
                    if (o)for (var a = 0; a < o.length; ++a)o[a].lines.length || Dl(o[a], "hide");
                    if (l)for (var a = 0; a < l.length; ++a)l[a].lines.length && Dl(l[a], "unhide");
                    n.wrapper.offsetHeight && (r.scrollTop = t.display.scroller.scrollTop), e.changeObjs && Dl(t, "changes", t, e.changeObjs), e.update && e.update.finish()
                }
                ...
                function Et(e, t, n) {
                    this.line = t, this.rest = br(t), this.size = this.rest ? ni(Di(this.rest)) - n + 1 : 1, this.node = this.text = null, this.hidden = Cr(e, t)
                }

                function It(e, t, n) {
                    for (var r, i = [], o = t; n > o; o = r) {
                        var l = new Et(e.doc, Qr(e.doc, o), o);
                        r = o + l.size, i.push(l)
                    }
                    return i
                }
                ...
                function Pt(e, t, n, r) {
                    ...
                    var i = e.display;
                    if (r && n < i.viewTo && (null == i.updateLineNumbers || i.updateLineNumbers > t) && (i.updateLineNumbers = t), e.curOp.viewChanged = !0, t >= i.viewTo)zo && wr(e.doc, t) < i.viewTo && Ft(e); else if (n <= i.viewFrom)zo && kr(e.doc, n + r) > i.viewFrom ? Ft(e) : (i.viewFrom += r, i.viewTo += r); else if (t <= i.viewFrom && n >= i.viewTo)Ft(e); else if (t <= i.viewFrom) {
                        var o = Bt(e, n, n + r, 1);
                        ...
                        var l = Bt(e, t, t, -1), a = Bt(e, n, n + r, 1);
                        l && a ? (i.view = i.view.slice(0, l.index).concat(It(e, l.lineN, a.lineN)).concat(i.view.slice(a.index)), i.viewTo += r) : Ft(e)
                    }
                ...
                function Bt(e, t, n, r) {
                    ...
                    if (!zo || n == e.doc.first + e.doc.size)return {index: o, lineN: n};
                ...
                function _t(e, t, n) {
                    ...
                    0 == i.length || t >= r.viewTo || n <= r.viewFrom ? (r.view = It(e, t, n), r.viewFrom = t) : (r.viewFrom > t ? r.view = It(e, t, r.viewFrom).concat(r.view) : r.viewFrom < t && (r.view = r.view.slice(Rt(e, t))), r.viewFrom = t, r.viewTo < n ? r.view = r.view.concat(It(e, r.viewTo, n)) : r.viewTo > n && (r.view = r.view.slice(0, Rt(e, n)))), r.viewTo = n
                }
                ...
                function qt(e) {
                    ...
                    var i = e.display;
                    Ol(i.scroller, "mousedown", Wt(e, Kt)), bo && 11 > wo ? Ol(i.scroller, "dblclick", Wt(e, function (t) {
                        if (!Mi(e, t)) {
                            var n = Vt(e, t);
                            if (n && !Jt(e, t) && !$t(e.display, t)) {
                                Ml(t);
                        ...
                        Mi(e, t) || Ml(t)
                    }), Io || Ol(i.scroller, "contextmenu", function (t) {
                        bn(e, t)
                    });
                    var o, l = {end: 0};
                    Ol(i.scroller, "touchstart", function (e) {
                        if (!n(e)) {
                            clearTimeout(o);
                            var t = +new Date;
                            i.activeTouch = {
                        ...
                        var o = i.activeTouch;
                        if (o && !$t(i, n) && null != o.left && !o.moved && new Date - o.start < 300) {
                            var l, a = e.coordsChar(i.activeTouch, "page");
                            l = !o.prev || r(o, o.prev) ? new he(a, a) : !o.prev.prev || r(o, o.prev.prev) ? e.findWordAt(a) : new he(Fo(a.line, 0), ge(e.doc, Fo(a.line + 1, 0))), e.setSelection(l.anchor, l.head), e.focus(), Ml(n)
                        }
                        t()
                    }), Ol(i.scroller, "touchcancel", t), Ol(i.scroller, "scroll", function () {
                        i.scroller.clientHeight && (on(e, i.scroller.scrollTop), ln(e, i.scroller.scrollLeft, !0), Dl(e, "scroll", e))
                    ...
                    Ol(a, "keyup", function (t) {
                        mn.call(e, t)
                    }), Ol(a, "keydown", Wt(e, fn)), Ol(a, "keypress", Wt(e, gn)), Ol(a, "focus", Ri(yn, e)), Ol(a, "blur", Ri(xn, e))
                }

                function Gt(t, n, r) {
                    var i = r && r != e.Init;
                    if (!n != !i) {
                        var o = t.display.dragFunctions, l = n ? Ol : Hl;
                ...
                function $t(e, t) {
                    for (var n = ki(t); n != e.wrapper; n = n.parentNode)if (!n || 1 == n.nodeType && "true" == n.getAttribute("cm-ignore-events") || n.parentNode == e.sizer && n != e.mover)return !0
                }

                function Vt(e, t, n, r) {
                    var i = e.display;
                    if (!n && "true" == ki(t).getAttribute("cm-not-content"))return null;
                    ...
                    var s, c = vt(e, o, l);
                    if (r && 1 == c.xRel && (s = Qr(e.doc, c.line).text).length == c.ch) {
                        var u = Bl(s, s.length, e.options.tabSize) - s.length;
                        c = Fo(c.line, Math.max(0, Math.round((o - $e(e.display).left) / bt(e.display)) - u))
                    }
                    return c
                }
                ...
                function Kt(e) {
                    ...
                    if (!(n.activeTouch && n.input.supportsTouch() || Mi(t, e))) {
                        if (n.shift = e.shiftKey, $t(n, e))return void(ko || (n.scroller.draggable = !1, setTimeout(function () {
                        ...
                        if (!Jt(t, e)) {
                            ...
                            switch (window.focus(), Ci(e)) {
                                case 1:
                                    t.state.selectingText ? t.state.selectingText(e) : r ? Xt(t, e, r) : ki(e) == n.scroller && Ml(e);
                                    break;
                                case 2:
                                    ko && (t.state.lastMiddleDown = +new Date), r && we(t.doc, r), setTimeout(function () {
                                        n.input.focus()
                                    }, 20), Ml(e);
                                    break;
                                case 3:
                ...
                function Xt(e, t, n) {
                    bo ? setTimeout(Ri(Y, e), 0) : e.curOp.focus = $i();
                    var r, i = +new Date;
                    qo && qo.time > i - 400 && 0 == Ro(qo.pos, n) ? r = "triple" : jo && jo.time > i - 400 && 0 == Ro(jo.pos, n) ? (r = "double", qo = {
                        time: i,
                        pos: n
                    }) : (r = "single", jo = {time: i, pos: n});
                    var o, l = e.doc.sel, a = Wo ? t.metaKey : t.ctrlKey;
                    e.options.dragDrop && ea && !Z(e) && "single" == r && (o = l.contains(n)) > -1 && (Ro((o = l.ranges[o]).from(), n) < 0 || n.xRel > 0) && (Ro(o.to(), n) > 0 || n.xRel < 0) ? Yt(e, t, n, a) : Zt(e, t, n, r, a)
                }

                function Yt(e, t, n, r) {
                    var i = e.display, o = +new Date, l = Wt(e, function (a) {
                        ko && (i.scroller.draggable = !1), e.state.draggingText = !1, Hl(document, "mouseup", l), Hl(i.scroller, "drop", l), Math.abs(t.clientX - a.clientX) + Math.abs(t.clientY - a.clientY) < 10 && (Ml(a), !r && +new Date - 200 < o && we(e.doc, n), ko || bo && 9 == wo ? setTimeout(function () {
                            document.body.focus(), i.input.focus()
                        }, 20) : i.input.focus())
                    });
                    ko && (i.scroller.draggable = !0), e.state.draggingText = l, i.scroller.dragDrop && i.scroller.dragDrop(), Ol(document, "mouseup", l), Ol(i.scroller, "drop", l)
                }

                function Zt(e, t, n, r, i) {
                    function o(t) {
                        if (0 != Ro(g, t))if (g = t, "rect" == r) {
                            for (var i = [], o = e.options.tabSize, l = Bl(Qr(c, n.line).text, n.ch, o), a = Bl(Qr(c, t.line).text, t.ch, o), s = Math.min(l, a), f = Math.max(l, a), p = Math.min(n.line, t.line), m = Math.min(e.lastLine(), Math.max(n.line, t.line)); m >= p; p++) {
                                var v = Qr(c, p).text, y = _l(v, s, o);
                                s == f ? i.push(new he(Fo(p, y), Fo(p, y))) : v.length > y && i.push(new he(Fo(p, y), Fo(p, _l(v, f, o))))
                            }
                            ...
                            if ("single" != r) {
                                if ("double" == r)var k = e.findWordAt(t); else var k = new he(Fo(t.line, 0), ge(c, Fo(t.line + 1, 0)));
                                Ro(k.anchor, b) > 0 ? (w = k.head, b = X(x.from(), k.anchor)) : (w = k.anchor, b = K(x.to(), k.head))
                            }
                            var i = h.ranges.slice(0);
                            i[d] = new he(ge(c, b), w), Me(c, fe(i, d), Fl)
                        }
                    }

                    function l(t) {
                        var n = ++y, i = Vt(e, t, !0, "rect" == r);
                        if (i)if (0 != Ro(i, g)) {
                            e.curOp.focus = $i(), o(i);
                            var a = b(s, c);
                            (i.line >= a.to || i.line < a.from) && setTimeout(Wt(e, function () {
                                y == n && l(t)
                            }), 150)
                        } else {
                            var u = t.clientY < v.top ? -20 : t.clientY > v.bottom ? 20 : 0;
                            u && setTimeout(Wt(e, function () {
                    ...
                    function a(t) {
                        e.state.selectingText = !1, y = 1 / 0, Ml(t), s.input.focus(), Hl(document, "mousemove", x), Hl(document, "mouseup", w), c.history.lastSelOrigin = null
                    }

                    var s = e.display, c = e.doc;
                    Ml(t);
                    var u, d, h = c.sel, f = h.ranges;
                    if (i && !t.shiftKey ? (d = c.sel.contains(n), u = d > -1 ? f[d] : new he(n, n)) : (u = c.sel.primary(), d = c.sel.primIndex), t.altKey)r = "rect", i || (u = new he(n, n)), n = Vt(e, t, !0, !0), d = -1; else if ("double" == r) {
                        var p = e.findWordAt(n);
                        u = e.display.shift || c.extend ? be(c, u, p.anchor, p.head) : p
                    } else if ("triple" == r) {
                        var m = new he(Fo(n.line, 0), ge(c, Fo(n.line + 1, 0)));
                    ...
                    i ? -1 == d ? (d = f.length, Me(c, fe(f.concat([u]), d), {
                        ...
                        scroll: !1,
                        origin: "*mouse"
                    }), h = c.sel) : Ce(c, d, u, Fl) : (d = 0, Me(c, new de([u], 0), Fl), h = c.sel);
                    var g = n, v = s.wrapper.getBoundingClientRect(), y = 0, x = Wt(e, function (e) {
                        Ci(e) ? l(e) : a(e)
                    }), w = Wt(e, a);
                    e.state.selectingText = w, Ol(document, "mousemove", x), Ol(document, "mouseup", w)
                }
                ...
                function Qt(e, t, n, r) {
                    ...
                    if (o > a.bottom || !Ai(e, n))return wi(t);
                ...
                function en(e) {
                    var t = this;
                    if (rn(t), !Mi(t, e) && !$t(t.display, e)) {
                        Ml(e), bo && (Vo = +new Date);
                        var n = Vt(t, e, !0), r = e.dataTransfer.files;
                        if (n && !Z(t))if (r && r.length && window.FileReader && window.File)for (var i = r.length, o = Array(i), l = 0, a = function (e, r) {
                            if (!t.options.allowDropFileTypes || -1 != Ei(t.options.allowDropFileTypes, e.type)) {
                                var a = new FileReader;
                                a.onload = Wt(t, function () {
                                    var e = a.result;
                            ...
                            try {
                                ...
                                if (o) {
                                    if (t.state.draggingText && !(Wo ? e.altKey : e.ctrlKey))var c = t.listSelections();
                                    if (Ne(t.doc, pe(n, n)), c)for (var s = 0; s < c.length; ++s)Dn(t.doc, "", c[s].anchor, c[s].head, "drag");
                ...
                function tn(e, t) {
                    if (bo && (!e.state.draggingText || +new Date - Vo < 100))return void Al(t);
                    if (!Mi(e, t) && !$t(e.display, t) && (t.dataTransfer.setData("Text", e.getSelection()), t.dataTransfer.setDragImage && !To)) {
                        var n = qi("img", null, null, "position: fixed; left: 0; top: 0;");
                        n.src = "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==", Lo && (n.width = n.height = 1, e.display.wrapper.appendChild(n), n._top = n.offsetTop), t.dataTransfer.setDragImage(n, 0, 0), Lo && n.parentNode.removeChild(n)
                    }
                }
                ...
                function nn(e, t) {
                    ...
                    if (n) {
                        ...
                        ze(e, n, r), e.display.dragCursor || (e.display.dragCursor = qi("div", null, "CodeMirror-cursors CodeMirror-dragcursors"), e.display.lineSpace.insertBefore(e.display.dragCursor, e.display.cursorDiv)), Ui(e.display.dragCursor, r)
                    }
                }
                ...
                function on(e, t) {
                    Math.abs(e.doc.scrollTop - t) < 2 || (e.doc.scrollTop = t, vo || A(e, {top: t}), e.display.scroller.scrollTop != t && (e.display.scroller.scrollTop = t), e.display.scrollbars.setScrollTop(t), vo && A(e), Be(e, 100))
                }
                ...
                function an(e, t) {
                    var n = Yo(t), r = n.x, i = n.y, o = e.display, l = o.scroller, a = l.scrollWidth > l.clientWidth, s = l.scrollHeight > l.clientHeight;
                    if (r && a || i && s) {
                        if (i && Wo && ko)e:for (var c = t.target, u = o.view; c != l; c = c.parentNode)for (var d = 0; d < u.length; d++)if (u[d].node == c) {
                            e.display.currentWheelTarget = c;
                            break e
                        }
                        if (r && !vo && !Lo && null != Xo)return i && s && on(e, Math.max(0, Math.min(l.scrollTop + i * Xo, l.scrollHeight - l.clientHeight))), ln(e, Math.max(0, Math.min(l.scrollLeft + r * Xo, l.scrollWidth - l.clientWidth))), (!i || i && s) && Ml(t), void(o.wheelStartX = null);
                        if (i && null != Xo) {
                            var h = i * Xo, f = e.doc.scrollTop, p = f + o.wrapper.clientHeight;
                            0 > h ? f = Math.max(0, f + h - 50) : p = Math.min(e.doc.height, p + h + 50), A(e, {
                                top: f,
                                bottom: p
                            })
                        }
                        20 > Ko && (null == o.wheelStartX ? (o.wheelStartX = l.scrollLeft, o.wheelStartY = l.scrollTop, o.wheelDX = r, o.wheelDY = i, setTimeout(function () {
                            if (null != o.wheelStartX) {
                                var e = l.scrollLeft - o.wheelStartX, t = l.scrollTop - o.wheelStartY, n = t && o.wheelDY && t / o.wheelDY || e && o.wheelDX && e / o.wheelDX;
                                o.wheelStartX = o.wheelStartY = null, n && (Xo = (Xo * Ko + n) / (Ko + 1), ++Ko)
                            }
                ...
                function sn(e, t, n) {
                    ...
                    try {
                        Z(e) && (e.state.suppressEdits = !0), n && (e.display.shift = !1), i = t(e) != Pl
                    } finally {
                ...
                function cn(e, t, n) {
                    for (var r = 0; r < e.state.keyMaps.length; r++) {
                        var i = hl(t, e.state.keyMaps[r], n, e);
                        if (i)return i
                    }
                    return e.options.extraKeys && hl(t, e.options.extraKeys, n, e) || hl(t, e.options.keyMap, n, e)
                }
                ...
                function un(e, t, n, r) {
                    ...
                    var o = cn(e, t, r);
                    return "multi" == o && (e.state.keySeq = t), "handled" == o && Li(e, "keyHandled", e, t, n), ("handled" == o || "multi" == o) && (Ml(n), Re(e)), i && !o && /\'$/.test(t) ? (Ml(n), !0) : !!o
                }

                function dn(e, t) {
                    var n = pl(t, !0);
                    return n ? t.shiftKey && !e.state.keySeq ? un(e, "Shift-" + n, t, function (t) {
                        return sn(e, t, !0)
                    }) || un(e, n, t, function (t) {
                ...
                function fn(e) {
                    var t = this;
                    if (t.curOp.focus = $i(), !Mi(t, e)) {
                        bo && 11 > wo && 27 == e.keyCode && (e.returnValue = !1);
                        var n = e.keyCode;
                        t.display.shift = 16 == n || e.shiftKey;
                        var r = dn(t, e);
                        Lo && (Qo = r ? n : null, !r && 88 == n && !ra && (Wo ? e.metaKey : e.ctrlKey) && t.replaceSelection("", null, "cut")), 18 != n || /\bCodeMirror-crosshair\b/.test(t.display.lineDiv.className) || pn(t)
                    }
                }

                function pn(e) {
                    function t(e) {
                        18 != e.keyCode && e.altKey || (Zl(n, "CodeMirror-crosshair"), Hl(document, "keyup", t), Hl(document, "mouseover", t))
                    }

                    var n = e.display.lineDiv;
                    Ql(n, "CodeMirror-crosshair"), Ol(document, "keyup", t), Ol(document, "mouseover", t)
                }
                ...
                function gn(e) {
                    var t = this;
                    if (!($t(t.display, e) || Mi(t, e) || e.ctrlKey && !e.altKey || Wo && e.metaKey)) {
                        var n = e.keyCode, r = e.charCode;
                        if (Lo && n == Qo)return Qo = null, void Ml(e);
                        if (!Lo || e.which && !(e.which < 10) || !dn(t, e)) {
                            var i = String.fromCharCode(null == r ? n : r);
                            hn(t, e, i) || t.display.input.onKeyPress(e)
                        }
                    }
                }
                ...
                function yn(e) {
                    e.state.delayingBlurEvent && (e.state.delayingBlurEvent = !1), "nocursor" != e.options.readOnly && (e.state.focused || (Dl(e, "focus", e), e.state.focused = !0, Ql(e.display.wrapper, "CodeMirror-focused"), e.curOp || e.display.selForContextMenu == e.doc.sel || (e.display.input.reset(), ko && setTimeout(function () {
                        e.display.input.reset(!0)
                    }, 20)), e.display.input.receivedFocus()), Re(e))
                }

                function xn(e) {
                    e.state.delayingBlurEvent || (e.state.focused && (Dl(e, "blur", e), e.state.focused = !1, Zl(e.display.wrapper, "CodeMirror-focused")), clearInterval(e.display.blinker), setTimeout(function () {
                        e.state.focused || (e.display.shift = !1)
                    }, 150))
                }

                function bn(e, t) {
                    $t(e.display, t) || wn(e, t) || Mi(e, t, "contextmenu") || e.display.input.onContextMenu(t)
                }

                function wn(e, t) {
                    return Ai(e, "gutterContextMenu") ? Qt(e, t, "gutterContextMenu", !1) : !1
                }
                ...
                function Cn(e, t) {
                    for (var n = [], r = 0; r < e.sel.ranges.length; r++) {
                        ...
                        n.push(new he(kn(i.anchor, t), kn(i.head, t)))
                    }
                ...
                function Ln(e, t, n) {
                    for (var r = [], i = Fo(e.first, 0), o = i, l = 0; l < t.length; l++) {
                        var a = t[l], s = Sn(a.from, i, o), c = Sn(Jo(a), i, o);
                        if (i = a.to, o = c, "around" == n) {
                            var u = e.sel.ranges[l], d = Ro(u.head, u.anchor) < 0;
                ...
                function Tn(e, t, n) {
                    ...
                    }), Dl(e, "beforeChange", e, r), e.cm && Dl(e.cm, "beforeChange", e.cm, r), r.canceled ? null : {
                        from: r.from,
                        to: r.to,
                        text: r.text,
                        origin: r.origin
                ...
                function Mn(e, t, n) {
                    if (e.cm) {
                        if (!e.cm.curOp)return Wt(e.cm, Mn)(e, t, n);
                        if (e.cm.state.suppressEdits)return
                    }
                    if (!(Ai(e, "beforeChange") || e.cm && Ai(e.cm, "beforeChange")) || (t = Tn(e, t, !0))) {
                        var r = Po && !n && cr(e, t.from, t.to);
                        if (r)for (var i = r.length - 1; i >= 0; --i)Nn(e, {
                            from: r[i].from,
                            to: r[i].to,
                            text: i ? [""] : t.text
                        }); else Nn(e, t)
                ...
                function Nn(e, t) {
                    if (1 != t.text.length || "" != t.text[0] || 0 != Ro(t.from, t.to)) {
                        var n = Cn(e, t);
                        ui(e, t, n, e.cm ? e.cm.curOp.id : NaN), Wn(e, t, n, lr(e, t));
                        var r = [];
                        Yr(e, function (e, n) {
                            n || -1 != Ei(r, e.history) || (bi(e.history, t), r.push(e.history)), Wn(e, t, null, lr(e, t))
                        })
                    }
                }
                    ...
                    if (!e.cm || !e.cm.state.suppressEdits) {
                        ...
                        if (s != l.length) {
                            for (i.lastOrigin = i.lastSelOrigin = null; r = l.pop(), r.ranges;) {
                                if (fi(r, a), n && !r.equals(e.sel))return void Me(e, r, {clearRedo: !1});
                                o = r
                            }
                            var c = [];
                            fi(o, a), a.push({
                            ...
                            for (var u = Ai(e, "beforeChange") || e.cm && Ai(e.cm, "beforeChange"), s = r.changes.length - 1; s >= 0; --s) {
                                var d = r.changes[s];
                                if (d.origin = t, u && !Tn(e, d, !1))return void(l.length = 0);
                                c.push(ai(e, d));
                                var h = s ? Cn(e, d) : Di(l);
                                Wn(e, d, h, sr(e, d)), !s && e.cm && e.cm.scrollIntoView({from: d.from, to: Jo(d)});
                                var f = [];
                                Yr(e, function (e, t) {
                                    t || -1 != Ei(f, e.history) || (bi(e.history, d), f.push(e.history)), Wn(e, d, null, sr(e, d))
                                })
                            }
                        }
                    }
                ...
                function On(e, t) {
                    if (0 != t && (e.first += t, e.sel = new de(Ii(e.sel.ranges, function (e) {
                            return new he(Fo(e.anchor.line + t, e.anchor.ch), Fo(e.head.line + t, e.head.ch))
                ...
                function Wn(e, t, n, r) {
                    if (e.cm && !e.cm.curOp)return Wt(e.cm, Wn)(e, t, n, r);
                    ...
                    if (!(t.from.line > e.lastLine())) {
                        ...
                        t.to.line > o && (t = {
                            from: t.from,
                            to: Fo(o, Qr(e, o).text.length),
                            text: [t.text[0]],
                            origin: t.origin
                        }), t.removed = Jr(e, t.from, t.to), n || (n = Cn(e, t)), e.cm ? Hn(e.cm, t, r) : Vr(e, t, r), Ne(e, n, zl)
                    }
                }

                function Hn(e, t, n) {
                    var r = e.doc, i = e.display, l = t.from, a = t.to, s = !1, c = l.line;
                    e.options.lineWrapping || (c = ni(xr(Qr(r, l.line))), r.iter(c, a.line + 1, function (e) {
                        return e == i.maxLine ? (s = !0, !0) : void 0
                    })), r.sel.contains(t.from, t.to) > -1 && Ni(e), Vr(r, t, n, o(e)), e.options.lineWrapping || (r.iter(c, l.line + t.text.length, function (e) {
                        var t = d(e);
                        t > i.maxLineLength && (i.maxLine = e, i.maxLineLength = t, i.maxLineChanged = !0, s = !1)
                    }), s && (e.curOp.updateMaxLine = !0)), r.frontier = Math.min(r.frontier, l.line), Be(e, 400);
                    var u = t.text.length - (a.line - l.line) - 1;
                    t.full ? Pt(e) : l.line != a.line || 1 != t.text.length || $r(e.doc, t) ? Pt(e, l.line, a.line + 1, u) : zt(e, l.line, "text");
                    var h = Ai(e, "changes"), f = Ai(e, "change");
                    if (f || h) {
                        var p = {from: l, to: a, text: t.text, removed: t.removed, origin: t.origin};
                        f && Li(e, "change", e, p), h && (e.curOp.changeObjs || (e.curOp.changeObjs = [])).push(p)
                    }
                ...
                function Dn(e, t, n, r, i) {
                    ...
                    "string" == typeof t && (t = e.splitLines(t)), Mn(e, {from: n, to: r, text: t, origin: i})
                }

                function En(e, t) {
                    if (!Mi(e, "scrollCursorIntoView")) {
                        var n = e.display, r = n.sizer.getBoundingClientRect(), i = null;
                        if (t.top + r.top < 0 ? i = !0 : t.bottom + r.top > (window.innerHeight || document.documentElement.clientHeight) && (i = !1), null != i && !No) {
                            var o = qi("div", "​", null, "position: absolute; top: " + (t.top - n.viewOffset - Ge(e.display)) + "px; height: " + (t.bottom - t.top + Ve(e) + n.barHeight) + "px; left: " + t.left + "px; width: 2px;");
                ...
                function In(e, t, n, r) {
                    null == r && (r = 0);
                    for (var i = 0; 5 > i; i++) {
                        var o = !1, l = pt(e, t), a = n && n != t ? pt(e, n) : l, s = zn(e, Math.min(l.left, a.left), Math.min(l.top, a.top) - r, Math.max(l.left, a.left), Math.max(l.bottom, a.bottom) + r), c = e.doc.scrollTop, u = e.doc.scrollLeft;
                        if (null != s.scrollTop && (on(e, s.scrollTop), Math.abs(e.doc.scrollTop - c) > 1 && (o = !0)), null != s.scrollLeft && (ln(e, s.scrollLeft), Math.abs(e.doc.scrollLeft - u) > 1 && (o = !0)), !o)break
                    }
                    return l
                }
                ...
                function Pn(e, t, n, r, i) {
                    var o = zn(e, t, n, r, i);
                    null != o.scrollTop && on(e, o.scrollTop), null != o.scrollLeft && ln(e, o.scrollLeft)
                }

                function zn(e, t, n, r, i) {
                    var o = e.display, l = xt(e.display);
                    0 > n && (n = 0);
                    var a = e.curOp && null != e.curOp.scrollTop ? e.curOp.scrollTop : o.scroller.scrollTop, s = Xe(e), c = {};
                    i - n > s && (i = n + s);
                    var u = e.doc.height + Ue(o), d = l > n, h = i > u - l;
                    if (a > n)c.scrollTop = d ? 0 : n; else if (i > a + s) {
                ...
                function Bn(e) {
                    ...
                    if (t) {
                        ...
                        var n = mt(e, t.from), r = mt(e, t.to), i = zn(e, Math.min(n.left, r.left), Math.min(n.top, r.top) - t.margin, Math.max(n.right, r.right), Math.max(n.bottom, r.bottom) + t.margin);
                ...
                function _n(e, t, n, r) {
                    ...
                    var l = e.options.tabSize, a = Qr(o, t), s = Bl(a.text, null, l);
                    ...
                    "prev" == n ? c = t > o.first ? Bl(Qr(o, t - 1).text, null, l) : 0 : "add" == n ? c = s + e.options.indentUnit : "subtract" == n ? c = s - e.options.indentUnit : "number" == typeof n && (c = s + n), c = Math.max(0, c);
                    var d = "", h = 0;
                    if (e.options.indentWithTabs)for (var f = Math.floor(c / l); f; --f)h += l, d += "	";
                    if (c > h && (d += Hi(c - h)), d != u)return Dn(o, d, Fo(t, 0), Fo(t, u.length), "+input"), a.stateAfter = null, !0;
                ...
                function jn(e, t, n, r) {
                    var i = t, o = t;
                    return "number" == typeof t ? o = Qr(e, me(e, t)) : i = ni(t), null == i ? null : (r(o, i) && e.cm && zt(e.cm, i, n), o)
                }

                function qn(e, t) {
                    for (var n = e.doc.sel.ranges, r = [], i = 0; i < n.length; i++) {
                        for (var o = t(n[i]); r.length && Ro(o.from, Di(r).to) <= 0;) {
                            var l = r.pop();
                    ...
                    Ot(e, function () {
                        for (var t = r.length - 1; t >= 0; t--)Dn(e.doc, "", r[t].from, r[t].to, "+delete");
                        Rn(e)
                    })
                }
                ...
                function Gn(e, t, n, r, i) {
                    function o() {
                        var t = a + n;
                        return t < e.first || t >= e.first + e.size ? d = !1 : (a = t, u = Qr(e, t))
                    }

                    function l(e) {
                        var t = (i ? fo : po)(u, s, n, !0);
                        if (null == t) {
                            if (e || !o())return d = !1;
                            s = i ? (0 > n ? oo : io)(u) : 0 > n ? u.text.length : 0
                        } else s = t;
                        return !0
                    }

                    var a = t.line, s = t.ch, c = n, u = Qr(e, a), d = !0;
                    if ("char" == r)l(); else if ("column" == r)l(!0); else if ("word" == r || "group" == r)for (var h = null, f = "group" == r, p = e.cm && e.cm.getHelper(t, "wordChars"), m = !0; !(0 > n) || l(!m); m = !1) {
                ...
                function $n(t, n, r, i) {
                    e.defaults[t] = n, r && (tl[t] = i ? function (e, t, n) {
                        n != nl && r(e, t, n)
                    } : r)
                }
                ...
                function Xn(e, t, n, r, i) {
                    ...
                    if (e.cm && !e.cm.curOp)return Wt(e.cm, Xn)(e, t, n, r, i);
                    var o = new vl(e, i), l = Ro(t, n);
                    ...
                    if (o.replacedWith && (o.collapsed = !0, o.widgetNode = qi("span", [o.replacedWith], "CodeMirror-widget"), r.handleMouseEvents || o.widgetNode.setAttribute("cm-ignore-events", "true"), r.insertLeft && (o.widgetNode.insertLeft = !0)), o.collapsed) {
                        if (yr(e, t.line, t, n, o) || t.line != n.line && yr(e, n.line, t, n, o))throw new Error("Inserting collapsed marker partially overlapping an existing one");
                        zo = !0
                    }
                    o.addToHistory && ui(e, {from: t, to: n, origin: "markText"}, e.sel, NaN);
                    var a, s = t.line, c = e.cm;
                    if (e.iter(s, n.line + 1, function (e) {
                            c && o.collapsed && !c.options.lineWrapping && xr(e) == c.display.maxLine && (a = !0), o.collapsed && s != t.line && ti(e, 0), rr(e, new er(o, s == t.line ? t.ch : null, s == n.line ? n.ch : null)), ++s
                        }), o.collapsed && e.iter(t.line, n.line + 1, function (t) {
                            Cr(e, t) && ti(t, 0)
                        }), o.clearOnEnter && Ol(o, "beforeCursorEnter", function () {
                            o.clear()
                        }), o.readOnly && (Po = !0, (e.history.done.length || e.history.undone.length) && e.clearHistory()), o.collapsed && (o.id = ++gl, o.atomic = !0), c) {
                        ...
                        o.atomic && Oe(c.doc), Li(c, "markerAdded", c, o)
                    }
                    return o
                }
                ...
                function Yn(e, t, n, r, i) {
                    r = Fi(r), r.shared = !1;
                    var o = [Xn(e, t, n, r, i)], l = o[0], a = r.widgetNode;
                    return Yr(e, function (e) {
                        a && (r.widgetNode = a.cloneNode(!0)), o.push(Xn(e, ge(e, t), ge(e, n), r, i));
                ...
                function Qn(e, t) {
                    for (var n = 0; n < t.length; n++) {
                        ...
                        if (Ro(o, l)) {
                            var a = Xn(e, o, l, r.primary, r.primary.type);
                ...
                function Jn(e) {
                    for (var t = 0; t < e.length; t++) {
                        ...
                        for (var i = 0; i < n.markers.length; i++) {
                            var o = n.markers[i];
                            -1 == Ei(r, o.doc) && (o.parent = null, n.markers.splice(i--, 1))
                        }
                    }
                }
                ...
                function ir(e, t, n) {
                    if (e)for (var r, i = 0; i < e.length; ++i) {
                        ...
                        if (a || o.from == t && "bookmark" == l.type && (!n || !o.marker.insertLeft)) {
                            ...
                            (r || (r = [])).push(new er(l, o.from, s ? null : o.to))
                        }
                    }
                    return r
                }
                ...
                function or(e, t, n) {
                    if (e)for (var r, i = 0; i < e.length; ++i) {
                        ...
                        if (a || o.from == t && "bookmark" == l.type && (!n || o.marker.insertLeft)) {
                            ...
                            (r || (r = [])).push(new er(l, s ? null : o.from - t, null == o.to ? null : o.to - t))
                        }
                    }
                    return r
                }
                ...
                function lr(e, t) {
                    ...
                    var n = ye(e, t.from.line) && Qr(e, t.from.line).markedSpans, r = ye(e, t.to.line) && Qr(e, t.to.line).markedSpans;
                    if (!n && !r)return null;
                    var i = t.from.ch, o = t.to.ch, l = 0 == Ro(t.from, t.to), a = ir(n, i, l), s = or(r, o, l), c = 1 == t.text.length, u = Di(t.text).length + (c ? i : 0);
                    ...
                    a && (a = ar(a)), s && s != a && (s = ar(s));
                    var p = [a];
                    if (!c) {
                        var m, g = t.text.length - 2;
                        if (g > 0 && a)for (var d = 0; d < a.length; ++d)null == a[d].to && (m || (m = [])).push(new er(a[d].marker, null, null));
                ...
                function cr(e, t, n) {
                    ...
                    for (var i = [{
                        ...
                        var c = i[s];
                        if (!(Ro(c.to, a.from) < 0 || Ro(c.from, a.to) > 0)) {
                            var u = [s, 1], d = Ro(c.from, a.from), h = Ro(c.to, a.to);
                ...
                function pr(e, t) {
                    ...
                    if (0 != n)return n;
                    var r = e.find(), i = t.find(), o = Ro(r.from, i.from) || hr(e) - hr(t);
                    if (o)return -o;
                    var l = Ro(r.to, i.to) || fr(e) - fr(t);
                    return l ? l : t.id - e.id
                }

                function mr(e, t) {
                    var n, r = zo && e.markedSpans;
                    if (r)for (var i, o = 0; o < r.length; ++o)i = r[o], i.marker.collapsed && null == (t ? i.from : i.to) && (!n || pr(n, i.marker) < 0) && (n = i.marker);
                    return n
                }
                ...
                function yr(e, t, n, r, i) {
                    var o = Qr(e, t), l = zo && o.markedSpans;
                    if (l)for (var a = 0; a < l.length; ++a) {
                        var s = l[a];
                        if (s.marker.collapsed) {
                            var c = s.marker.find(0), u = Ro(c.from, n) || hr(s.marker) - hr(i), d = Ro(c.to, r) || fr(s.marker) - fr(i);
                            if (!(u >= 0 && 0 >= d || 0 >= u && d >= 0) && (0 >= u && (Ro(c.to, n) > 0 || s.marker.inclusiveRight && i.inclusiveLeft) || u >= 0 && (Ro(c.from, r) < 0 || s.marker.inclusiveLeft && i.inclusiveRight)))return !0
                        }
                    }
                }
                ...
                function Sr(e, t, n) {
                    if (null == n.to) {
                        ...
                        return Sr(e, r.line, tr(r.line.markedSpans, n.marker))
                    }
                ...
                function Lr(e, t, n) {
                    ii(t) < (e.curOp && e.curOp.scrollTop || e.doc.scrollTop) && Fn(e, null, n)
                }
                ...
                function Tr(e) {
                    ...
                    if (!Kl(document.body, e.node)) {
                        ...
                        e.coverGutter && (n += "margin-left: -" + t.display.gutters.offsetWidth + "px;"), e.noHScroll && (n += "width: " + t.display.wrapper.clientWidth + "px;"), Ui(t.display.measure, qi("div", [e.node], null, n))
                    }
                ...
                function Mr(e, t, n, r) {
                    ...
                    return o && i.noHScroll && (o.display.alignWidgets = !0), jn(e, t, "widget", function (t) {
                        ...
                        if (null == i.insertAt ? n.push(i) : n.splice(Math.min(n.length - 1, Math.max(0, i.insertAt)), 0, i), i.line = t, o && !Cr(e, t)) {
                            var r = ii(t) < e.scrollTop;
                            ti(t, t.height + Tr(i)), r && Fn(o, null, i.height), o.curOp.forceUpdate = !0
                        }
                        return !0
                    }), i
                }
                ...
                function Nr(e, t, n, r) {
                    e.text = t, e.stateAfter && (e.stateAfter = null), e.styles && (e.styles = null), null != e.order && (e.order = null), ur(e), dr(e, n);
                    var i = r ? r(e) : 1;
                    i != e.height && ti(e, i)
                }
                ...
                function Dr(e, t, n, r) {
                    function i(e) {
                        return {
                            ...
                            string: d.current(),
                            type: o || null,
                            state: e ? sl(l.mode, u) : u
                        }
                    }

                    var o, l = e.doc, a = l.mode;
                    t = ge(l, t);
                    var s, c = Qr(l, t.line), u = qe(e, t.line, n), d = new ml(c.text, e.options.tabSize);
                    for (r && (s = []); (r || d.pos < t.ch) && !d.eol();)d.start = d.pos, o = Hr(a, d, u), r && s.push(i(!0));
                    return r ? s : i()
                }
                ...
                function Er(e, t, n, r, i, o, l) {
                    ...
                    var s, c = 0, u = null, d = new ml(t, e.options.tabSize), h = e.options.addModeClass && [null];
                    for ("" == t && Or(Wr(n, r), o); !d.eol();) {
                        if (d.pos > e.options.maxHighlightLength ? (a = !1, l && zr(e, t, r, d.pos), d.pos = t.length, s = null) : s = Or(Hr(n, d, r, h), o), h) {
                            var f = h[0].name;
                            f && (s = "m-" + (s ? f + " " + s : f))
                        }
                        if (!a || u != s) {
                ...
                function Pr(e, t, n) {
                    if (!t.styles || t.styles[0] != e.state.modeGen) {
                        var r = qe(e, ni(t)), i = Ir(e, t, t.text.length > e.options.maxHighlightLength ? sl(e.doc.mode, r) : r);
                ...
                function zr(e, t, n, r) {
                    var i = e.doc.mode, o = new ml(t, e.options.tabSize);
                    for (o.start = o.pos = r || 0, "" == t && Wr(i, n); !o.eol();)Hr(i, o, n), o.start = o.pos
                }

                function Fr(e, t) {
                    if (!e || /^\s*$/.test(e))return null;
                    var n = t.addModeClass ? kl : wl;
                    return n[e] || (n[e] = e.replace(/\S+/g, "cm-$&"))
                }

                function Rr(e, t) {
                    var n = qi("span", null, null, ko ? "padding-right: .1px" : null), r = {
                        pre: qi("pre", [n], "CodeMirror-line"),
                        content: n,
                        col: 0,
                        pos: 0,
                        cm: e,
                        splitSpaces: (bo || ko) && e.getOption("lineWrapping")
                    };
                    t.measure = {};
                    for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
                        var o, l = i ? t.rest[i - 1] : t.line;
                        r.pos = 0, r.addToken = _r, Ji(e.display.measure) && (o = oi(l)) && (r.addToken = qr(r.addToken, o)), r.map = [];
                        var a = t != e.display.externalMeasured && ni(l);
                        Ur(l, r, Pr(e, l, a)), l.styleClasses && (l.styleClasses.bgClass && (r.bgClass = Ki(l.styleClasses.bgClass, r.bgClass || "")), l.styleClasses.textClass && (r.textClass = Ki(l.styleClasses.textClass, r.textClass || ""))), 0 == r.map.length && r.map.push(0, 0, r.content.appendChild(Qi(e.display.measure))), 0 == i ? (t.measure.map = r.map, t.measure.cache = {}) : ((t.measure.maps || (t.measure.maps = [])).push(r.map), (t.measure.caches || (t.measure.caches = [])).push({}))
                    }
                    return ko && /\bcm-tab\b/.test(r.content.lastChild.className) && (r.content.className = "cm-tab-wrap-hack"), Dl(e, "renderLine", e, t.line, r.pre), r.pre.className && (r.textClass = Ki(r.pre.className, r.textClass || "")), r
                }
                ...
                function _r(e, t, n, r, i, o, l) {
                    if (t) {
                        var a = e.splitSpaces ? t.replace(/ {3,}/g, jr) : t, s = e.cm.state.specialChars, c = !1;
                        if (s.test(t))for (var u = document.createDocumentFragment(), d = 0; ;) {
                            ...
                            if (f) {
                                ...
                                bo && 9 > wo ? u.appendChild(qi("span", [p])) : u.appendChild(p), e.map.push(e.pos, e.pos + f, p), e.col += f, e.pos += f
                            }
                            if (!h)break;
                            if (d += f + 1, "	" == h[0]) {
                                var m = e.cm.options.tabSize, g = m - e.col % m, p = u.appendChild(qi("span", Hi(g), "cm-tab"));
                                p.setAttribute("role", "presentation"), p.setAttribute("cm-text", "	"), e.col += g
                            } else if ("\r" == h[0] || "\n" == h[0]) {
                                var p = u.appendChild(qi("span", "\r" == h[0] ? "␍" : "␤", "cm-invalidchar"));
                                p.setAttribute("cm-text", h[0]), e.col += 1
                            } else {
                                var p = e.cm.options.specialCharPlaceholder(h[0]);
                                p.setAttribute("cm-text", h[0]), bo && 9 > wo ? u.appendChild(qi("span", [p])) : u.appendChild(p), e.col += 1
                            }
                ...
                function Ur(e, t, n) {
                    ...
                    if (r)for (var l, a, s, c, u, d, h, f = i.length, p = 0, m = 1, g = "", v = 0; ;) {
                        if (v == p) {
                            s = c = u = d = a = "", h = null, v = 1 / 0;
                            for (var y = [], x = 0; x < r.length; ++x) {
                                var b = r[x], w = b.marker;
                                "bookmark" == w.type && b.from == p && w.widgetNode ? y.push(w) : b.from <= p && (null == b.to || b.to > p || w.collapsed && b.to == p && b.from == p) ? (null != b.to && b.to != p && v > b.to && (v = b.to, c = ""), w.className && (s += " " + w.className), w.css && (a = (a ? a + ";" : "") + w.css), w.startStyle && b.from == p && (u += " " + w.startStyle), w.endStyle && b.to == v && (c += " " + w.endStyle), w.title && !d && (d = w.title), w.collapsed && (!h || pr(h.marker, w) < 0) && (h = b)) : b.from > p && v > b.from && (v = b.from)
                            }
                            if (h && (h.from || 0) == p) {
                                if (Gr(t, (null == h.to ? f + 1 : h.to) - p, h.marker, null == h.from), null == h.to)return;
                                h.to == p && (h = !1)
                            }
                            if (!h && y.length)for (var x = 0; x < y.length; ++x)Gr(t, 0, y[x])
                        }
                        if (p >= f)break;
                    ...
                    } else for (var m = 1; m < n.length; m += 2)t.addToken(t, i.slice(o, o = n[m]), Fr(n[m + 1], t.cm.options))
                }
                ...
                function Vr(e, t, n, r) {
                    ...
                    function o(e, n, i) {
                        Nr(e, n, i, r), Li(e, "change", e, t)
                    }

                    function l(e, t) {
                        for (var n = e, o = []; t > n; ++n)o.push(new bl(c[n], i(n), r));
                        return o
                    }

                    var a = t.from, s = t.to, c = t.text, u = Qr(e, a.line), d = Qr(e, s.line), h = Di(c), f = i(c.length - 1), p = s.line - a.line;
                    if (t.full)e.insert(0, l(0, c.length)), e.remove(c.length, e.size - c.length); else if ($r(e, t)) {
                        var m = l(0, c.length - 1);
                        o(d, d.text, f), p && e.remove(a.line, p), m.length && e.insert(a.line, m)
                    } else if (u == d)if (1 == c.length)o(u, u.text.slice(0, a.ch) + h + u.text.slice(s.ch), f); else {
                        var m = l(1, c.length - 1);
                        m.push(new bl(h + u.text.slice(s.ch), f, r)), o(u, u.text.slice(0, a.ch) + c[0], i(0)), e.insert(a.line + 1, m)
                    } else if (1 == c.length)o(u, u.text.slice(0, a.ch) + c[0] + d.text.slice(s.ch), i(0)), e.remove(a.line + 1, p); else {
                ...
                function Zr(e, t) {
                    ...
                    e.doc = t, t.cm = e, l(e), n(e), e.options.lineWrapping || h(e), e.options.mode = t.modeOption, Pt(e)
                }
                ...
                function ni(e) {
                    ...
                    for (var t = e.parent, n = Ei(t.lines, e), r = t.parent; r; t = r, r = r.parent)for (var i = 0; r.children[i] != t; ++i)n += r.children[i].chunkSize();
                    return n + t.first
                }
                ...
                function oi(e) {
                    var t = e.order;
                    return null == t && (t = e.order = aa(e.text)), t
                }
                ...
                function ai(e, t) {
                    var n = {from: V(t.from), to: Jo(t), text: Jr(e, t.from, t.to)};
                    return pi(e, n, t.from.line, t.to.line + 1), Yr(e, function (e) {
                ...
                function ui(e, t, n, r) {
                    ...
                    i.undone.length = 0;
                    var o, l = +new Date;
                    if ((i.lastOp == r || i.lastOrigin == t.origin && t.origin && ("+" == t.origin.charAt(0) && e.cm && i.lastModTime > l - e.cm.options.historyEventDelay || "*" == t.origin.charAt(0))) && (o = ci(i, i.lastOp == r))) {
                        var a = Di(o.changes);
                        0 == Ro(t.from, t.to) && 0 == Ro(t.from, a.to) ? a.to = Jo(t) : o.changes.push(ai(e, t))
                    } else {
                        var s = Di(i.done);
                    ...
                    i.done.push(n), i.generation = ++i.maxGeneration, i.lastModTime = i.lastSelTime = l, i.lastOp = i.lastSelOp = r, i.lastOrigin = i.lastSelOrigin = t.origin, a || Dl(e, "historyAdded")
                }
                ...
                function hi(e, t, n, r) {
                    ...
                    n == i.lastSelOp || o && i.lastSelOrigin == o && (i.lastModTime == i.lastSelTime && i.lastOrigin == o || di(e, o, Di(i.done), t)) ? i.done[i.done.length - 1] = t : fi(t, i.done), i.lastSelTime = +new Date, i.lastSelOrigin = o, i.lastSelOp = n, r && r.clearRedo !== !1 && si(i.undone)
                }
                ...
                function gi(e, t) {
                    var n = t["spans_" + e.id];
                    if (!n)return null;
                    for (var r = 0, i = []; r < t.text.length; ++r)i.push(mi(n[r]));
                    return i
                }
                ...
                function vi(e, t, n) {
                    for (var r = 0, i = []; r < e.length; ++r) {
                        var o = e[r];
                        if (o.ranges)i.push(n ? de.prototype.deepCopy.call(o) : o); else {
                            var l = o.changes, a = [];
                            i.push({changes: a});
                            for (var s = 0; s < l.length; ++s) {
                                ...
                                if (a.push({
                                        ...
                                        to: u.to,
                                        text: u.text
                                    }), t)for (var d in u)(c = d.match(/^spans_(\d+)$/)) && Ei(t, Number(c[1])) > -1 && (Di(a)[d] = u[d], delete u[d])
                            }
                        }
                    }
                    return i
                ...
                function xi(e, t, n, r) {
                    for (var i = 0; i < e.length; ++i) {
                        ...
                        if (o.ranges) {
                            ...
                            for (var a = 0; a < o.ranges.length; a++)yi(o.ranges[a].anchor, t, n, r), yi(o.ranges[a].head, t, n, r)
                        } else {
                            for (var a = 0; a < o.changes.length; ++a) {
                                var s = o.changes[a];
                                if (n < s.from.line)s.from = Fo(s.from.line + r, s.from.ch), s.to = Fo(s.to.line + r, s.to.ch); else if (t <= s.to.line) {
                                    l = !1;
                                    break
                                }
                            }
                ...
                function Ci(e) {
                    var t = e.which;
                    return null == t && (1 & e.button ? t = 1 : 2 & e.button ? t = 3 : 4 & e.button && (t = 2)), Wo && e.ctrlKey && 1 == t && (t = 3), t
                }

                function Si(e, t, n) {
                    var r = e._handlers && e._handlers[t];
                    return n ? r && r.length > 0 ? r.slice() : Wl : r || Wl
                }
                ...
                function Li(e, t) {
                    ...
                    if (r.length) {
                        ...
                        Uo ? i = Uo.delayedCallbacks : El ? i = El : (i = El = [], setTimeout(Ti, 0));
                ...
                function Mi(e, t, n) {
                    ...
                    }), Dl(e, n || t.type, e, t), wi(t) || t.codemirrorIgnore
                }

                function Ni(e) {
                    var t = e._handlers && e._handlers.cursorActivity;
                    if (t)for (var n = e.curOp.cursorActivityHandlers || (e.curOp.cursorActivityHandlers = []), r = 0; r < t.length; ++r)-1 == Ei(n, t[r]) && n.push(t[r])
                }
                ...
                function zi(e, t) {
                    var n;
                    return Object.create ? n = Object.create(e) : (Pi.prototype = e, n = new Pi), t && Fi(t, n), n
                }
                ...
                function Bi(e, t) {
                    return t ? t.source.indexOf("\\w") > -1 && $l(e) ? !0 : t.test(e) : $l(e)
                }
                ...
                function Qi(e) {
                    if (null == Xl) {
                        var t = qi("span", "​");
                        Ui(e, qi("span", [t, document.createTextNode("x")])), 0 != e.firstChild.offsetHeight && (Xl = t.offsetWidth <= 1 && t.offsetHeight > 2 && !(bo && 8 > wo))
                    }
                    var n = Xl ? qi("span", "​") : qi("span", " ", null, "display: inline-block; width: 1px; margin-right: -1px");
                    return n.setAttribute("cm-text", ""), n
                }

                function Ji(e) {
                    if (null != Yl)return Yl;
                    var t = Ui(e, document.createTextNode("AخA")), n = Gl(t, 0, 1).getBoundingClientRect();
                    if (!n || n.left == n.right)return !1;
                    var r = Gl(t, 1, 2).getBoundingClientRect();
                    return Yl = r.right - n.right < 3
                }

                function eo(e) {
                    if (null != ia)return ia;
                    var t = Ui(e, qi("span", "x")), n = t.getBoundingClientRect(), r = Gl(t, 0, 1).getBoundingClientRect();
                    return ia = Math.abs(n.left - r.left) > 1
                }
                ...
                function lo(e, t) {
                    var n = Qr(e.doc, t), r = xr(n);
                    r != n && (t = ni(r));
                    var i = oi(r), o = i ? i[0].level % 2 ? oo(r) : io(r) : 0;
                    return Fo(t, o)
                }

                function ao(e, t) {
                    for (var n, r = Qr(e.doc, t); n = vr(r);)r = n.find(1, !0).line, t = null;
                    var i = oi(r), o = i ? i[0].level % 2 ? io(r) : oo(r) : r.text.length;
                    return Fo(null == t ? ni(r) : t, o)
                }

                function so(e, t) {
                    var n = lo(e, t.line), r = Qr(e.doc, n.line), i = oi(r);
                    if (!i || 0 == i[0].level) {
                ...
                function uo(e, t) {
                    ...
                    for (var n, r = 0; r < e.length; ++r) {
                        ...
                        if (i.from == t || i.to == t) {
                            if (null != n)return co(e, i.level, e[n].level) ? (i.from != i.to && (la = n), r) : (i.from != i.to && (la = r), n);
                            n = r
                        }
                    }
                    return n
                ...
                function fo(e, t, n, r) {
                    var i = oi(e);
                    if (!i)return po(e, t, n, r);
                    for (var o = uo(i, t), l = i[o], a = ho(e, t, l.level % 2 ? -n : n, r); ;) {
                        if (a > l.from && a < l.to)return a;
                        if (a == l.from || a == l.to)return uo(i, a) == o ? a : (l = i[o += n], n > 0 == l.level % 2 ? l.to : l.from);
                        if (l = i[o += n], !l)return null;
                        a = n > 0 == l.level % 2 ? ho(e, l.to, -1, r) : ho(e, l.from, 1, r)
                    }
                }

                function po(e, t, n, r) {
                    var i = t + n;
                    if (r)for (; i > 0 && ji(e.text.charAt(i));)i += n;
                    return 0 > i || i > e.text.length ? null : i
                }

                var mo = navigator.userAgent, go = navigator.platform, vo = /gecko\/\d/i.test(mo), yo = /MSIE \d/.test(mo), xo = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(mo), bo = yo || xo, wo = bo && (yo ? document.documentMode || 6 : xo[1]), ko = /WebKit\//.test(mo), Co = ko && /Qt\/\d+\.\d+/.test(mo), So = /Chrome\//.test(mo), Lo = /Opera\//.test(mo), To = /Apple Computer/.test(navigator.vendor), Mo = /Mac OS X 1\d\D([8-9]|\d\d)\D/.test(mo), No = /PhantomJS/.test(mo), Ao = /AppleWebKit/.test(mo) && /Mobile\/\w+/.test(mo), Oo = Ao || /Android|webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(mo), Wo = Ao || /Mac/.test(go), Ho = /win/i.test(go), Do = Lo && mo.match(/Version\/(\d*\.\d*)/);
                Do && (Do = Number(Do[1])), Do && Do >= 15 && (Lo = !1, ko = !0);
                var Eo = Wo && (Co || Lo && (null == Do || 12.11 > Do)), Io = vo || bo && wo >= 9, Po = !1, zo = !1;
                m.prototype = Fi({
                    update: function (e) {
                        ...
                        var e = Wo && !Mo ? "12px" : "18px";
                        this.horiz.style.height = this.vert.style.width = e, this.horiz.style.pointerEvents = this.vert.style.pointerEvents = "none", this.disableHoriz = new Wi, this.disableVert = new Wi
                ...
                re.prototype = Fi({
                    init: function (e) {
                        function t(e) {
                            if (r.somethingSelected())Bo = r.getSelections(), n.inaccurateSelection && (n.prevInput = "", n.inaccurateSelection = !1, o.value = Bo.join("\n"), ql(o)); else {
                                if (!r.options.lineWiseCopyCut)return;
                                var t = te(r);
                                Bo = t.text, "cut" == e.type ? r.setSelections(t.ranges, null, zl) : (n.prevInput = "", o.value = t.text.join("\n"), ql(o))
                            }
                            "cut" == e.type && (r.state.cutIncoming = !0)
                        }

                        var n = this, r = this.cm, i = this.wrapper = ie(), o = this.textarea = i.firstChild;
                        e.wrapper.insertBefore(i, e.wrapper.firstChild), Ao && (o.style.width = "0px"), Ol(o, "input", function () {
                            bo && wo >= 9 && n.hasSelection && (n.hasSelection = null), n.poll()
                            ...
                            $t(e, t) || (r.state.pasteIncoming = !0, n.focus())
                        ...
                        if (e.options.moveInputWithCursor) {
                            var i = pt(e, n.sel.primary().head, "div"), o = t.wrapper.getBoundingClientRect(), l = t.lineDiv.getBoundingClientRect();
                        ...
                        if (!this.contextMenuPending) {
                            ...
                            if (r.somethingSelected()) {
                                ...
                                this.textarea.value = l, r.state.focused && ql(this.textarea), bo && wo >= 9 && (this.hasSelection = l)
                        ...
                        if ("nocursor" != this.cm.options.readOnly && (!Oo || $i() != this.textarea))try {
                            this.textarea.focus()
                        } catch (e) {
                        }
                    }, blur: function () {
                        ...
                        if (this.contextMenuPending || !e.state.focused || na(t) && !n && !this.composing || Z(e) || e.options.disableInput || e.state.keySeq)return !1;
                        var r = t.value;
                        if (r == n && !e.somethingSelected())return !1;
                        if (bo && wo >= 9 && this.hasSelection === r || Wo && /[\uf700-\uf7ff]/.test(r))return e.display.input.reset(), !1;
                        ...
                        return Ot(e, function () {
                            Q(e, r.slice(o), n.length - o, null, a.composing ? "*compose" : null), r.length > 1e3 || r.indexOf("\n") > -1 ? t.value = a.prevInput = "" : a.prevInput = r, a.composing && (a.composing.range.clear(), a.composing.range = e.markText(a.composing.start, e.getCursor("to"), {className: "CodeMirror-composing"}))
                        }), !0
                        ...
                        function n() {
                            if (r.contextMenuPending = !1, r.wrapper.style.position = "relative", l.style.cssText = u, bo && 9 > wo && o.scrollbars.setScrollTop(o.scroller.scrollTop = s), null != l.selectionStart) {
                                (!bo || bo && 9 > wo) && t();
                                var e = 0, n = function () {
                                    o.selForContextMenu == i.doc.sel && 0 == l.selectionStart && l.selectionEnd > 0 && "​" == r.prevInput ? Wt(i, ul.selectAll)(i) : e++ < 10 ? o.detectingSelectAll = setTimeout(n, 500) : o.input.reset()
                                };
                        ...
                        if (a && !Lo) {
                            ...
                            c && -1 == i.doc.sel.contains(a) && Wt(i, Me)(i.doc, pe(a), zl);
                            var u = l.style.cssText;
                            if (r.wrapper.style.position = "absolute", l.style.cssText = "position: fixed; width: 30px; height: 30px; top: " + (e.clientY - 5) + "px; left: " + (e.clientX - 5) + "px; z-index: 1000; background: " + (bo ? "rgba(255, 255, 255, .05)" : "transparent") + "; outline: none; border-width: 0; outline: none; overflow: hidden; opacity: .05; filter: alpha(opacity=5);", ko)var d = window.scrollY;
                            if (o.input.focus(), ko && window.scrollTo(null, d), o.input.reset(), i.somethingSelected() || (l.value = r.prevInput = " "), r.contextMenuPending = !0, o.selForContextMenu = i.doc.sel, clearTimeout(o.detectingSelectAll), bo && wo >= 9 && t(), Io) {
                                Al(e);
                                var h = function () {
                                    Hl(window, "mouseup", h), setTimeout(n, 20)
                                };
                                Ol(window, "mouseup", h)
                ...
                }, re.prototype), oe.prototype = Fi({
                    init: function (e) {
                        function t(e) {
                            if (r.somethingSelected())Bo = r.getSelections(), "cut" == e.type && r.replaceSelection("", null, "cut"); else {
                                if (!r.options.lineWiseCopyCut)return;
                                var t = te(r);
                                Bo = t.text, "cut" == e.type && r.operation(function () {
                                    r.setSelections(t.ranges, 0, zl), r.replaceSelection("", null, "cut")
                                })
                            }
                            if (e.clipboardData && !Ao)e.preventDefault(), e.clipboardData.clearData(), e.clipboardData.setData("text/plain", Bo.join("\n")); else {
                                var n = ie(), i = n.firstChild;
                                r.display.lineSpace.insertBefore(n, r.display.lineSpace.firstChild), i.value = Bo.join("\n");
                                var o = document.activeElement;
                                ql(i), setTimeout(function () {
                        ...
                        ne(i), Ol(i, "paste", function (e) {
                            ...
                            if (n.composing = {sel: r.doc.sel, data: t, startData: t}, t) {
                                ...
                                l > -1 && l <= i.head.ch && (n.composing.sel = pe(Fo(i.head.line, l), Fo(i.head.line, l + t.length)))
                            }
                            ...
                            n.composing || (Z(r) || !n.pollContent()) && Ot(n.cm, function () {
                                Pt(r)
                            })
                        ...
                        var e = window.getSelection(), t = this.cm.doc.sel.primary(), n = se(this.cm, e.anchorNode, e.anchorOffset), r = se(this.cm, e.focusNode, e.focusOffset);
                        if (!n || n.bad || !r || r.bad || 0 != Ro(X(n, r), t.from()) || 0 != Ro(K(n, r), t.to())) {
                            ...
                            if (i || o) {
                                ...
                                try {
                                    var u = Gl(i.node, i.offset, o.offset, o.node)
                                } catch (d) {
                                }
                                u && (e.removeAllRanges(), e.addRange(u), a && null == e.anchorNode ? e.addRange(a) : vo && this.startGracePeriod()), this.rememberSelection()
                            }
                        }
                        ...
                        if (!this.composing && !this.gracePeriod && this.selectionChanged()) {
                            ...
                            var n = se(t, e.anchorNode, e.anchorOffset), r = se(t, e.focusNode, e.focusOffset);
                            n && r && Ot(t, function () {
                                Me(t.doc, pe(n, r), zl), (n.bad || r.bad) && (t.curOp.selectionChanged = !0)
                            })
                        }
                        ...
                        var o;
                        if (r.line == t.viewFrom || 0 == (o = Rt(e, r.line)))var l = ni(t.view[0].line), a = t.view[0].node; else var l = ni(t.view[o].line), a = t.view[o - 1].node.nextSibling;
                        var s = Rt(e, i.line);
                        if (s == t.view.length - 1)var c = t.viewTo - 1, u = t.lineDiv.lastChild; else var c = ni(t.view[s + 1].line) - 1, u = t.view[s + 1].node.previousSibling;
                        for (var d = e.doc.splitLines(ue(e, a, u, l, c)), h = Jr(e.doc, Fo(l, 0), Fo(c, Qr(e.doc, c).text.length)); d.length > 1 && h.length > 1;)if (Di(d) == Di(h))d.pop(), h.pop(), c--; else {
                            if (d[0] != h[0])break;
                            d.shift(), h.shift(), l++
                        }
                        for (var f = 0, p = 0, m = d[0], g = h[0], v = Math.min(m.length, g.length); v > f && m.charCodeAt(f) == g.charCodeAt(f);)++f;
                        for (var y = Di(d), x = Di(h), b = Math.min(y.length - (1 == d.length ? f : 0), x.length - (1 == h.length ? f : 0)); b > p && y.charCodeAt(y.length - p - 1) == x.charCodeAt(x.length - p - 1);)++p;
                        d[d.length - 1] = y.slice(0, y.length - p), d[0] = d[0].slice(f);
                        var w = Fo(l, f), k = Fo(c, h.length ? Di(h).length - p : 0);
                        return d.length > 1 || d[0] || Ro(w, k) ? (Dn(e.doc, d, w, k, "+input"), !0) : void 0
                    }, ensurePolled: function () {
                        ...
                        Z(this.cm) ? Wt(this.cm, Pt)(this.cm) : e.data && e.data != e.startData && Wt(this.cm, Q)(this.cm, e.data, 0, e.sel)
                    }, setUneditable: function (e) {
                        e.contentEditable = "false"
                    }, onKeyPress: function (e) {
                        e.preventDefault(), Z(this.cm) || Wt(this.cm, Q)(this.cm, String.fromCharCode(null == e.charCode ? e.keyCode : e.charCode), 0)
                    }, readOnlyChanged: function (e) {
                    ...
                    primary: function () {
                        ...
                        for (var t = 0; t < this.ranges.length; t++) {
                            ...
                            if (0 != Ro(n.anchor, r.anchor) || 0 != Ro(n.head, r.head))return !1
                        }
                        return !0
                    }, deepCopy: function () {
                        ...
                        for (var n = 0; n < this.ranges.length; n++) {
                            var r = this.ranges[n];
                            if (Ro(t, r.from()) >= 0 && Ro(e, r.to()) <= 0)return n
                        }
                        return -1
                    }
                }, he.prototype = {
                ...
                var _o, jo, qo, Go = {
                    ...
                    top: 0,
                    bottom: 0
                }, Uo = null, $o = 0, Vo = 0, Ko = 0, Xo = null;
                bo ? Xo = -.53 : vo ? Xo = 15 : So ? Xo = -.7 : To && (Xo = -1 / 3);
                var Yo = function (e) {
                ...
                var Zo = new Wi, Qo = null, Jo = e.changeEnd = function (e) {
                    return e.text ? Fo(e.from.line + e.text.length - 1, Di(e.text).length + (1 == e.text.length ? e.from.ch : 0)) : e.to
                };
                e.prototype = {
                    constructor: e,
                    focus: function () {
                    ...
                    setOption: function (e, t) {
                        ...
                        (n[e] != t || "mode" == e) && (n[e] = t, tl.hasOwnProperty(e) && Wt(this, tl[e])(this, t, r))
                    },
                    ...
                    removeOverlay: Ht(function (e) {
                        for (var t = this.state.overlays, n = 0; n < t.length; ++n) {
                            var r = t[n].modeSpec;
                            if (r == e || "string" == typeof e && r.name == e)return t.splice(n, 1), this.state.modeGen++, void Pt(this)
                        }
                    }),
                    indentLine: Ht(function (e, t, n) {
                        "string" != typeof t && "number" != typeof t && (t = null == t ? this.options.smartIndent ? "smart" : "prev" : t ? "add" : "subtract"), ye(this.doc, e) && _n(this, e, t, n)
                    }),
                    indentSelection: Ht(function (e) {
                        for (var t = this.doc.sel.ranges, n = -1, r = 0; r < t.length; r++) {
                            var i = t[r];
                            if (i.empty())i.head.line > n && (_n(this, i.head.line, e, !0), n = i.head.line, r == this.doc.sel.primIndex && Rn(this)); else {
                                var o = i.from(), l = i.to(), a = Math.max(n, o.line);
                                n = Math.min(this.lastLine(), l.line - (l.ch ? 0 : 1)) + 1;
                                for (var s = a; n > s; ++s)_n(this, s, e);
                                var c = this.doc.sel.ranges;
                                0 == o.ch && t.length == c.length && c[r].from().ch > 0 && Ce(this.doc, r, new he(o, c[r].to()), zl)
                            }
                        }
                    }),
                    ...
                    getLineTokens: function (e, t) {
                        return Dr(this, Fo(e), t, !0)
                    },
                    getTokenTypeAt: function (e) {
                        e = ge(this.doc, e);
                        var t, n = Pr(this, Qr(this.doc, e.line)), r = 0, i = (n.length - 1) / 2, o = e.ch;
                    ...
                    getStateAfter: function (e, t) {
                        var n = this.doc;
                        return e = me(n, null == e ? n.first + n.size - 1 : e), qe(this, e + 1, t)
                    },
                    cursorCoords: function (e, t) {
                        var n, r = this.doc.sel.primary();
                        return n = null == e ? r.head : "object" == typeof e ? ge(this.doc, e) : e ? r.from() : r.to(), pt(this, n, t || "page")
                    },
                    ...
                    heightAtLine: function (e, t) {
                        ...
                        if ("number" == typeof e) {
                            ...
                            e < this.doc.first ? e = this.doc.first : e > i && (e = i, r = !0), n = Qr(this.doc, e)
                        } else n = e;
                        return dt(this, n, {top: 0, left: 0}, t || "page").top + (r ? this.doc.height - ii(n) : 0)
                    },
                    ...
                    setGutterMarker: Ht(function (e, t, n) {
                        return jn(this.doc, e, "gutter", function (e) {
                            ...
                            return r[t] = n, !n && _i(r) && (e.gutterMarkers = null), !0
                        })
                    }),
                    clearGutter: Ht(function (e) {
                        var t = this, n = t.doc, r = n.first;
                        n.iter(function (n) {
                            n.gutterMarkers && n.gutterMarkers[e] && (n.gutterMarkers[e] = null, zt(t, r, "gutter"), _i(n.gutterMarkers) && (n.gutterMarkers = null)), ++r
                        })
                    }),
                    lineInfo: function (e) {
                        if ("number" == typeof e) {
                    ...
                    addWidget: function (e, t, n, r, i) {
                        ...
                        if (t.style.position = "absolute", t.setAttribute("cm-ignore-events", "true"), this.display.input.setUneditable(t), o.sizer.appendChild(t), "over" == r)l = e.top; else if ("above" == r || "near" == r) {
                        ...
                        t.style.top = l + "px", t.style.left = t.style.right = "", "right" == i ? (a = o.sizer.clientWidth - t.offsetWidth, t.style.right = "0px") : ("left" == i ? a = 0 : "middle" == i && (a = (o.sizer.clientWidth - t.offsetWidth) / 2), t.style.left = a + "px"), n && Pn(this, a, l, a + t.offsetWidth, l + t.offsetHeight)
                    },
                    triggerOnKeyDown: Ht(fn),
                    triggerOnKeyPress: Ht(gn),
                    triggerOnKeyUp: mn,
                    ...
                    findPosH: function (e, t, n, r) {
                        var i = 1;
                        0 > t && (i = -1, t = -t);
                        for (var o = 0, l = ge(this.doc, e); t > o && (l = Gn(this.doc, l, i, n, r), !l.hitSide); ++o);
                        return l
                    },
                    moveH: Ht(function (e, t) {
                        var n = this;
                        n.extendSelectionsBy(function (r) {
                            return n.display.shift || n.doc.extend || r.empty() ? Gn(n.doc, r.head, e, t, n.options.rtlMoveVisually) : 0 > e ? r.from() : r.to()
                        }, Rl)
                    }),
                    ...
                    moveV: Ht(function (e, t) {
                        ...
                        if (r.extendSelectionsBy(function (l) {
                                ...
                                var a = pt(n, l.head, "div");
                                null != l.goalColumn && (a.left = l.goalColumn), i.push(a.left);
                                var s = Un(n, a, e, t);
                                return "page" == t && l == r.sel.primary() && Fn(n, null, ft(n, s, "div").top - a.top), s
                            }, Rl), i.length)for (var l = 0; l < r.sel.ranges.length; l++)r.sel.ranges[l].goalColumn = i[l]
                    }),
                    findWordAt: function (e) {
                        var t = this.doc, n = Qr(t, e.line).text, r = e.ch, i = e.ch;
                        if (n) {
                            var o = this.getHelper(e, "wordChars");
                            (e.xRel < 0 || i == n.length) && r ? --r : ++i;
                            for (var l = n.charAt(r), a = Bi(l, o) ? function (e) {
                                return Bi(e, o)
                            } : /\s/.test(l) ? function (e) {
                                return /\s/.test(e)
                            } : function (e) {
                        ...
                        return new he(Fo(e.line, r), Fo(e.line, i))
                    },
                    toggleOverwrite: function (e) {
                        (null == e || e != this.state.overwrite) && ((this.state.overwrite = !this.state.overwrite) ? Ql(this.display.cursorDiv, "CodeMirror-overwrite") : Zl(this.display.cursorDiv, "CodeMirror-overwrite"), Dl(this, "overwriteToggle", this, this.state.overwrite))
                    },
                    hasFocus: function () {
                    ...
                    scrollIntoView: Ht(function (e, t) {
                        if (null == e ? (e = {
                                ...
                                from: e,
                                to: null
                            }), e.to || (e.to = e.from), e.margin = t || 0, null != e.from.line)Bn(this), this.curOp.scrollToPos = e; else {
                    ...
                    setSize: Ht(function (e, t) {
                        ...
                        r.doc.iter(i, r.display.viewTo, function (e) {
                            ...
                            ++i
                        }), r.curOp.forceUpdate = !0, Dl(r, "refresh", this)
                    }),
                    ...
                    refresh: Ht(function () {
                        ...
                        Pt(this), this.curOp.forceUpdate = !0, st(this), this.scrollTo(this.doc.scrollLeft, this.doc.scrollTop), u(this), (null == e || Math.abs(e - xt(this.display)) > .5) && l(this), Dl(this, "refresh", this)
                    }),
                    swapDoc: Ht(function (e) {
                        var t = this.doc;
                        return t.cm = null, Zr(this, e), st(this), this.display.input.reset(), this.scrollTo(e.scrollLeft, e.scrollTop), this.curOp.forceScroll = !0, Li(this, "swapDoc", this, t), t
                    }),
                ...
                var el = e.defaults = {}, tl = e.optionHandlers = {}, nl = e.Init = {
                    toString: function () {
                ...
                $n("value", "", function (e, t) {
                ...
                }, !0), $n("indentUnit", 2, n, !0), $n("indentWithTabs", !1), $n("smartIndent", !0), $n("tabSize", 4, function (e) {
                    r(e), st(e), Pt(e)
                    ...
                    if (e.doc.lineSep = t, t) {
                        ...
                        for (var i = n.length - 1; i >= 0; i--)Dn(e.doc, t, n[i], Fo(n[i].line, n[i].ch + t.length))
                    }
                }), $n("specialChars", /[\t\u0000-\u0019\u00ad\u200b-\u200f\u2028\u2029\ufeff]/g, function (t, n, r) {
                    t.state.specialChars = new RegExp(n.source + (n.test("	") ? "" : "|	"), "g"), r != e.Init && t.refresh()
                }), $n("specialCharPlaceholder", Br, function (e) {
                    e.refresh()
                }, !0), $n("electricChars", !0), $n("inputStyle", Oo ? "contenteditable" : "textarea", function () {
                    throw new Error("inputStyle can not (yet) be changed in a running editor")
                }, !0), $n("rtlMoveVisually", !Ho), $n("wholeLineUpdateBefore", !0), $n("theme", "default", function (e) {
                    a(e), s(e)
                }, !0), $n("keyMap", "default", function (t, n, r) {
                    var i = Kn(n), o = r != e.Init && Kn(r);
                    o && o.detach && o.detach(t, i), i.attach && i.attach(t, o || null)
                }), $n("extraKeys", null), $n("lineWrapping", !1, i, !0), $n("gutters", [], function (e) {
                    f(e.options), s(e)
                    ...
                    f(e.options), s(e)
                }, !0), $n("firstLineNumber", 1, s, !0), $n("lineNumberFormatter", function (e) {
                    return e
                }, s, !0), $n("showCursorWhenSelecting", !1, Ie, !0), $n("resetSelectionOnContextMenu", !0), $n("lineWiseCopyCut", !0), $n("readOnly", !1, function (e, t) {
                    "nocursor" == t ? (xn(e), e.display.input.blur(), e.display.disabled = !0) : e.display.disabled = !1, e.display.input.readOnlyChanged(t)
                }), $n("disableInput", !1, function (e, t) {
                    t || e.display.input.reset()
                }, !0), $n("dragDrop", !0, Gt), $n("allowDropFileTypes", null), $n("cursorBlinkRate", 530), $n("cursorScrollMargin", 0), $n("cursorHeight", 1, Ie, !0), $n("singleCursorHeightPerLine", !0, Ie, !0), $n("workTime", 100), $n("workDelay", 100), $n("flattenSpans", !0, r, !0), $n("addModeClass", !1, r, !0), $n("pollInterval", 100), $n("undoDepth", 200, function (e, t) {
                    e.doc.history.undoDepth = t
                }), $n("historyEventDelay", 1250), $n("viewportMargin", 10, function (e) {
                    e.refresh()
                }, !0), $n("maxHighlightLength", 1e4, r, !0), $n("moveInputWithCursor", !0, function (e, t) {
                    t || e.display.input.resetPosition()
                }), $n("tabindex", null, function (e, t) {
                    e.display.input.getField().tabIndex = t || ""
                }), $n("autofocus", null);
                var rl = e.modes = {}, il = e.mimeModes = {};
                e.defineMode = function (t, n) {
                    e.defaults.mode || "null" == t || (e.defaults.mode = t), arguments.length > 2 && (n.dependencies = Array.prototype.slice.call(arguments, 2)), rl[t] = n
                }, e.defineMIME = function (e, t) {
                    il[e] = t
                }, e.resolveMode = function (t) {
                    if ("string" == typeof t && il.hasOwnProperty(t))t = il[t]; else if (t && "string" == typeof t.name && il.hasOwnProperty(t.name)) {
                        var n = il[t.name];
                        "string" == typeof n && (n = {name: n}), t = zi(n, t), t.name = n.name
                    ...
                    var n = e.resolveMode(n), r = rl[n.name];
                    if (!r)return e.getMode(t, "text/plain");
                    var i = r(t, n);
                    if (ol.hasOwnProperty(n.name)) {
                        var o = ol[n.name];
                ...
                e.extendMode = function (e, t) {
                    var n = ol.hasOwnProperty(e) ? ol[e] : ol[e] = {};
                    Fi(t, n)
                ...
                e.registerHelper = function (t, n, r) {
                    al.hasOwnProperty(t) || (al[t] = e[t] = {_global: []}), al[t][n] = r
                }, e.registerGlobalHelper = function (t, n, r, i) {
                    e.registerHelper(t, n, i), al[t]._global.push({pred: r, val: i})
                };
                var sl = e.copyState = function (e, t) {
                    ...
                    return n
                }, cl = e.startState = function (e, t, n) {
                    ...
                    selectAll: function (e) {
                        ...
                        qn(e, function (t) {
                            if (t.empty()) {
                                ...
                                } : {from: t.head, to: Fo(t.head.line, n)}
                            }
                            return {from: t.from(), to: t.to()}
                        })
                    }, deleteLine: function (e) {
                        qn(e, function (t) {
                            return {from: Fo(t.from().line, 0), to: ge(e.doc, Fo(t.to().line + 1, 0))}
                        })
                        ...
                        for (var t = [], n = e.listSelections(), r = e.options.tabSize, i = 0; i < n.length; i++) {
                            var o = n[i].from(), l = Bl(e.getLine(o.line), o.ch, r);
                        ...
                        Ot(e, function () {
                            for (var t = e.listSelections(), n = [], r = 0; r < t.length; r++) {
                                var i = t[r].head, o = Qr(e.doc, i.line).text;
                                if (o)if (i.ch == o.length && (i = new Fo(i.line, i.ch - 1)), i.ch > 0)i = new Fo(i.line, i.ch + 1), e.replaceRange(o.charAt(i.ch - 1) + o.charAt(i.ch - 2), Fo(i.line, i.ch - 2), i, "+transpose"); else if (i.line > e.doc.first) {
                                    var l = Qr(e.doc, i.line - 1).text;
                ...
                dl.basic = {
                ...
                }, dl["default"] = Wo ? dl.macDefault : dl.pcDefault, e.normalizeKeyMap = function (e) {
                    var t = {};
                    for (var n in e)if (e.hasOwnProperty(n)) {
                        ...
                        for (var i = Ii(n.split(" "), Vn), o = 0; o < i.length; o++) {
                            var l, a;
                ...
                var hl = e.lookupKey = function (e, t, n, r) {
                    t = Kn(t);
                    ...
                    if (t.fallthrough) {
                        if ("[object Array]" != Object.prototype.toString.call(t.fallthrough))return hl(e, t.fallthrough, n, r);
                        for (var o = 0; o < t.fallthrough.length; o++) {
                            var l = hl(e, t.fallthrough[o], n, r);
                            if (l)return l
                        }
                    }
                    ...
                    var n = oa[e.keyCode], r = n;
                    return null == r || e.altGraphKey ? !1 : (e.altKey && "Alt" != n && (r = "Alt-" + r), (Eo ? e.metaKey : e.ctrlKey) && "Ctrl" != n && (r = "Ctrl-" + r), (Eo ? e.ctrlKey : e.metaKey) && "Cmd" != n && (r = "Cmd-" + r), !t && e.shiftKey && "Shift" != n && (r = "Shift-" + r), r)
                };
                ...
                ml.prototype = {
                    eol: function () {
                        ...
                        return this.lastColumnPos < this.start && (this.lastColumnValue = Bl(this.string, this.start, this.tabSize, this.lastColumnPos, this.lastColumnValue), this.lastColumnPos = this.start), this.lastColumnValue - (this.lineStart ? Bl(this.string, this.lineStart, this.tabSize) : 0)
                    }, indentation: function () {
                        return Bl(this.string, null, this.tabSize) - (this.lineStart ? Bl(this.string, this.lineStart, this.tabSize) : 0)
                ...
                Oi(vl), vl.prototype.clear = function () {
                    if (!this.explicitlyCleared) {
                        ...
                        for (var r = null, i = null, o = 0; o < this.lines.length; ++o) {
                            var l = this.lines[o], a = tr(l.markedSpans, this);
                            e && !this.collapsed ? zt(e, ni(l), "text") : e && (null != a.to && (i = ni(l)), null != a.from && (r = ni(l))), l.markedSpans = nr(l.markedSpans, a), null == a.from && this.collapsed && !Cr(this.doc, l) && e && ti(l, xt(e.display))
                        }
                        if (e && this.collapsed && !e.options.lineWrapping)for (var o = 0; o < this.lines.length; ++o) {
                            var s = xr(this.lines[o]), c = d(s);
                            c > e.display.maxLineLength && (e.display.maxLine = s, e.display.maxLineLength = c, e.display.maxLineChanged = !0)
                        }
                        null != r && e && this.collapsed && Pt(e, r, i + 1), this.lines.length = 0, this.explicitlyCleared = !0, this.atomic && this.doc.cantEdit && (this.doc.cantEdit = !1, e && Oe(e.doc)), e && Li(e, "markerCleared", e, this), t && Ct(e), this.parent && this.parent.clear()
                    }
                }, vl.prototype.find = function (e, t) {
                    null == e && "bookmark" == this.type && (e = 1);
                    for (var n, r, i = 0; i < this.lines.length; ++i) {
                        var o = this.lines[i], l = tr(o.markedSpans, this);
                        if (null != l.from && (n = Fo(t ? o : ni(o), l.from), -1 == e))return n;
                        if (null != l.to && (r = Fo(t ? o : ni(o), l.to), 1 == e))return r
                    }
                    return n && {from: n, to: r}
                }, vl.prototype.changed = function () {
                    var e = this.find(-1, !0), t = this, n = this.doc.cm;
                    e && n && Ot(n, function () {
                        var r = e.line, i = ni(e.line), o = et(n, i);
                        if (o && (lt(o), n.curOp.selectionChanged = n.curOp.forceUpdate = !0), n.curOp.updateMaxLine = !0, !Cr(t.doc, r) && null != t.height) {
                            var l = t.height;
                            t.height = null;
                            var a = Tr(t) - l;
                            a && ti(r, r.height + a)
                    ...
                    if (this.lines.splice(Ei(this.lines, e), 1), !this.lines.length && this.doc.cm) {
                        var t = this.doc.cm.curOp;
                        (t.maybeHiddenMarkers || (t.maybeHiddenMarkers = [])).push(this)
                    }
                };
                var gl = 0, yl = e.SharedTextMarker = function (e, t) {
                    this.markers = e, this.primary = t;
                    for (var n = 0; n < e.length; ++n)e[n].parent = this
                };
                Oi(yl), yl.prototype.clear = function () {
                    if (!this.explicitlyCleared) {
                ...
                Oi(xl), xl.prototype.clear = function () {
                    var e = this.doc.cm, t = this.line.widgets, n = this.line, r = ni(n);
                    if (null != r && t) {
                        for (var i = 0; i < t.length; ++i)t[i] == this && t.splice(i--, 1);
                        t.length || (n.widgets = null);
                        var o = Tr(this);
                        ti(n, Math.max(0, n.height - o)), e && Ot(e, function () {
                            Lr(e, n, -o), zt(e, r, "widget")
                        })
                    }
                    ...
                    this.height = null;
                    var r = Tr(this) - e;
                    r && (ti(n, n.height + r), t && Ot(t, function () {
                        t.curOp.forceUpdate = !0, Lr(t, n, r)
                    }))
                };
                var bl = e.Line = function (e, t, n) {
                    this.text = e, dr(this, t), this.height = n ? n(this) : 1
                };
                Oi(bl), bl.prototype.lineNo = function () {
                    return ni(this)
                };
                var wl = {}, kl = {};
                Kr.prototype = {
                    chunkSize: function () {
                        ...
                        for (var n = e, r = e + t; r > n; ++n) {
                            var i = this.lines[n];
                            this.height -= i.height, Ar(i), Li(i, "delete")
                        }
                    ...
                    chunkSize: function () {
                        ...
                        if (!(this.children.length <= 10)) {
                            var e = this;
                            do {
                                var t = e.children.splice(e.children.length - 5, 5), n = new Xr(t);
                                if (e.parent) {
                                    e.size -= n.size, e.height -= n.height;
                                    var r = Ei(e.parent.children, e);
                                    e.parent.children.splice(r + 1, 0, n)
                                } else {
                                    var i = new Xr(e.children);
                ...
                var Cl = 0, Sl = e.Doc = function (e, t, n, r) {
                    if (!(this instanceof Sl))return new Sl(e, t, n, r);
                    null == n && (n = 0), Xr.call(this, [new Kr([new bl("", null)])]), this.first = n, this.scrollTop = this.scrollLeft = 0, this.cantEdit = !1, this.cleanGeneration = 1, this.frontier = n;
                    var i = Fo(n, 0);
                    this.sel = pe(i), this.history = new li(null), this.id = ++Cl, this.modeOption = t, this.lineSep = r, this.extend = !1, "string" == typeof e && (e = this.splitLines(e)), Vr(this, {
                        from: i,
                        to: i,
                        text: e
                    }), Me(this, pe(i), zl)
                };
                Sl.prototype = zi(Xr.prototype, {
                    constructor: Sl, iter: function (e, t, n) {
                        ...
                        var t = Fo(this.first, 0), n = this.first + this.size - 1;
                        Mn(this, {
                            from: t,
                            to: Fo(n, Qr(this, n).text.length),
                            text: this.splitLines(e),
                            origin: "setValue",
                            full: !0
                        }, !0), Me(this, pe(t))
                    }), replaceRange: function (e, t, n, r) {
                        t = ge(this, t), n = n ? ge(this, n) : t, Dn(this, e, t, n, r)
                    }, getRange: function (e, t, n) {
                        var r = Jr(this, ge(this, e), ge(this, t));
                        return n === !1 ? r : r.join(n || this.lineSeparator())
                    }, getLine: function (e) {
                        var t = this.getLineHandle(e);
                        return t && t.text
                    }, getLineHandle: function (e) {
                        return ye(this, e) ? Qr(this, e) : void 0
                    }, getLineNumber: function (e) {
                        return ni(e)
                    }, getLineHandleVisualStart: function (e) {
                        return "number" == typeof e && (e = Qr(this, e)), xr(e)
                    }, lineCount: function () {
                        return this.size
                    }, firstLine: function () {
                        return this.first
                    ...
                    }, setCursor: Dt(function (e, t, n) {
                        Se(this, ge(this, "number" == typeof e ? Fo(e, t || 0) : e), null, n)
                    }), setSelection: Dt(function (e, t, n) {
                        Se(this, ge(this, e), ge(this, t || e), n)
                    }), extendSelection: Dt(function (e, t, n) {
                        we(this, ge(this, e), t && ge(this, t), n)
                    }), extendSelections: Dt(function (e, t) {
                        ke(this, xe(this, e, t))
                    }), extendSelectionsBy: Dt(function (e, t) {
                        ke(this, Ii(this.sel.ranges, e), t)
                    }), setSelections: Dt(function (e, t, n) {
                        if (e.length) {
                    ...
                    }), addSelection: Dt(function (e, t, n) {
                    ...
                    }, replaceSelections: Dt(function (e, t, n) {
                        for (var r = [], i = this.sel, o = 0; o < i.ranges.length; o++) {
                            var l = i.ranges[o];
                            r[o] = {from: l.from(), to: l.to(), text: this.splitLines(e[o]), origin: n}
                        }
                        for (var a = t && "end" != t && Ln(this, r, t), o = r.length - 1; o >= 0; o--)Mn(this, r[o]);
                        a ? Te(this, a) : this.cm && Rn(this.cm)
                    }), undo: Dt(function () {
                        An(this, "undo")
                    }), redo: Dt(function () {
                        An(this, "redo")
                    ...
                    }, addLineClass: Dt(function (e, t, n) {
                    ...
                    }), removeLineClass: Dt(function (e, t, n) {
                        return jn(this, e, "gutter" == t ? "gutter" : "class", function (e) {
                    ...
                    }), addLineWidget: Dt(function (e, t, n) {
                        return Mr(this, e, t, n)
                    }), removeLineWidget: function (e) {
                        e.clear()
                    }, markText: function (e, t, n) {
                        return Xn(this, ge(this, e), ge(this, t), n, n && n.type || "range")
                        ...
                        return e = ge(this, e), Xn(this, e, e, n, "bookmark")
                    }, findMarksAt: function (e) {
                        e = ge(this, e);
                        var t = [], n = Qr(this, e.line).markedSpans;
                        ...
                        var t = new Sl(ei(this, this.first, this.first + this.size), this.modeOption, this.first, this.lineSep);
                        return t.scrollTop = this.scrollTop, t.scrollLeft = this.scrollLeft, t.sel = this.sel, t.extend = !1, e && (t.history.undoDepth = this.history.undoDepth, t.setHistory(this.getHistory())), t
                    }, linkedDoc: function (e) {
                        e || (e = {});
                        var t = this.first, n = this.first + this.size;
                        null != e.from && e.from > t && (t = e.from), null != e.to && e.to < n && (n = e.to);
                        var r = new Sl(ei(this, t, n), e.mode || this.modeOption, t, this.lineSep);
                        return e.sharedHist && (r.history = this.history), (this.linked || (this.linked = [])).push({
                            doc: r,
                            sharedHist: e.sharedHist
                        }), r.linked = [{doc: this, isParent: !0, sharedHist: e.sharedHist}], Qn(r, Zn(this)), r
                    }, unlinkDoc: function (t) {
                        if (t instanceof e && (t = t.doc), this.linked)for (var n = 0; n < this.linked.length; ++n) {
                            var r = this.linked[n];
                            if (r.doc == t) {
                                this.linked.splice(n, 1), t.unlinkDoc(this), Jn(Zn(this));
                                break
                            }
                        }
                        if (t.history == this.history) {
                            ...
                            Yr(t, function (e) {
                                i.push(e.id)
                            }, !0), t.history = new li(null), t.history.done = vi(this.history.done, i), t.history.undone = vi(this.history.undone, i)
                        }
                        ...
                        return this.lineSep ? e.split(this.lineSep) : ta(e)
                    }, lineSeparator: function () {
                        return this.lineSep || "\n"
                    }
                }), Sl.prototype.eachLine = Sl.prototype.iter;
                var Ll = "iter insert remove copy getEditor constructor".split(" ");
                for (var Tl in Sl.prototype)Sl.prototype.hasOwnProperty(Tl) && Ei(Ll, Tl) < 0 && (e.prototype[Tl] = function (e) {
                    return function () {
                ...
                }, El = null, Il = 30, Pl = e.Pass = {
                    toString: function () {
                        return "CodeMirror.Pass"
                    }
                }, zl = {scroll: !1}, Fl = {origin: "*mouse"}, Rl = {origin: "+move"};
                Wi.prototype.set = function (e, t) {
                    clearTimeout(this.id), this.id = setTimeout(t, e)
                };
                var Bl = e.countColumn = function (e, t, n, r, i) {
                ...
                }, _l = e.findColumn = function (e, t, n) {
                    for (var r = 0, i = 0; ;) {
                        var o = e.indexOf("	", r);
                        -1 == o && (o = e.length);
                        var l = o - r;
                ...
                var Gl, Ul = /[\u00df\u0587\u0590-\u05f4\u0600-\u06ff\u3040-\u309f\u30a0-\u30ff\u3400-\u4db5\u4e00-\u9fcc\uac00-\ud7af]/, $l = e.isWordChar = function (e) {
                ...
                Gl = document.createRange ? function (e, t, n, r) {
                ...
                var Xl, Yl, Zl = e.rmClass = function (e, t) {
                ...
                !function () {
                    for (var e = 0; 10 > e; e++)oa[e + 48] = oa[e + 96] = String(e);
                ...
                var la, aa = function () {
                    ...
                    return function (n) {
                        ...
                        for (var b, w = [], h = 0; u > h;)if (a.test(d[h])) {
                            var k = h;
                        ...
                        return 1 == w[0].level && (b = n.match(/^\s+/)) && (w[0].from = b[0].length, w.unshift(new t(0, 0, b[0].length))), 1 == Di(w).level && (b = n.match(/\s+$/)) && (Di(w).to -= b[0].length, w.push(new t(0, u - b[0].length, u))), 2 == w[0].level && w.unshift(new t(1, w[0].to, w[0].to)), w[0].level != Di(w).level && w.push(new t(w[0].level, u, u)), w
                    }
                }();
                ...
                e.defineMode("markdown", function (t, n) {
                    ...
                    function p(t, r) {
                        ...
                        if ("\\" === s && (t.next(), n.highlightFormatting)) {
                            var u = h(r), d = L.formatting + "-escape";
                            return u ? u + " " + d : d
                        }
                        if (r.linkTitle) {
                            r.linkTitle = !1;
                    ...
                    var k = e.modes.hasOwnProperty("xml"), C = e.getMode(t, k ? {
                        name: "xml",
                        htmlMode: !0
                    } : "text/plain");
                    ...
                    var M = /^([*\-_])(?:\s*\1){2,}\s*$/, N = /^[*\-+]\s+/, A = /^[0-9]+([.)])\s+/, O = /^\[(x| )\](?=\s)/, W = n.allowAtxHeaderWithoutSpace ? /^(#+)/ : /^(#+)(?: |$)/, H = /^ *(?:\={1,}|-{1,})\s*$/, D = /^[^#!\[\]*_\\<>` "'(~]+/, E = new RegExp("^(" + (n.fencedCodeBlocks === !0 ? "~~~+|```+" : n.fencedCodeBlocks) + ")[ \\t]*([\\w+#]*)"), I = [], P = {
                        startState: function () {
                            return {
                                f: s,
                                prevLine: null,
                            ...
                            return e.block == c ? {state: e.htmlState, mode: C} : e.localState ? {
                                state: e.localState,
                                mode: e.localMode
                            } : {state: e, mode: P}
                        }, blankLine: a, getType: h, fold: "markdown"
                    };
                    return P
        ...
        10: [function (t, n, r) {
            !function (i) {
                ...
                e.defineMode("xml", function (t, n) {
                    ...
                    var b = t.indentUnit, w = n.multilineTagIndentFactor || 1, k = n.multilineTagIndentPastTag;
                    null == k && (k = !0);
            ...
            (function (t) {
                (function () {
                    ...
                    f.bullet = /(?:[*+-]|\d+\.)/, f.item = /^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/, f.item = c(f.item, "gm")(/bull/g, f.bullet)(), f.list = c(f.list)(/bull/g, f.bullet)("hr", "\\n+(?=\\1?(?:[-*_] *){3,}(?:\\n+|$))")("def", "\\n+(?=" + f.def.source + ")")(), f.blockquote = c(f.blockquote)("def", f.def)(), f._tag = "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:/|[^\\w\\s@]*@)\\b", f.html = c(f.html)("comment", /<!--[\s\S]*?-->/)("closed", /<(tag)[\s\S]+?<\/\1>/)("closing", /<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(/tag/g, f._tag)(), f.paragraph = c(f.paragraph)("hr", f.hr)("heading", f.heading)("lheading", f.lheading)("blockquote", f.blockquote)("tag", "<" + f._tag)("def", f.def)(), f.normal = d({}, f), f.gfm = d({}, f.normal, {
                        ...
                        for (var r, i, o, l, a, s, c, u, d, e = e.replace(/^ +$/gm, ""); e;)if ((o = this.rules.newline.exec(e)) && (e = e.substring(o[0].length), o[0].length > 1 && this.tokens.push({type: "space"})), o = this.rules.code.exec(e))e = e.substring(o[0].length), o = o[0].replace(/^ {4}/gm, ""), this.tokens.push({
                            type: "code",
        ...
        13: [function (e, t, n) {
            "use strict";
            function r(e) {
                return e = F ? e.replace("Ctrl", "Cmd") : e.replace("Cmd", "Ctrl")
            }

            function i(e, t) {
                e = e || {};
                var n = document.createElement("a");
                return t = void 0 == t ? !0 : t, e.title && t && (n.title = e.title, F && (n.title = n.title.replace("Ctrl", "⌘"), n.title = n.title.replace("Alt", "⌥"))), n.tabIndex = -1, n.className = e.className, n
            }
            ...
            function a(e) {
                var t = e.codemirror;
                t.setOption("fullScreen", !t.getOption("fullScreen")), t.getOption("fullScreen") ? (_ = document.body.style.overflow, document.body.style.overflow = "hidden") : document.body.style.overflow = _;
                ...
                /editor-preview-active-side/.test(i.className) && T(e)
            }
            ...
            function b(e) {
                ...
                N(t, n.link, r.insertTexts.link)
            }

            function w(e) {
                var t = e.codemirror, n = l(t), r = e.options;
                N(t, n.image, r.insertTexts.image)
            }
            ...
            function M(e) {
                var t = e.codemirror, n = t.getWrapperElement(), r = n.previousSibling, i = e.toolbarElements.preview, o = n.lastChild;
                ...
                /editor-preview-active-side/.test(l.className) && T(e)
            }

            function N(e, t, n) {
                if (!/editor-preview-active/.test(e.getWrapperElement().lastChild.className)) {
                    var r, i = n[0], o = n[1], l = e.getCursor("start"), a = e.getCursor("end");
            ...
            function W(e, t, n, r) {
                if (!/editor-preview-active/.test(e.codemirror.getWrapperElement().lastChild.className)) {
                    ...
                    var i, o = e.codemirror, a = l(o), s = n, c = r, u = o.getCursor("start"), d = o.getCursor("end");
            ...
            function H(e, t) {
                for (var n in t)t.hasOwnProperty(n) && (t[n] instanceof Array ? e[n] = t[n].concat(e[n] instanceof Array ? e[n] : []) : null !== t[n] && "object" == typeof t[n] && t[n].constructor === Object ? e[n] = H(e[n] || {}, t[n]) : e[n] = t[n]);
                return e
            }

            function D(e) {
                for (var t = 1; t < arguments.length; t++)e = H(e, arguments[t]);
                return e
            }

            function E(e) {
                var t = /[a-zA-Z0-9_\u0392-\u03c9]+|[\u4E00-\u9FFF\u3400-\u4dbf\uf900-\ufaff\u3040-\u309f\uac00-\ud7af]+/g, n = e.match(t), r = 0;
                if (null === n)return r;
            ...
            function I(e) {
                ...
                if (void 0 === e.toolbar) {
                    e.toolbar = [];
                    for (var o in j)j.hasOwnProperty(o) && (-1 != o.indexOf("separator-") && e.toolbar.push("|"), (j[o]["default"] === !0 || e.showIcons && e.showIcons.constructor === Array && -1 != e.showIcons.indexOf(o)) && e.toolbar.push(o))
                }
                ...
                }), e.parsingConfig = e.parsingConfig || {}, e.insertTexts = D({}, q, e.insertTexts || {}), e.blockStyles = D({}, G, e.blockStyles || {}), void 0 != e.autosave && void 0 != e.autosave.unique_id && "" != e.autosave.unique_id && (e.autosave.uniqueId = e.autosave.unique_id), this.options = e, this.render(), !e.initialValue || this.options.autosave && this.options.autosave.foundSavedValue === !0 || this.value(e.initialValue)
            }
            ...
            var z = e("marked"), F = /Mac/.test(navigator.platform), R = {
                "Cmd-B": s,
                "Cmd-I": c,
                "Cmd-K": b,
                "Cmd-H": f,
                ...
                bold: {name: "bold", action: s, className: "fa fa-bold", title: "Bold (Ctrl+B)", "default": !0},
                italic: {name: "italic", action: c, className: "fa fa-italic", title: "Italic (Ctrl+I)", "default": !0},
                strikethrough: {
                    name: "strikethrough",
                    action: u,
                ...
                code: {name: "code", action: d, className: "fa fa-code", title: "Code (Ctrl+Alt+C)"},
                quote: {
                    name: "quote",
                    action: h,
                ...
                "unordered-list": {
                    name: "unordered-list", action: y,
                    className: "fa fa-list-ul", title: "Generic List (Ctrl+L)", "default": !0
                },
                "ordered-list": {
                    name: "ordered-list",
                    action: x,
                ...
                link: {name: "link", action: b, className: "fa fa-link", title: "Create Link (Ctrl+K)", "default": !0},
                image: {
                    name: "image",
                    action: w,
                ...
                table: {name: "table", action: k, className: "fa fa-table", title: "Insert Table"},
                "horizontal-rule": {
            ...
            I.prototype.markdown = function (e) {
                ...
                if (e || (e = this.element || document.getElementsByTagName("textarea")[0]), !this._rendered || this._rendered !== e) {
                    ...
                    i.Enter = "newlineAndIndentContinueMarkdownList", i.Tab = "tabAndIndentMarkdownList", i["Shift-Tab"] = "shiftTabAndUnindentMarkdownList", i.F11 = function () {
                        ...
                        e = e || window.event, 27 == e.keyCode && n.codemirror.getOption("fullScreen") && a(n)
                    }, !1);
                    var l, s;
                    t.spellChecker !== !1 ? (l = "spell-checker", s = t.parsingConfig, s.name = "gfm", s.gitHubSpice = !1) : (l = t.parsingConfig, l.name = "gfm", l.gitHubSpice = !1), this.codemirror = P.fromTextArea(e, {
                        mode: l,
                        backdrop: s,
                        theme: "paper",
                ...
                if (localStorage) {
                    ...
                    if (null != t && void 0 != t && "" != t) {
                        var n = new Date, r = n.getHours(), i = n.getMinutes(), o = "am", l = r;
                ...
                if (e = e || this.options.toolbar, e && 0 !== e.length) {
                    var t;
                    for (t = 0; t < e.length; t++)void 0 != j[e[t]] && (e[t] = j[e[t]]);
                    var n = document.createElement("div");
                    n.className = "editor-toolbar";
                    var r = this, a = {};
                    for (r.toolbar = e, t = 0; t < e.length; t++)("guide" != e[t].name || r.options.toolbarGuideIcon !== !1) && (r.options.hideIcons && -1 != r.options.hideIcons.indexOf(e[t].name) || ("fullscreen" != e[t].name && "side-by-side" != e[t].name || !B()) && !function (e) {
                        var t;
