...
(function ($) {
    ...
    skel.init({
        ...
        breakpoints: {
            ...
            normal: {
                range: '-1280',
                href: '/themes/alpha/css/style-normal.css',
                viewport: {
                    scalable: false
                }
            },
            ...
            narrower: {
                range: '-840',
                href: '/themes/alpha/css/style-narrower.css',
                containers: '90%!',
                grid: {
                    zoom: 2
                }
            ...
            mobile: {
                range: '-736',
                href: '/themes/alpha/css/style-mobile.css',
                containers: '100%!',
                grid: {
                    zoom: 2
                }
            ...
            mobilep: {
                range: '-480',
                href: '/themes/alpha/css/style-mobilep.css',
                grid: {
                    zoom: 5,
                    gutters: ['1em', 0]
                }
