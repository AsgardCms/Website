...
!function(e){var n="openerActiveClass",t="click touchend",o="left",i="doCollapseAll",a="position",s="trigger",r="disableSelection_dropotron",f="addClass",c="doCollapse",l=!1,u="outerWidth",d="removeClass",h="preventDefault",p="length",w="dropotron",g="clearTimeout",m="right",v="parent",b=!0,k="speed",x="none",y="stopPropagation",C="doExpand",O=":visible",I="absolute",T="css",D="center",E="toggle",Y="baseZIndex",P="offsetX",M="alignment",A="submenuClassPrefix",X="children",z="hover",F="relative",S="doToggle",Z="ul",j="z-index",H="opacity",Q="find",R="opener",W="px",$=null,_="hide",q="offset",B="detach",G="fast";e.fn[r]=function(){return e(this)[T]("user-select",x)[T]("-khtml-user-select",x)[T]("-moz-user-select",x)[T]("-o-user-select",x)[T]("-webkit-user-select",x)},e.fn[w]=function(n){var t;if(0==this[p])return e(this);if(this[p]>1)for(t=0;t<this[p];t++)e(this[t])[w](n);return e[w](e.extend({selectorParent:e(this)},n))},e[w]=function(x){var J=e.extend({selectorParent:$,baseZIndex:1e3,menuClass:w,expandMode:z,hoverDelay:150,hideDelay:250,openerClass:R,openerActiveClass:"active",submenuClassPrefix:"level-",mode:"fade",speed:G,easing:"swing",alignment:o,offsetX:0,offsetY:0,globalOffsetY:0,IEOffsetX:0,IEOffsetY:0,noOpenerFade:b,detach:b,cloneOnDetach:b},x),K=J.selectorParent,L=K[Q](Z),N=e("body"),U=e("body,html"),V=e(window),ee=l,ne=$,te=$;K.on(i,function(){L[s](c)}),L.each(function(){var i=e(this),p=i[v]();J.hideDelay>0&&i.add(p).on("mouseleave",function(){window[g](te),te=window.setTimeout(function(){i[s](c)},J.hideDelay)}),i[r]()[_]()[f](J.menuClass)[T](a,I).on("mouseenter",function(){window[g](te)}).on(C,function(){var t,r,h,w,x,y,C,A,X,z,S;if(i.is(O))return l;if(window[g](te),L.each(function(){var n=e(this);e.contains(n.get(0),p.get(0))||n[s](c)}),t=p[q](),r=p[a](),h=p[v]()[a](),w=p[u](),x=i[u](),y=i[T](j)==J[Y],y){switch(C=J[B]?t:r,z=C.top+p.outerHeight()+J.globalOffsetY,A=J[M],i[d](o)[d](m)[d](D),J[M]){case m:X=C[o]-x+w,0>X&&(X=C[o],A=o);break;case D:X=C[o]-Math.floor((x-w)/2),0>X?(X=C[o],A=o):X+x>V.width()&&(X=C[o]-x+w,A=m);break;case o:default:X=C[o],X+x>V.width()&&(X=C[o]-x+w,A=m)}i[f](A)}else switch(p[T](a)==F||p[T](a)==I?(z=J.offsetY,X=-1*r[o]):(z=r.top+J.offsetY,X=0),J[M]){case m:X+=-1*p[v]()[u]()+J[P];break;case D:case o:default:X+=p[v]()[u]()+J[P]}switch(navigator.userAgent.match(/MSIE ([0-9]+)\./)&&RegExp.$1<8&&(X+=J.IEOffsetX,z+=J.IEOffsetY),i[T](o,X+W)[T]("top",z+W)[T](H,"0.01").show(),S=l,X=p[T](a)==F||p[T](a)==I?-1*r[o]:0,i[q]()[o]<0?(X+=p[v]()[u]()-J[P],S=b):i[q]()[o]+x>V.width()&&(X+=-1*p[v]()[u]()-J[P],S=b),S&&i[T](o,X+W),i[_]()[T](H,"1"),J.mode){case"zoom":ee=b,p[f](J[n]),i.animate({width:E,height:E},J[k],J.easing,function(){ee=l});break;case"slide":ee=b,p[f](J[n]),i.animate({height:E},J[k],J.easing,function(){ee=l});break;case"fade":ee=b,y&&!J.noOpenerFade?(S="slow"==J[k]?80:J[k]==G?40:Math.floor(J[k]/2),p.fadeTo(S,.01,function(){p[f](J[n]),p.fadeTo(J[k],1),i.fadeIn(J[k],function(){ee=l})})):(p[f](J[n]),p.fadeTo(J[k],1),i.fadeIn(J[k],function(){ee=l}));break;case"instant":default:p[f](J[n]),i.show()}return l}).on(c,function(){return i.is(O)?(i[_](),p[d](J[n]),i[Q]("."+J[n])[d](J[n]),i[Q](Z)[_](),l):l}).on(S,function(){return i[s](i.is(O)?c:C),l}),p[r]()[f](R)[T]("cursor","pointer").on(t,function(e){ee||(e[h](),e[y](),i[s](S))}),J.expandMode==z&&p[z](function(){ee||(ne=window.setTimeout(function(){i[s](C)},J.hoverDelay))},function(){window[g](ne)})}),L[Q]("a")[T]("display","block").on(t,function(n){ee||e(this).attr("href")[p]<1&&n[h]()}),K[Q]("li")[T]("white-space","nowrap").each(function(){var n=e(this),o=n[X]("a"),a=n[X](Z),r=o.attr("href");o.on(t,function(e){0==r[p]||"#"==r?e[h]():e[y]()}),o[p]>0&&0==a[p]&&n.on(t,function(e){ee||(K[s](i),e[y]())})}),K[X]("li").each(function(){var n,t,o,i,a=e(this),s=a[X](Z);if(s[p]>0)for(J[B]&&(J.cloneOnDetach&&(n=s.clone(),n.attr("class","")[_]().appendTo(s[v]())),s[B]().appendTo(N)),t=J[Y],o=1,i=s;i[p]>0;o++)i[T](j,t++),J[A]&&i[f](J[A]+(t-1-J[Y])),i=i[Q]("> li > ul")}),V.on("scroll",function(){K[s](i)}).on("keypress",function(e){!ee&&27==e.keyCode&&(e[h](),K[s](i))}),U.on(t,function(){ee||K[s](i)})}}(jQuery);
!function(){var t="scrollwatchResume",r="length",i="removeData",n="data",e="scrollwatch-state",s="scrollwatch-suspended",o="scrollgress-suspended",a="setTimeout",h="trigger",c="scroll",u="scrollwatchSuspend",f=!0,l="scrollwatch",d=null,w="top",g="rangeMin",v="rangeMax",m="scrollgress",y=!1,b="anchor",j="unscrollwatch",p="unscrollgress",M="element",Q="-id",k="scroll.",x="height",T="scrollTop",D="center",H="bottom",I=$(window),R=$(document),S=1e3;jQuery.fn[t]=function(){var u,f;if(0==this[r])return $(this);if(this[r]>1){for(u=0;u<this[r];u++)$(this[u])[t]();return this}return f=$(this),f[n](e,-1)[i](s)[i](o),window[a](function(){I[h](c)},50),f},jQuery.fn[u]=function(){var t,i;if(0==this[r])return $(this);if(this[r]>1){for(t=0;t<this[r];t++)$(this[t])[u]();return this}return i=$(this),i[n](s,f),window[a](function(){I[h](c)},50),i},jQuery.fn[l]=function(t){var i,h,c,u,j;if(0==this[r])return $(this);if(this[r]>1){for(i=0;i<this[r];i++)$(this[i])[l](t);return this}return h=jQuery.extend({range:.5,rangeMin:d,rangeMax:d,anchor:w,init:d,on:d,off:d,delay:0},t),h[g]===d&&(h[g]=-1*h.range),h[v]===d&&(h[v]=h.range),c=$(this),h.init&&(j=h.init),c[n](s,y)[n](e,-1)[m](function(t){return c[n](s)===f?(h.on&&h.on(c),void c[n](o,f)):(window.clearTimeout(u),void(u=window[a](function(){var r,i,s=parseInt(c[n](e));return(0==s||-1==s)&&(r=h[g]===y||t>=h[g],i=h[v]===y||t<=h[v],r&&i)?(c[n](e,1),h.on&&h.on(c),j&&(j(c,f),j=d),void 0):(1==s||-1==s)&&(r=h[g]!==y&&t<h[g],i=h[v]!==y&&t>h[v],r||i)?(c[n](e,0),h.off&&h.off(c),j&&(j(c,y),j=d),void 0):void 0},j?0:h.delay)))},{anchor:h[b]},l),c},jQuery.fn[j]=function(){var t,n;if(0==this[r])return $(this);if(this[r]>1){for(t=0;t<this[r];t++)$(this[t])[j]();return this}return n=$(this),n[i](e)[p](l),n},jQuery.fn[m]=function(t,i,e){var s,a,u,l,d;if(0==this[r])return $(this);if(this[r]>1){for(s=0;s<this[r];s++)$(this[s])[m](t,i,e);return $(this)}return e||(e=m),a=jQuery.extend({anchor:w,direction:"both",scope:M,easing:0},i),u=$(this),u[n](e+Q)||u[n](e+Q,S++),l=u[n](e+Q),d=k+e+"-"+l,I.off(d).on(d,function(){var r,i,e,s;if(u[n](o)!==f){switch(r=u.offset()[w],i=u.outerHeight(),e=R[x](),a.scope){default:case M:switch(a[b]){default:case w:s=(r-I[T]())/i*-1;break;case D:s=(r-I[T]()-(I[x]()-i)/2)/i*-1;break;case H:s=(r-I[T]()-(I[x]()-i))/i*-1}break;case"window":switch(a[b]){default:case w:s=(r-I[T]())/I[x]()*-1;break;case D:s=(r-I[T]()-(I[x]()-i)/2)/I[x]()*-1;break;case H:s=(r-I[T]()-(I[x]()-i))/I[x]()*-1}}"forwards"==a.direction?s=Math.max(0,s):"backwards"==a.direction&&(s=Math.min(0,s)),s>0?s=Math.max(0,s-a.easing/100):0>s&&(s=Math.min(0,s+a.easing/100)),t(s,u)}})[h](c),u},jQuery.fn[p]=function(t){var e,s,o,a;if(0==this[r])return $(this);if(this[r]>1){for(e=0;e<this[r];e++)$(this[e])[p](t);return $(this)}return t||(t=m),s=$(this),s[n](t+Q)?(o=s[n](t+Q),a=k+t+"-"+o,I.off(a),s[i](t+Q),s):s}}();
self="undefined"!=typeof window?window:"undefined"!=typeof WorkerGlobalScope&&self instanceof WorkerGlobalScope?self:{};var Prism=function(){var e=/\blang(?:uage)?-(?!\*)(\w+)\b/i,t=self.Prism={util:{encode:function(e){return e instanceof a?new a(e.type,t.util.encode(e.content),e.alias):"Array"===t.util.type(e)?e.map(t.util.encode):e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/\u00a0/g," ")},type:function(e){return Object.prototype.toString.call(e).match(/\[object (\w+)\]/)[1]},clone:function(e){var a=t.util.type(e);switch(a){case"Object":var n={};for(var r in e)e.hasOwnProperty(r)&&(n[r]=t.util.clone(e[r]));return n;case"Array":return e.slice()}return e}},languages:{extend:function(e,a){var n=t.util.clone(t.languages[e]);for(var r in a)n[r]=a[r];return n},insertBefore:function(e,a,n,r){r=r||t.languages;var i=r[e];if(2==arguments.length){n=arguments[1];for(var s in n)n.hasOwnProperty(s)&&(i[s]=n[s]);return i}var o={};for(var l in i)if(i.hasOwnProperty(l)){if(l==a)for(var s in n)n.hasOwnProperty(s)&&(o[s]=n[s]);o[l]=i[l]}return t.languages.DFS(t.languages,function(t,a){a===r[e]&&t!=e&&(this[t]=o)}),r[e]=o},DFS:function(e,a,n){for(var r in e)e.hasOwnProperty(r)&&(a.call(e,r,e[r],n||r),"Object"===t.util.type(e[r])?t.languages.DFS(e[r],a):"Array"===t.util.type(e[r])&&t.languages.DFS(e[r],a,r))}},highlightAll:function(e,a){for(var n,r=document.querySelectorAll('code[class*="language-"], [class*="language-"] code, code[class*="lang-"], [class*="lang-"] code'),i=0;n=r[i++];)t.highlightElement(n,e===!0,a)},highlightElement:function(n,r,i){for(var s,o,l=n;l&&!e.test(l.className);)l=l.parentNode;if(l&&(s=(l.className.match(e)||[,""])[1],o=t.languages[s]),o){n.className=n.className.replace(e,"").replace(/\s+/g," ")+" language-"+s,l=n.parentNode,/pre/i.test(l.nodeName)&&(l.className=l.className.replace(e,"").replace(/\s+/g," ")+" language-"+s);var g=n.textContent;if(g){var c={element:n,language:s,grammar:o,code:g};if(t.hooks.run("before-highlight",c),r&&self.Worker){var u=new Worker(t.filename);u.onmessage=function(e){c.highlightedCode=a.stringify(JSON.parse(e.data),s),t.hooks.run("before-insert",c),c.element.innerHTML=c.highlightedCode,i&&i.call(c.element),t.hooks.run("after-highlight",c)},u.postMessage(JSON.stringify({language:c.language,code:c.code}))}else c.highlightedCode=t.highlight(c.code,c.grammar,c.language),t.hooks.run("before-insert",c),c.element.innerHTML=c.highlightedCode,i&&i.call(n),t.hooks.run("after-highlight",c)}}},highlight:function(e,n,r){var i=t.tokenize(e,n);return a.stringify(t.util.encode(i),r)},tokenize:function(e,a,n){var r=t.Token,i=[e],s=a.rest;if(s){for(var o in s)a[o]=s[o];delete a.rest}e:for(var o in a)if(a.hasOwnProperty(o)&&a[o]){var l=a[o];l="Array"===t.util.type(l)?l:[l];for(var g=0;g<l.length;++g){var c=l[g],u=c.inside,p=!!c.lookbehind,d=0,m=c.alias;c=c.pattern||c;for(var h=0;h<i.length;h++){var f=i[h];if(i.length>e.length)break e;if(!(f instanceof r)){c.lastIndex=0;var y=c.exec(f);if(y){p&&(d=y[1].length);var k=y.index-1+d,y=y[0].slice(d),b=y.length,w=k+b,P=f.slice(0,k+1),v=f.slice(w+1),S=[h,1];P&&S.push(P);var A=new r(o,u?t.tokenize(y,u):y,m);S.push(A),v&&S.push(v),Array.prototype.splice.apply(i,S)}}}}}return i},hooks:{all:{},add:function(e,a){var n=t.hooks.all;n[e]=n[e]||[],n[e].push(a)},run:function(e,a){var n=t.hooks.all[e];if(n&&n.length)for(var r,i=0;r=n[i++];)r(a)}}},a=t.Token=function(e,t,a){this.type=e,this.content=t,this.alias=a};if(a.stringify=function(e,n,r){if("string"==typeof e)return e;if("[object Array]"==Object.prototype.toString.call(e))return e.map(function(t){return a.stringify(t,n,e)}).join("");var i={type:e.type,content:a.stringify(e.content,n,r),tag:"span",classes:["token",e.type],attributes:{},language:n,parent:r};if("comment"==i.type&&(i.attributes.spellcheck="true"),e.alias){var s="Array"===t.util.type(e.alias)?e.alias:[e.alias];Array.prototype.push.apply(i.classes,s)}t.hooks.run("wrap",i);var o="";for(var l in i.attributes)o+=l+'="'+(i.attributes[l]||"")+'"';return"<"+i.tag+' class="'+i.classes.join(" ")+'" '+o+">"+i.content+"</"+i.tag+">"},!self.document)return self.addEventListener?(self.addEventListener("message",function(e){var a=JSON.parse(e.data),n=a.language,r=a.code;self.postMessage(JSON.stringify(t.util.encode(t.tokenize(r,t.languages[n])))),self.close()},!1),self.Prism):self.Prism;var n=document.getElementsByTagName("script");return n=n[n.length-1],n&&(t.filename=n.src,document.addEventListener&&!n.hasAttribute("data-manual")&&document.addEventListener("DOMContentLoaded",t.highlightAll)),self.Prism}();"undefined"!=typeof module&&module.exports&&(module.exports=Prism),Prism.languages.markup={comment:/<!--[\w\W]*?-->/g,prolog:/<\?.+?\?>/,doctype:/<!DOCTYPE.+?>/,cdata:/<!\[CDATA\[[\w\W]*?]]>/i,tag:{pattern:/<\/?[\w:-]+\s*(?:\s+[\w:-]+(?:=(?:("|')(\\?[\w\W])*?\1|[^\s'">=]+))?\s*)*\/?>/gi,inside:{tag:{pattern:/^<\/?[\w:-]+/i,inside:{punctuation:/^<\/?/,namespace:/^[\w-]+?:/}},"attr-value":{pattern:/=(?:('|")[\w\W]*?(\1)|[^\s>]+)/gi,inside:{punctuation:/=|>|"/g}},punctuation:/\/?>/g,"attr-name":{pattern:/[\w:-]+/g,inside:{namespace:/^[\w-]+?:/}}}},entity:/\&#?[\da-z]{1,8};/gi},Prism.hooks.add("wrap",function(e){"entity"===e.type&&(e.attributes.title=e.content.replace(/&amp;/,"&"))}),Prism.languages.css={comment:/\/\*[\w\W]*?\*\//g,atrule:{pattern:/@[\w-]+?.*?(;|(?=\s*{))/gi,inside:{punctuation:/[;:]/g}},url:/url\((["']?).*?\1\)/gi,selector:/[^\{\}\s][^\{\};]*(?=\s*\{)/g,property:/(\b|\B)[\w-]+(?=\s*:)/gi,string:/("|')(\\?.)*?\1/g,important:/\B!important\b/gi,punctuation:/[\{\};:]/g,"function":/[-a-z0-9]+(?=\()/gi},Prism.languages.markup&&(Prism.languages.insertBefore("markup","tag",{style:{pattern:/<style[\w\W]*?>[\w\W]*?<\/style>/gi,inside:{tag:{pattern:/<style[\w\W]*?>|<\/style>/gi,inside:Prism.languages.markup.tag.inside},rest:Prism.languages.css},alias:"language-css"}}),Prism.languages.insertBefore("inside","attr-value",{"style-attr":{pattern:/\s*style=("|').+?\1/gi,inside:{"attr-name":{pattern:/^\s*style/gi,inside:Prism.languages.markup.tag.inside},punctuation:/^\s*=\s*['"]|['"]\s*$/,"attr-value":{pattern:/.+/gi,inside:Prism.languages.css}},alias:"language-css"}},Prism.languages.markup.tag)),Prism.languages.css.selector={pattern:/[^\{\}\s][^\{\}]*(?=\s*\{)/g,inside:{"pseudo-element":/:(?:after|before|first-letter|first-line|selection)|::[-\w]+/g,"pseudo-class":/:[-\w]+(?:\(.*\))?/g,"class":/\.[-:\.\w]+/g,id:/#[-:\.\w]+/g}},Prism.languages.insertBefore("css","ignore",{hexcode:/#[\da-f]{3,6}/gi,entity:/\\[\da-f]{1,8}/gi,number:/[\d%\.]+/g}),Prism.languages.clike={comment:[{pattern:/(^|[^\\])\/\*[\w\W]*?\*\//g,lookbehind:!0},{pattern:/(^|[^\\:])\/\/.*?(\r?\n|$)/g,lookbehind:!0}],string:/("|')(\\?.)*?\1/g,"class-name":{pattern:/((?:(?:class|interface|extends|implements|trait|instanceof|new)\s+)|(?:catch\s+\())[a-z0-9_\.\\]+/gi,lookbehind:!0,inside:{punctuation:/(\.|\\)/}},keyword:/\b(if|else|while|do|for|return|in|instanceof|function|new|try|throw|catch|finally|null|break|continue)\b/g,"boolean":/\b(true|false)\b/g,"function":{pattern:/[a-z0-9_]+\(/gi,inside:{punctuation:/\(/}},number:/\b-?(0x[\dA-Fa-f]+|\d*\.?\d+([Ee]-?\d+)?)\b/g,operator:/[-+]{1,2}|!|<=?|>=?|={1,3}|&{1,2}|\|?\||\?|\*|\/|\~|\^|\%/g,ignore:/&(lt|gt|amp);/gi,punctuation:/[{}[\];(),.:]/g},Prism.languages.javascript=Prism.languages.extend("clike",{keyword:/\b(break|case|catch|class|const|continue|debugger|default|delete|do|else|enum|export|extends|false|finally|for|function|get|if|implements|import|in|instanceof|interface|let|new|null|package|private|protected|public|return|set|static|super|switch|this|throw|true|try|typeof|var|void|while|with|yield)\b/g,number:/\b-?(0x[\dA-Fa-f]+|\d*\.?\d+([Ee]-?\d+)?|NaN|-?Infinity)\b/g}),Prism.languages.insertBefore("javascript","keyword",{regex:{pattern:/(^|[^/])\/(?!\/)(\[.+?]|\\.|[^/\r\n])+\/[gim]{0,3}(?=\s*($|[\r\n,.;})]))/g,lookbehind:!0}}),Prism.languages.markup&&Prism.languages.insertBefore("markup","tag",{script:{pattern:/<script[\w\W]*?>[\w\W]*?<\/script>/gi,inside:{tag:{pattern:/<script[\w\W]*?>|<\/script>/gi,inside:Prism.languages.markup.tag.inside},rest:Prism.languages.javascript},alias:"language-javascript"}}),Prism.languages.php=Prism.languages.extend("clike",{keyword:/\b(and|or|xor|array|as|break|case|cfunction|class|const|continue|declare|default|die|do|else|elseif|enddeclare|endfor|endforeach|endif|endswitch|endwhile|extends|for|foreach|function|include|include_once|global|if|new|return|static|switch|use|require|require_once|var|while|abstract|interface|public|implements|private|protected|parent|throw|null|echo|print|trait|namespace|final|yield|goto|instanceof|finally|try|catch)\b/gi,constant:/\b[A-Z0-9_]{2,}\b/g,comment:{pattern:/(^|[^\\])(\/\*[\w\W]*?\*\/|(^|[^:])(\/\/|#).*?(\r?\n|$))/g,lookbehind:!0}}),Prism.languages.insertBefore("php","keyword",{delimiter:/(\?>|<\?php|<\?)/gi,variable:/(\$\w+)\b/gi,"package":{pattern:/(\\|namespace\s+|use\s+)[\w\\]+/g,lookbehind:!0,inside:{punctuation:/\\/}}}),Prism.languages.insertBefore("php","operator",{property:{pattern:/(->)[\w]+/g,lookbehind:!0}}),Prism.languages.markup&&(Prism.hooks.add("before-highlight",function(e){"php"===e.language&&(e.tokenStack=[],e.backupCode=e.code,e.code=e.code.replace(/(?:<\?php|<\?)[\w\W]*?(?:\?>)/gi,function(t){return e.tokenStack.push(t),"{{{PHP"+e.tokenStack.length+"}}}"}))}),Prism.hooks.add("before-insert",function(e){"php"===e.language&&(e.code=e.backupCode,delete e.backupCode)}),Prism.hooks.add("after-highlight",function(e){if("php"===e.language){for(var t,a=0;t=e.tokenStack[a];a++)e.highlightedCode=e.highlightedCode.replace("{{{PHP"+(a+1)+"}}}",Prism.highlight(t,e.grammar,"php"));e.element.innerHTML=e.highlightedCode}}),Prism.hooks.add("wrap",function(e){"php"===e.language&&"markup"===e.type&&(e.content=e.content.replace(/(\{\{\{PHP[0-9]+\}\}\})/g,'<span class="token php">$1</span>'))}),Prism.languages.insertBefore("php","comment",{markup:{pattern:/<[^?]\/?(.*?)>/g,inside:Prism.languages.markup},php:/\{\{\{PHP[0-9]+\}\}\}/g})),Prism.languages.insertBefore("php","variable",{"this":/\$this/g,global:/\$_?(GLOBALS|SERVER|GET|POST|FILES|REQUEST|SESSION|ENV|COOKIE|HTTP_RAW_POST_DATA|argc|argv|php_errormsg|http_response_header)/g,scope:{pattern:/\b[\w\\]+::/g,inside:{keyword:/(static|self|parent)/,punctuation:/(::|\\)/}}}),Prism.languages.bash=Prism.languages.extend("clike",{comment:{pattern:/(^|[^"{\\])(#.*?(\r?\n|$))/g,lookbehind:!0},string:{pattern:/("|')(\\?[\s\S])*?\1/g,inside:{property:/\$([a-zA-Z0-9_#\?\-\*!@]+|\{[^\}]+\})/g}},keyword:/\b(if|then|else|elif|fi|for|break|continue|while|in|case|function|select|do|done|until|echo|exit|return|set|declare)\b/g}),Prism.languages.insertBefore("bash","keyword",{property:/\$([a-zA-Z0-9_#\?\-\*!@]+|\{[^}]+\})/g}),Prism.languages.insertBefore("bash","comment",{important:/(^#!\s*\/bin\/bash)|(^#!\s*\/bin\/sh)/g}),Prism.languages.git={comment:/^#.*$/m,string:/("|')(\\?.)*?\1/gm,command:{pattern:/^.*\$ git .*$/m,inside:{parameter:/\s(--|-)\w+/m}},coord:/^@@.*@@$/m,deleted:/^-(?!-).+$/m,inserted:/^\+(?!\+).+$/m,commit_sha1:/^commit \w{40}$/m};
var skel=function(){var e="breakpoints",t="config",n="iterate",i="elements",o="stateId",r="stateElements",a="getElementsByClassName",c=!1,u="getElementsByTagName",s="length",d="gridLevelMax",l=null,f="getCachedElement",m="viewport",p=" 0 -1px ",h="cacheNewElement",g="config_breakpoint",w="createElement",b=!0,v="gutters",y="vars",x="insertBefore",k="newInline",E="substring",M="}",S="parentNode",z="cache",R="locations",T="gridLevelMap",C="orientationChange",A="deviceType",_="className",I=" 0 0 ",L="object",j="isArray",O="match",P="grid",N="+*,",q="replace",$="head",F="newElement",D="canUseProperty_element",G="indexOf",B="_skel_isReversed",U="push",W="extend",V="matchesMedia",H="DOMReady",X="containers",J="onorientationchange",Z="defaults",K="lock",Q="getComputedStyle",Y="addEventListener",ee="^head",te="{display:none!important}",ne="parseMeasurement",ie="isActive",oe="charAt",re="registerLocation",ae="trigger",ce="IEVersion",ue="documentElement",se="events",de="placeholder",le="level",fe="attachElements",me="isStatic",pe="attachElement",he="plugins",ge="DOMContentLoaded",we="text/css",be="device-width",ve="states",ye="initial-scale=1",xe="_skel_attach",ke="removeEventListener",Ee="split",Me="resize",Se="attached",ze="location",Re="change",Te="normalize",Ce="collapse",Ae="applyRowTransforms",_e="media",Ie="previousSibling",Le="(min-width: ",je="html",Oe="style",Pe="firstChild",Ne="forceDefaultState",qe="_skel_placeholder",$e="querySelectorAll",Fe="min-height",De="max-height",Ge="min-width",Be="innerHTML",Ue="prototype",We="max-width",Ve="nextSibling",He="hasOwnProperty",Xe="domready",Je="onresize",Ze="priority",Ke="href",Qe=".\\3$1 ",Ye="android",et="readyState",tt="height=",nt={breakpoints:[],breakpointList:[],cache:{elements:{},states:{},stateElements:{}},config:{breakpoints:{"*":{href:c,media:""}},containers:1140,defaultState:l,events:{},grid:{level:1,collapse:c,gutters:[40,0]},lock:{path:c,permanent:b},plugins:{},pollOnce:c,preload:c,reset:Te,RTL:c,viewport:{width:be,height:"",scalable:b}},css:{bm:"*,*:before,*:after{-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box}",n:"html{font-family:sans-serif;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%}body{margin:0}article,aside,details,figcaption,figure,footer,header,hgroup,main,menu,nav,section,summary{display:block}audio,canvas,progress,video{display:inline-block;vertical-align:baseline}audio:not([controls]){display:none;height:0}[hidden],template{display:none}a{background-color:transparent}a:active,a:hover{outline:0}abbr[title]{border-bottom:1px dotted}b,strong{font-weight:700}dfn{font-style:italic}h1{font-size:2em;margin:.67em 0}mark{background:#ff0;color:#000}small{font-size:80%}sub,sup{font-size:75%;line-height:0;position:relative;vertical-align:baseline}sup{top:-.5em}sub{bottom:-.25em}img{border:0}svg:not(:root){overflow:hidden}figure{margin:1em 40px}hr{-moz-box-sizing:content-box;box-sizing:content-box;height:0}pre{overflow:auto}code,kbd,pre,samp{font-family:monospace,monospace;font-size:1em}button,input,optgroup,select,textarea{color:inherit;font:inherit;margin:0}button{overflow:visible}button,select{text-transform:none}button,html input[type=button],input[type=reset],input[type=submit]{-webkit-appearance:button;cursor:pointer}button[disabled],html input[disabled]{cursor:default}button::-moz-focus-inner,input::-moz-focus-inner{border:0;padding:0}input{line-height:normal}input[type=checkbox],input[type=radio]{box-sizing:border-box;padding:0}input[type=number]::-webkit-inner-spin-button,input[type=number]::-webkit-outer-spin-button{height:auto}input[type=search]{-webkit-appearance:textfield;-moz-box-sizing:content-box;-webkit-box-sizing:content-box;box-sizing:content-box}input[type=search]::-webkit-search-cancel-button,input[type=search]::-webkit-search-decoration{-webkit-appearance:none}fieldset{border:1px solid silver;margin:0 2px;padding:.35em .625em .75em}legend{border:0;padding:0}textarea{overflow:auto}optgroup{font-weight:700}table{border-collapse:collapse;border-spacing:0}td,th{padding:0}",r:"html,body,div,span,applet,object,iframe,h1,h2,h3,h4,h5,h6,p,blockquote,pre,a,abbr,acronym,address,big,cite,code,del,dfn,em,img,ins,kbd,q,s,samp,small,strike,strong,sub,sup,tt,var,b,u,i,center,dl,dt,dd,ol,ul,li,fieldset,form,label,legend,table,caption,tbody,tfoot,thead,tr,th,td,article,aside,canvas,details,embed,figure,figcaption,footer,header,hgroup,menu,nav,output,ruby,section,summary,time,mark,audio,video{margin:0;padding:0;border:0;font-size:100%;font:inherit;vertical-align:baseline}article,aside,details,figcaption,figure,footer,header,hgroup,menu,nav,section{display:block}body{line-height:1}ol,ul{list-style:none}blockquote,q{quotes:none}blockquote:before,blockquote:after,q:before,q:after{content:'';content:none}table{border-collapse:collapse;border-spacing:0}body{-webkit-text-size-adjust:none}",gc:function(e){return".\\31 2u"+e+",.\\31 2u\\24"+e+"{width:100%;clear:none;margin-left:0}.\\31 1u"+e+",.\\31 1u\\24"+e+"{width:91.6666666667%;clear:none;margin-left:0}.\\31 0u"+e+",.\\31 0u\\24"+e+"{width:83.3333333333%;clear:none;margin-left:0}.\\39 u"+e+",.\\39 u\\24"+e+"{width:75%;clear:none;margin-left:0}.\\38 u"+e+",.\\38 u\\24"+e+"{width:66.6666666667%;clear:none;margin-left:0}.\\37 u"+e+",.\\37 u\\24"+e+"{width:58.3333333333%;clear:none;margin-left:0}.\\36 u"+e+",.\\36 u\\24"+e+"{width:50%;clear:none;margin-left:0}.\\35 u"+e+",.\\35 u\\24"+e+"{width:41.6666666667%;clear:none;margin-left:0}.\\34 u"+e+",.\\34 u\\24"+e+"{width:33.3333333333%;clear:none;margin-left:0}.\\33 u"+e+",.\\33 u\\24"+e+"{width:25%;clear:none;margin-left:0}.\\32 u"+e+",.\\32 u\\24"+e+"{width:16.6666666667%;clear:none;margin-left:0}.\\31 u"+e+",.\\31 u\\24"+e+"{width:8.3333333333%;clear:none;margin-left:0}.\\31 2u\\24"+e+N+".\\31 1u\\24"+e+N+".\\31 0u\\24"+e+N+".\\39 u\\24"+e+N+".\\38 u\\24"+e+N+".\\37 u\\24"+e+N+".\\36 u\\24"+e+N+".\\35 u\\24"+e+N+".\\34 u\\24"+e+N+".\\33 u\\24"+e+N+".\\32 u\\24"+e+N+".\\31 u\\24"+e+"+*{clear:left;"+M+".\\-11u"+e+"{margin-left:91.6666666667%}.\\-10u"+e+"{margin-left:83.3333333333%}.\\-9u"+e+"{margin-left:75%}.\\-8u"+e+"{margin-left:66.6666666667%}.\\-7u"+e+"{margin-left:58.3333333333%}.\\-6u"+e+"{margin-left:50%}.\\-5u"+e+"{margin-left:41.6666666667%}.\\-4u"+e+"{margin-left:33.3333333333%}.\\-3u"+e+"{margin-left:25%}.\\-2u"+e+"{margin-left:16.6666666667%}.\\-1u"+e+"{margin-left:8.3333333333%}"}},defaults:{breakpoint:{config:l,elements:l,test:l},config_breakpoint:{containers:"100%",grid:{},href:c,media:"",viewport:{}}},events:[],forceDefaultState:c,gridLevelMap:{k:{},v:{}},gridLevelMax:1,isInit:c,isStatic:c,locations:{body:l,head:l,html:l},lcn:"_skel_lock",me:l,plugins:{},sd:"/",stateId:"",vars:{},DOMReady:l,getElementsByClassName:l,indexOf:l,isArray:l,iterate:l,matchesMedia:l,extend:function(e,t){nt[n](t,function(n){nt[j](t[n])?(nt[j](e[n])||(e[n]=[]),nt[W](e[n],t[n])):typeof t[n]==L?(typeof e[n]!=L&&(e[n]={}),nt[W](e[n],t[n])):e[n]=t[n]})},getArray:function(e){return nt[j](e)?e:[e]},parseMeasurement:function(e){var t,n;if("string"!=typeof e)t=[e,"px"];else if("fluid"==e)t=[100,"%"];else{var n;n=e[O](/([0-9\.]+)([^\s]*)/),t=n[s]<3||!n[2]?[parseFloat(e),"px"]:[parseFloat(n[1]),n[2]]}return t},canUseProperty_element:l,canUse:function(t){return nt[e][t]&&nt[e][t].test()},canUseProperty:function(e){nt[D]||(nt[D]=document[w]("div"));var t=nt[D][Oe],n=e[oe](0).toUpperCase()+e.slice(1);return e in t||"Moz"+n in t||"Webkit"+n in t||"O"+n in t||"ms"+n in t},hasActive:function(e){var t=c;return nt[n](e,function(n){t=t||nt[ie](e[n])}),t},isActive:function(e){return-1!==nt[G](nt[o],nt.sd+e)},isLocked:function(){return!!nt[y][K]&&nt[j](nt[y][K])},lock:function(e,n){nt[y][K]=[e,n],document.cookie=nt.lcn+"="+nt[y][K].join("_")+(nt[t][K].path?";path="+nt[t][K].path:"")+(nt[t][K].permanent?";expires=Tue, 19 Jan 2038 03:14:07 GMT":""),window[ze].reload()},unlock:function(){nt[y][K]=l,document.cookie=nt.lcn+"="+(nt[t][K].path?";path="+nt[t][K].path:"")+";expires=Thu, 01 Jan 1970 01:02:03 GMT",window[ze].reload()},useActive:function(e){if(typeof e!==L)return e;var t=l;return nt[n](e,function(n){t===l&&nt[ie](n)&&(t=e[n])}),t},wasActive:function(e){return-1!==nt[G](nt[y].lastStateId,nt.sd+e)},applyRowTransforms:function(e){nt[t].RTL&&(nt.unreverseRows(),e[t][P][Ce]&&nt.reverseRows());var i,o,r="_skel_important",u=[];for(i=1;i<=nt[d];i++)o=nt[a]("important("+nt[T].k[i]+")"),nt[n](o,function(e){u[U](o[e])});o=nt[a]("important(collapse)"),nt[n](o,function(e){u[U](o[e])}),nt[n](u,function(n){if(n!==s){var i,o,a,d=u[n],l=d[S],f=c;if(l)if(d[He](r)&&d[r]!==c){if(i=d[r][de],f=d[r].mode,"c"==f&&e[t][P][Ce]||"l"==f&&d[r][le]<=e[t][P][le])return;l[x](d,nt[t].RTL&&"l"==f?i[Ie]:i[Ve]),d[r]=c}else{if(e[t][P][Ce]&&d[_][O](/important\(collapse\)/)?f="c":d[_][O](/important\((.+)\)/)&&(a=parseInt(nt[T].v[RegExp.$1]))<=e[t][P][le]&&(f="l"),!f)return;for(o=nt[t].RTL?Ve:Ie,i=d[o];i&&"#text"==i.nodeName;)i=i[o];if(!i)return;l[x](d,nt[t].RTL&&"l"==f?l.lastChild:l[Pe]),d[r]={placeholder:i,mode:f,level:a}}}})},reverseRows:function(){var e=nt[a]("row");nt[n](e,function(t){if(t!==s){var n=e[t];if(!n[B]){var i,o=n.children;for(i=1;i<o[s];i++)n[x](o[i],o[0]);n[B]=b}}})},unreverseRows:function(){var e=nt[a]("row");nt[n](e,function(t){if(t!==s){var n=e[t];if(n[B]){var i,o=n.children;for(i=1;i<o[s];i++)n[x](o[i],o[0]);n[B]=c}}})},bind:function(e,t){return nt.on(e,t)},on:function(e,t){var i=e[Ee](/[\s]+/);nt[n](i,function(e){var n=i[e];if(nt.isInit){if("init"==n)return void t();if(n==Re)t();else if("+"==n[oe](0)&&nt[ie](n[E](1)))t();else if("!"==n[oe](0)&&!nt[ie](n[E](1)))return void t()}nt[se][n]||(nt[se][n]=[]),nt[se][n][U](t)})},change:function(e){nt.on(Re,e)},ready:function(e){nt.on("ready",e)},trigger:function(e){if(nt[se][e]&&0!=nt[se][e][s]){nt[n](nt[se][e],function(t){nt[se][e][t]()})}},registerLocation:function(e,t){t[xe]=e==$?function(e,t){t?this[x](e,this[Pe]):this===nt.me[S]?this[x](e,nt.me):this.appendChild(e)}:function(e,t){t?this[x](e,this[Pe]):this.appendChild(e)},nt[R][e]=t},addCachedElementToBreakpoint:function(t,n){nt[e][t]&&nt[e][t][i][U](n)},addCachedElementToState:function(e,t){nt[z][r][e]?nt[z][r][e][U](t):nt[z][r][e]=[t]},attachElement:function(e){var t,n=e[ze],i=c;return e[Se]?b:("^"==n[0]&&(n=n[E](1),i=b),n in nt[R]?(t=nt[R][n],t[xe](e[L],i),e[Se]=b,e.onAttach&&e.onAttach(),b):c)},attachElements:function(e){var t=[],i=[];nt[n](e,function(n){t[e[n][Ze]]||(t[e[n][Ze]]=[]),t[e[n][Ze]][U](e[n])}),nt[n](t,function(e){0!=t[e][s]&&nt[n](t[e],function(n){nt[pe](t[e][n])||i[U](t[e][n])})}),i[s]>0&&nt[H](function(){nt[n](i,function(e){nt[pe](i[e])})})},cacheElement:function(e){return nt[z][i][e.id]=e,e},cacheNewElement:function(e,t,n,i){var o;return t[S]&&t[S].removeChild(t),o=nt[F](e,t,n,i),nt.cacheElement(o)},detachAllElements:function(e){var t={};nt[n](e,function(n){t[e[n].id]=b}),nt[n](nt[z][i],function(e){e in t||nt.detachElement(e)})},detachElement:function(e){var t,n=nt[z][i][e];n[Se]&&(t=n[L],!t[S]||t[S]&&!t[S].tagName||(t[S].removeChild(t),n[Se]=c,n.onDetach&&n.onDetach()))},getCachedElement:function(e){return nt[z][i][e]?nt[z][i][e]:l},newElement:function(e,t,n,i){return{id:e,object:t,location:n,priority:i,attached:c}},removeCachedElementFromBreakpoint:function(t,o){return nt[n](nt[e][t][i],function(n){nt[e][t][i][n].id==o&&delete nt[e][t][i][n]}),b},removeCachedElementFromState:function(e,t){return nt[n](nt[z][r][e],function(n){nt[z][r][e][n].id==t&&delete nt[z][r][e][n]}),b},uncacheElement:function(e){return e in nt[z][i]?(delete nt[z][i][e],b):c},changeState:function(a){var u,d,l,w,x,S,R,C;if(nt[y].lastStateId=nt[o],nt[o]=a,nt[z][ve][nt[o]])d=nt[z][ve][nt[o]];else{nt[z][ve][nt[o]]={config:{},elements:[],values:{}},d=nt[z][ve][nt[o]],u=nt[o]===nt.sd?[]:nt[o][E](1)[Ee](nt.sd),nt[W](d[t],nt[Z][g]),nt[n](u,function(n){nt[W](d[t],nt[e][u[n]][t])}),S="mV"+nt[o],d[t][m].content?R=d[t][m].content:nt.isLocked()?(l=[],l[U]("user-scalable=yes"),nt[y][K][0]&&l[U]("width="+nt[y][K][0]),nt[y][K][1]&&l[U](tt+nt[y][K][1]),R=l.join(","),window.setTimeout(function(){nt.poll()},0)):(l=[],l[U]("user-scalable="+(d[t][m].scalable?"yes":"no")),d[t][m].width&&l[U]("width="+d[t][m].width),d[t][m].height&&l[U](tt+d[t][m].height),d[t][m].width==be&&l[U](ye),R=l.join(",")),(w=nt[f](S))||(w=nt[h](S,nt.newMeta(m,R),ee,4)),d[i][U](w);var A,_,L=c;if(l=nt[ne](d[t][X]),A=l[0],_=l[1],d.values[X]=A+_,S="iC"+d.values[X],"!"==_.substr(-1)&&(L=b,_=_.substr(0,_[s]-1)),(w=nt[f](S))||(w=nt[h](S,nt[k](".container{margin-left:auto;margin-right:auto;width:"+1*A+_+(L?"!important;max-width:none!important;min-width:0!important"+M:M+".container.\\31 25\\25{width:100%;max-width:"+1.25*A+_+";min-width:"+A+_+M+".container.\\37 5\\25{width:"+.75*A+_+M+".container.\\35 0\\25{width:"+.5*A+_+M+".container.\\32 5\\25{width:"+.25*A+_+M)),$,3)),d[i][U](w),S="iGG"+d[t][P][v][0]+"_"+d[t][P][v][1],!(w=nt[f](S))){var j,O;l=nt[ne](d[t][P][v][0]),j=l[0],O=l[1];var N,F;l=nt[ne](d[t][P][v][1]),N=l[0],F=l[1],w=nt[h]("iGG"+d[t][P][v][0]+"_"+d[t][P][v][1],nt[k](".row>*{padding:"+1*N+F+I+1*j+O+M+".row{margin:"+-1*N+F+p+-1*j+O+M+".row.uniform>*{padding:"+1*j+O+I+1*j+O+M+".row.uniform{margin:"+-1*j+O+p+-1*j+O+M+".row.\\32 00\\25>*{padding:"+2*N+F+I+2*j+O+M+".row.\\32 00\\25{margin:"+-2*N+F+p+-2*j+O+M+".row.uniform.\\32 00\\25>*{padding:"+2*j+O+I+2*j+O+M+".row.uniform.\\32 00\\25{margin:"+-2*j+O+p+-2*j+O+M+".row.\\31 50\\25>*{padding:"+1.5*N+F+I+1.5*j+O+M+".row.\\31 50\\25{margin:"+-1.5*N+F+p+-1.5*j+O+M+".row.uniform.\\31 50\\25>*{padding:"+1.5*j+O+I+1.5*j+O+M+".row.uniform.\\31 50\\25{margin:"+-1.5*j+O+p+-1.5*j+O+M+".row.\\35 0\\25>*{padding:"+.5*N+F+I+.5*j+O+M+".row.\\35 0\\25{margin:"+N*-.5+F+p+j*-.5+O+M+".row.uniform.\\35 0\\25>*{padding:"+.5*j+O+I+.5*j+O+M+".row.uniform.\\35 0\\25{margin:"+j*-.5+O+p+j*-.5+O+M+".row.\\32 5\\25>*{padding:"+.25*N+F+I+.25*j+O+M+".row.\\32 5\\25{margin:"+N*-.25+F+p+j*-.25+O+M+".row.uniform.\\32 5\\25>*{padding:"+.25*j+O+I+.25*j+O+M+".row.uniform.\\32 5\\25{margin:"+j*-.25+O+p+j*-.25+O+M+".row.\\30 \\25>*{padding:0}.row.\\30 \\25{margin:0 0 -1px 0}"),$,3)}if(d[i][U](w),d[t][P][le]>1){if(S="igZ"+d[t][P][le],!(w=nt[f](S))){for(R="",x=2;x<=d[t][P][le];x++)R+=nt.css.gc("\\28 "+nt[T].k[x]+"\\29");w=nt[h](S,nt[k](R),$,3)}d[i][U](w)}if(d[t][P][Ce]&&(S="igC"+d[t][X],(w=nt[f](S))||(w=nt[h](S,nt[k](".row:not(.no-collapse)>*{width:100%!important;margin-left:0!important"+M),$,3)),d[i][U](w)),!(nt[me]||(S="iCd"+nt[o],w=nt[f](S)))){R=[],C=[],nt[n](nt[e],function(e){-1!==nt[G](u,e)?R[U](".not-"+e):C[U](".only-"+e)});var D=(R[s]>0?R.join(",")+te:"")+(C[s]>0?C.join(",")+te:"");w=nt[h](S,nt[k](D[q](/\.([0-9])/,Qe)),$,3),d[i][U](w)}nt[n](u,function(o){nt[e][u[o]][t][Ke]&&(S="ss"+u[o],(w=nt[f](S))||(w=nt[h](S,nt.newStyleSheet(nt[e][u[o]][t][Ke]),$,5)),d[i][U](w)),nt[e][u[o]][i][s]>0&&nt[n](nt[e][u[o]][i],function(t){d[i][U](nt[e][u[o]][i][t])})}),nt[z][r][nt[o]]&&(nt[n](nt[z][r][nt[o]],function(e){d[i][U](nt[z][r][nt[o]][e])}),nt[z][r][nt[o]]=[])}nt.detachAllElements(d[i]),nt[fe](d[i]),nt[H](function(){nt[Ae](d)}),nt[y].state=nt[z][ve][nt[o]],nt[y][o]=nt[o],nt[ae](Re),nt[n](nt[e],function(e){nt[ie](e)?nt.wasActive(e)||nt[ae]("+"+e):nt.wasActive(e)&&nt[ae]("-"+e)})},getStateId:function(){if(nt[Ne]&&nt[t].defaultState)return nt[t].defaultState;var i="";return nt[n](nt[e],function(t){nt[e][t].test()&&(i+=nt.sd+t)}),i},poll:function(){var e="";e=nt.getStateId(),""===e&&(e=nt.sd),e!==nt[o]&&(nt[me]?nt.changeState(e):(nt[R][je][_]=nt[R][je][_][q](nt[o][E](1)[q](new RegExp(nt.sd,"g")," "),""),nt.changeState(e),nt[R][je][_]=nt[R][je][_]+" "+nt[o][E](1)[q](new RegExp(nt.sd,"g")," ")," "==nt[R][je][_][oe](0)&&(nt[R][je][_]=nt[R][je][_][E](1))))},updateState:function(){var t,a,c=[];nt[o]!=nt.sd&&(t=nt[o][E](1)[Ee](nt.sd),nt[n](t,function(r){a=nt[e][t[r]],0!=a[i][s]&&nt[n](a[i],function(e){nt[z][ve][nt[o]][i][U](a[i][e]),c[U](a[i][e])})}),nt[z][r][nt[o]]&&(nt[n](nt[z][r][nt[o]],function(e){nt[z][ve][nt[o]][i][U](nt[z][r][nt[o]][e]),c[U](nt[z][r][nt[o]][e])}),nt[z][r][nt[o]]=[]),c[s]>0&&nt[fe](c))},newDiv:function(e){var t=document[w]("div");return t[Be]=e,t},newInline:function(e){var t;return t=document[w](Oe),t.type=we,t[Be]=e,t},newMeta:function(e,t){var n=document[w]("meta");return n.name=e,n.content=t,n},newStyleSheet:function(e){var t=document[w]("link");return t.rel="stylesheet",t.type=we,t[Ke]=e,t},initPlugin:function(e,n){typeof n==L&&nt[W](e[t],n),e.init&&e.init()},registerPlugin:function(e,t){return t?(nt[he][e]=t,t._=this,t.register&&t.register(),void 0):c},init:function(e,i){nt.initConfig(e),nt.initElements(),nt.initEvents(),nt.poll(),i&&typeof i==L&&(nt[t][he]=i),nt[n](nt[he],function(e){nt.initPlugin(nt[he][e],e in nt[t][he]?nt[t][he][e]:l)}),nt.isInit=b,nt[ae]("init")},initAPI:function(){var e,t,i=navigator.userAgent;switch(nt[y][ce]=99,e="other",i[O](/Firefox/)?e="firefox":i[O](/Chrome/)?e="chrome":i[O](/Safari/)&&!i[O](/Chrome/)?e="safari":i[O](/(OPR|Opera)/)?e="opera":i[O](/MSIE ([0-9]+)/)?(e="ie",nt[y][ce]=RegExp.$1):i[O](/Trident\/.+rv:([0-9]+)/)&&(e="ie",nt[y][ce]=RegExp.$1),nt[y].browser=e,nt[y][A]="other",t={ios:"(iPad|iPhone|iPod)",android:"Android",mac:"Macintosh",wp:"Windows Phone",windows:"Windows NT"},nt[n](t,function(e){i[O](new RegExp(t[e],"g"))&&(nt[y][A]=e)}),nt[y][A]){case"ios":i[O](/([0-9_]+) like Mac OS X/),e=parseFloat(RegExp.$1[q]("_",".")[q]("_",""));break;case Ye:i[O](/Android ([0-9\.]+)/),e=parseFloat(RegExp.$1);break;case"mac":i[O](/Mac OS X ([0-9_]+)/),e=parseFloat(RegExp.$1[q]("_",".")[q]("_",""));break;case"wp":i[O](/IEMobile\/([0-9\.]+)/),e=parseFloat(RegExp.$1);break;case"windows":i[O](/Windows NT ([0-9\.]+)/),e=parseFloat(RegExp.$1);break;default:e=99}nt[y].deviceVersion=e,nt[y].isTouch="wp"==nt[y][A]?navigator.msMaxTouchPoints>0:"ontouchstart"in window,nt[y].isMobile="wp"==nt[y][A]||nt[y][A]==Ye||"ios"==nt[y][A],e=document.cookie[Ee](";"),nt[n](e,function(t){var n=e[t][Ee]("=");return n[0][q](/^\s+|\s+$/g,"")==nt.lcn&&n[1][s]>0?void(nt[y][K]=n[1][Ee]("_")):void 0})},initConfig:function(o){var r,a=[];if(o&&e in o||(nt[me]=b,nt[t][m].width="",nt[t][m].height="",nt[t][m].scalable=b),typeof o==L&&(o[e]&&(nt[t][e]={}),nt[W](nt[t],o)),P in nt[t]&&v in nt[t][P]&&!nt[j](nt[t][P][v])&&(nt[t][P][v]=[nt[t][P][v],nt[t][P][v]]),nt[W](nt[Z][g][P],nt[t][P]),nt[d]=Math.max(nt[d],nt[t][P][le]),nt[W](nt[Z][g][m],nt[t][m]),nt[Z][g][X]=nt[t][X],nt[n](nt[t][e],function(n){var o,r,c,u={};nt[W](u,nt[t][e][n]),Ke in u||(u[Ke]=nt[Z][g][Ke]),_e in u||(u[_e]=nt[Z][g][_e]),"range"in u&&(r=u.range,"*"==r?c="":"-"==r[oe](0)?c="(max-width: "+parseInt(r[E](1))+"px)":"-"==r[oe](r[s]-1)?c=Le+parseInt(r[E](0,r[s]-1))+"px)":-1!=nt[G](r,"-")&&(r=r[Ee]("-"),c=Le+parseInt(r[0])+"px) and (max-width: "+parseInt(r[1])+"px)"),u[_e]=c),P in u&&(v in u[P]&&!nt[j](u[P][v])&&(u[P][v]=[u[P][v],u[P][v]]),"zoom"in u[P]&&(u[P][le]=u[P].zoom),le in u[P]&&(nt[d]=Math.max(nt[d],u[P][le]))),nt[t][e][n]=u,o={},nt[W](o,nt[Z].breakpoint),o[t]=nt[t][e][n],o.test=function(){return nt[V](u[_e])},o[i]=[],nt[t].preload&&o[t][Ke]&&a[U](o[t][Ke]),nt[e][n]=o,nt.breakpointList[U](n)}),nt[d]>1||nt[me])for(r=2;r<=nt[d];r++)nt[T].k[r]=nt[T].v[r]=r;else nt[n](nt[t][e],function(n){var i=nt[t][e][n];nt[d]++,P in i||(i[P]={}),i[P][le]=nt[d],nt[T].k[nt[d]]=n,nt[T].v[n]=nt[d]});nt[n](nt[t][se],function(e){nt.on(e,nt[t][se][e])}),a[s]>0&&"file:"!=window[ze].protocol&&nt[H](function(){var e=(document[u]($)[0],new XMLHttpRequest);nt[n](a,function(t){e.open("GET",a[t],c),e.send("")})})},initElements:function(){var e=[];switch(e[U](nt[F]("mV",nt.newMeta(m,ye),ee,1)),nt[t].reset){case"full":e[U](nt[F]("iR",nt[k](nt.css.r),ee,2));break;case Te:e[U](nt[F]("iN",nt[k](nt.css.n),ee,2))}e[U](nt[F]("iBM",nt[k](nt.css.bm),ee,1)),e[U](nt[F]("iG",nt[k]('.row{border-bottom:solid 1px transparent}.row>*{float:left}.row:after,.row:before{content:"";display:block;clear:both;height:0}.row.uniform>*>:first-child{margin-top:0}.row.uniform>*>:last-child{margin-bottom:0}'+nt.css.gc("")),$,3)),nt[fe](e)},initEvents:function(){!nt[t].pollOnce&&!nt[me]&&(nt.on(Me,function(){nt.poll()}),nt.on(C,function(){nt.poll()})),"ios"==nt[y][A]&&nt[H](function(){nt.on(C,function(){var e=document[u]("input");nt[n](e,function(t){e[t][qe]=e[t][de],e[t][de]=""}),window.setTimeout(function(){nt[n](e,function(t){e[t][de]=e[t][qe]})},100)})}),nt[H](function(){nt[ae]("ready")}),window[Je]&&nt.on(Me,window[Je]),window[Je]=function(){nt[ae](Me)},window[J]&&nt.on(C,window[J]),window[J]=function(){nt[ae](C)}},initUtilityMethods:function(){document[Y]?!function(e,t){nt[H]=t()}(Xe,function(){function e(e){for(r=1;e=n.shift();)e()}var t,n=[],i=document,o=ge,r=/^loaded|^c/.test(i[et]);return i[Y](o,t=function(){i[ke](o,t),e()}),function(e){r?e():n[U](e)}}):!function(e,t){nt[H]=t()}(Xe,function(e){function t(e){for(m=1;e=i.shift();)e()}var n,i=[],o=!1,r=document,a=r[ue],c=a.doScroll,u=ge,s=Y,d="onreadystatechange",l=et,f=c?/^loaded|^c/:/^loaded|c/,m=f.test(r[l]);return r[s]&&r[s](u,n=function(){r[ke](u,n,o),t()},o),c&&r.attachEvent(d,n=function(){/^c/.test(r[l])&&(r.detachEvent(d,n),t())}),e=c?function(t){self!=top?m?t():i[U](t):function(){try{a.doScroll("left")}catch(n){return setTimeout(function(){e(t)},50)}t()}()}:function(e){m?e():i[U](e)}}),nt[a]=document[a]?function(e){return document[a](e)}:function(e){var t=document;return t[$e]?t[$e](("."+e[q](" "," ."))[q](/\.([0-9])/,Qe)):[]},nt[G]=Array[Ue][G]?function(e,t){return e[G](t)}:function(e,t){if("string"==typeof e)return e[G](t);var n,i,o=t?t:0;if(!this)throw new TypeError;if(i=this[s],0===i||o>=i)return-1;for(0>o&&(o=i-Math.abs(o)),n=o;i>n;n++)if(this[n]===e)return n;return-1},nt[j]=Array[j]?function(e){return Array[j](e)}:function(e){return"[object Array]"===Object[Ue].toString.call(e)},nt[n]=Object.keys?function(e,t){if(!e)return[];var n,i=Object.keys(e);for(n=0;i[n];n++)t(i[n])}:function(e,t){if(!e)return[];var n;for(n in e)Object[Ue][He].call(e,n)&&t(n)},window.matchMedia?nt[V]=function(e){return""==e?b:window.matchMedia(e).matches}:window.styleMedia||window[_e]?nt[V]=function(e){if(""==e)return b;var t=window.styleMedia||window[_e];return t.matchMedium(e||"all")}:window[Q]?nt[V]=function(e){if(""==e)return b;var t=document[w](Oe),n=document[u]("script")[0],i=l;t.type=we,t.id="matchmediajs-test",n[S][x](t,n),i=Q in window&&window[Q](t,l)||t.currentStyle;var o="@media "+e+"{ #matchmediajs-test { width: 1px; } }";return t.styleSheet?t.styleSheet.cssText=o:t.textContent=o,"1px"===i.width}:(nt[Ne]=b,nt[V]=function(e){if(""==e)return b;var t,n,i,o,r={"min-width":l,"max-width":l},a=c;n=e[Ee](/\s+and\s+/);for(o in n)t=n[o],"("==t[oe](0)&&(t=t[E](1,t[s]-1),i=t[Ee](/:\s+/),2==i[s]&&(r[i[0][q](/^\s+|\s+$/g,"")]=parseInt(i[1]),a=b));if(!a)return c;var u=document[ue].clientWidth,d=document[ue].clientHeight;return r[Ge]!==l&&u<r[Ge]||r[We]!==l&&u>r[We]||r[Fe]!==l&&d<r[Fe]||r[De]!==l&&d>r[De]?c:b})},preInit:function(){var e=document[u]("script");nt.me=e[e[s]-1],nt.initUtilityMethods(),nt.initAPI(),nt[re](je,document[u](je)[0]),nt[re]($,document[u]($)[0]),nt[H](function(){nt[re]("body",document[u]("body")[0])}),"ie"==nt[y].browser&&nt[y][ce]>=10&&nt[pe](nt[F]("msie-viewport-fix",nt[k]("@-ms-viewport{width:device-width}"),ee,1))}};return nt.preInit(),nt[y][ce]<9&&(nt[Ae]=function(e){},nt[k]=function(e){var t;return t=document[w]("span"),t[Be]='&nbsp;<style type="text/css">'+e+"</style>",t}),nt}();!function(e,t){"function"==typeof define&&define.amd?define([],t):"object"==typeof exports?module.exports=t():e.skel=t()}(this,function(){return skel});
skel.registerPlugin("layers",function(e){function t(e,t,s){var a,r;this.id=e,this.index=s,this[n]={breakpoints:I,states:I,position:I,side:I,animation:we,orientation:we,width:0,height:0,zIndex:this.index,html:"",hidden:P,exclusive:N,resetScroll:N,resetForms:N,swipeToHide:N,clickToHide:P},i._.extend(this[n],t),this[X]=i._.newDiv(this[n][Xe]),this[X].id=e,this[X]._layer=this,this[o]=I,this[me]=I,this[xe]=I,this[D]=P,r=i._.newElement(this.id,this[X],ce,1),r.onAttach=function(){var e=this[Qe]._layer;e[ee]()||e.init(),e.resume()},r.onDetach=function(){var e=this[Qe]._layer;e.suspend()},this[n].states&&this[n].states!=i._.sd?(i._.cacheElement(r),a=i._[ot](this[n].states),i._[Pe](a,function(e){i._.addCachedElementToState(a[e],r)})):this[n].breakpoints?(i._.cacheElement(r),a=i._[ot](this[n].breakpoints),i._[Pe](a,function(e){i._.addCachedElementToBreakpoint(a[e],r)})):i._.attachElement(r)}var i,n="config",s="_skel_layers_translateOrigin",r="cache",o="$element",c="_skel_layers_translate",l="visibleWrapper",h="_skel_layers_resetForms",f="_skel_layers_resume",d="_skel_layers_promote",u="exclusiveLayer",p="_skel_layers_demote",v="moveToVisibleWrapper",_="setTimeout",w="moveToHiddenWrapper",k="right",y="bottom",m="position",b="useActive",g="width",x="css",I=null,T="center",z="_skel_layers_suspend",H="prototype",W="left",E="wrapper",C="skel-layers-layer-z-index",V="children",M="_skel_layers_init",S="skel-layers-moved",L="overflow-x",B="hiddenWrapper",P=!1,F="scrollTop",X="element",j=".skel-layers-fixed:not(.skel-layers-moved)",A="transform",R="top",Y="height",$="length",D="visible",O="touchstart.lock click.lock scroll.lock",Z='<div id="skel-layers-placeholder-',N=!0,Q="resetForms",q="-webkit-",G="recalcW",J="skel-layers-exclusiveVisible",K="padding-bottom",U="-webkit-tap-highlight-color",ee="isInitialized",te="animation",ie="originalEvent",ne="hidden",se="skel-layers-layer-index",ae="z-index",re="skel-layers-layer-position",oe="unlockView",ce="skel_layers_hiddenWrapper",le="#skel-layers-placeholder-",he="animations",fe="_skel_layers_initializeCell",de="layers",ue="append",pe="resize.lock scroll.lock",ve="speed",_e="registerLocation",we="none",ke="undefined",ye="orientationchange.lock",me="touchPosX",be="window",ge="stopPropagation",xe="touchPosY",Ie="positions",Te="-moz-",ze="blur",He="_skel_layers_expandCell",We="preventDefault",Ee="_skel_layers_hasParent",Ce="attr",Ve="find",Me="deviceType",Se="-ms-",Le="addClass",Be="DOMReady",Pe="iterate",Fe="lockView",Xe="html",je="auto",Ae="hide",Re="_skel_layers_xcss",Ye="transformBreakpoints",$e="-o-",De="rgba(0,0,0,0)",Oe="trigger",Ze="removeClass",Ne="appendTo",Qe="object",qe="cell-size",Ge="-",Je="body",Ke="px",Ue="recalcH",et="touches",tt="side",it="isVisible",nt="relative",st="show",at="transformTest",rt="*",ot="getArray",ct="#",lt="x",ht="htmlbody";return typeof e==ke?P:(e.fn[p]=function(){var t,i;if(this[$]>1){for(t=0;t<this[$];t++)e(this[t])[p]();return e(this)}return i=e(this),i[x](ae,i.data(C)).data(C,""),i},e.fn[He]=function(){var t=e(this),i=t.parent(),n=12;i[V]().each(function(){var t=e(this),i=t[Ce]("class");i&&i.match(/(\s+|^)([0-9]+)u(\s+|$)/)&&(n-=parseInt(RegExp.$2))}),n>0&&(t[fe](),t[x](g,(t.data(qe)+n)/12*100+"%"))},e.fn[Ee]=function(){return e(this).parents()[$]>0},e.fn[fe]=function(){var t=e(this);t[Ce]("class").match(/(\s+|^)([0-9]+)u(\s+|$)/)&&t.data(qe,parseInt(RegExp.$2))},e.fn[d]=function(t){var s,a,r;if(this[$]>1){for(s=0;s<this[$];s++)e(this[s])[d](t);return e(this)}return a=e(this),isNaN(r=parseInt(a.data(se)))&&(r=0),a.data(C,a[x](ae))[x](ae,i[n].baseZIndex+r+(t?t:1)),a},e.fn[h]=function(){var t=e(this);return e(this)[Ve]("form").each(function(){this.reset()}),t},e.fn[Re]=function(t,i){return e(this)[x](t,i)[x](Te+t,Te+i)[x](q+t,q+i)[x]($e+t,$e+i)[x](Se+t,Se+i)},e.fn._skel_layers_xcssProperty=function(t,i){return e(this)[x](t,i)[x](Te+t,i)[x](q+t,i)[x]($e+t,i)[x](Se+t,i)},e.fn._skel_layers_xcssValue=function(t,i){return e(this)[x](t,i)[x](t,Te+i)[x](t,q+i)[x](t,$e+i)[x](t,Se+i)},t[H][he]={none:{show:function(e){var t=e[n],i=e[o];i[F](0)[d](t.zIndex)[st](),t[Q]&&i[h](),e[v]()},hide:function(e){var t=(e[n],e[o]);t[Ae]()[p](),e[w]()}},overlayX:{show:function(e){var t=e[n],s=e[o];s[F](0)[d](t.zIndex)[x](t[tt],Ge+i[G](i._[b](t[g]))+Ke)[st](),t[Q]&&s[h](),i[Fe](lt),e[v](),window[_](function(){s[c]((t[tt]==k?Ge:"")+i[G](i._[b](t[g])),0)},50)},hide:function(e){var t=(e[n],e[o]);t[Ve](rt)[Oe](ze,[N]),t[s](),window[_](function(){i[oe](lt),e[w](),t[p]()[Ae]()},i[n][ve]+50)}},overlayY:{show:function(e){var t=e[n],s=e[o];s[F](0)[d](t.zIndex)[x](t[tt],Ge+i[G](i._[b](t[Y]))+Ke)[st](),t[Q]&&s[h](),i[Fe]("y"),e[v](),window[_](function(){s[c](0,(t[tt]==y?Ge:"")+i[G](i._[b](t[Y])))},50)},hide:function(e){var t=(e[n],e[o]);t[Ve](rt)[Oe](ze,[N]),t[s](),window[_](function(){i[oe]("y"),e[w](),t[p]()[Ae]()},i[n][ve]+50)}},pushX:{show:function(e){var t=e[n],s=e[o],a=i[r][E].add(i[r][l][V]());s[F](0)[x](t[tt],Ge+i[G](i._[b](t[g]))+Ke)[st](),t[Q]&&s[h](),a[d](),i[Fe](lt),e[v](),window[_](function(){s.add(a)[c]((t[tt]==k?Ge:"")+i[G](i._[b](t[g])),0)},50)},hide:function(e){var t=(e[n],e[o]),a=i[r][E].add(i[r][l][V]());t[Ve](rt)[Oe](ze,[N]),t.add(a)[s](),window[_](function(){i[oe](lt),t[Ae](),e[w](),a[p]()},i[n][ve]+50)}},pushY:{show:function(e){var t=e[n],s=e[o],a=i[r][E].add(i[r][l][V]());s[F](0)[x](t[tt],Ge+i[Ue](i._[b](t[Y]))+Ke)[st](),t[Q]&&s[h](),i[Fe]("y"),e[v](),window[_](function(){s.add(a)[c](0,(t[tt]==y?Ge:"")+i[Ue](i._[b](t[Y])))},50)},hide:function(e){var t=(e[n],e[o]),a=i[r][E].add(i[r][l][V]());t[Ve](rt)[Oe](ze,[N]),t.add(a)[s](),window[_](function(){i[oe]("y"),t[Ae](),e[w]()},i[n][ve]+50)}},revealX:{show:function(e){var t=e[n],s=e[o],a=i[r][E].add(i[r][l][V]());s[F](0)[st](),t[Q]&&s[h](),a[d](),i[Fe](lt),e[v](),window[_](function(){a[c]((t[tt]==k?Ge:"")+i[G](i._[b](t[g])),0)},50)},hide:function(e){var t=(e[n],e[o]),a=i[r][E].add(i[r][l][V]());t[Ve](rt)[Oe](ze,[N]),a[s](),window[_](function(){i[oe](lt),t[Ae](),a[p](),e[w]()},i[n][ve]+50)}}},t[H][Ie]={"top-left":{v:R,h:W,side:W},"top-right":{v:R,h:k,side:k},top:{v:R,h:T,side:R},"top-center":{v:R,h:T,side:R},"bottom-left":{v:y,h:W,side:W},"bottom-right":{v:y,h:k,side:k},bottom:{v:y,h:T,side:y},"bottom-center":{v:y,h:T,side:y},left:{v:T,h:W,side:W},"center-left":{v:T,h:W,side:W},right:{v:T,h:k,side:k},"center-right":{v:T,h:k,side:k}},t[H][st]=function(){var e,t,s,a,c;if(this[D])return void i[r][l][ue](this[X]);switch(e=this,t=this[n],s=i._[b](t[te]),a=this[o],a[x](g,i._[b](t[g]))[x](Y,i._[b](t[Y])),"ios"==i._.vars[Me]&&("100%"==t[Y]&&!t[ne]&&a[x](Y,"-webkit-calc("+i._[b](t[Y])+" + 70px)"),a.on(ze,"input,select,textarea",function(t,n){n||window[_](function(){i[r][B][ue](e[X]),window[_](function(){i[r][l][ue](e[X])},500)},500)})),c=this[Ie][t[m]],a[Le]("skel-layer-"+t[m]).data(re,t[m]),c.v){case R:a[x](R,0);break;case y:a[x](y,0);break;case T:a[x](R,"50%")[x]("margin-top",Ge+i.getHalf(t[Y]))}switch(c.h){case W:a[x](W,0);break;case k:a[x](k,0);break;case T:a[x](W,"50%")[x]("margin-left",Ge+i.getHalf(t[g]))}this[he][s][st](this),t[ne]&&t.exclusive&&(i[r][Je][Le](J),i[r][u]=this),this[D]=N},t[H][Ae]=function(){var e,t;return this[D]?(e=this[n],t=i._[b](e[te]),t in this[he]||(t=we),this[he][t][Ae](this),e[ne]&&e.exclusive&&i[r][u]===this&&(i[r][Je][Ze](J),i[r][u]=I),this[D]=P,void 0):void i[r][B][ue](this[X])},t[H].init=function(){var t=this[n],s=e(this[X]),a=this;switch(s[M](),s[Ve](rt).each(function(){i.parseInit(e(this))}),s[Le]("skel-layer").data(se,this.index)[x](ae,i[n].baseZIndex)[x](m,"fixed")[x]("-ms-overflow-style","-ms-autohiding-scrollbar")[x]("-webkit-overflow-scrolling","touch")[Ae](),t.orientation){case"vertical":s[x]("overflow-y",je);break;case"horizontal":s[x](L,je);break;case we:}t[m]&&t[m]in this[Ie]||(t[m]="top-left"),t[tt]||(t[tt]=this[Ie][t[m]][tt]),t[te]&&(typeof t[te]===Qe||t[te]in this[he])||(t[te]=we),t.clickToHide&&s[Ve]("a")[x](U,De).on("click.skel-layers",function(t){var s,r,o=e(this);o.hasClass("skel-layers-ignore")||(t[We](),t[ge](),a[Ae](),o.hasClass("skel-layers-ignoreHref")||(s=o[Ce]("href"),r=o[Ce]("target"),typeof s!==ke&&""!=s&&window[_](function(){"_blank"==r&&"wp"!=i._.vars[Me]?window.open(s):window.location.href=s},i[n][ve]+10)))}),s.on("touchstart",function(e){a[me]=e[ie][et][0].pageX,a[xe]=e[ie][et][0].pageY}).on("touchmove",function(e){var i,n,r,o,c,l,h;if(a[me]!==I&&a[xe]!==I){if(i=a[me]-e[ie][et][0].pageX,n=a[xe]-e[ie][et][0].pageY,r=s.outerHeight(),o=s.get(0).scrollHeight-s[F](),t[ne]&&t.swipeToHide){switch(c=P,l=20,h=50,t[tt]){case W:c=l>n&&n>-1*l&&i>h;break;case k:c=l>n&&n>-1*l&&-1*h>i;break;case R:c=l>i&&i>-1*l&&n>h;break;case y:c=l>i&&i>-1*l&&-1*h>n}if(c)return a[me]=I,a[xe]=I,a[Ae](),P}return 0==s[F]()&&0>n||o>r-2&&r+2>o&&n>0?P:void 0}}),this[o]=s},t[H][ee]=function(){return this[o]!==I},t[H][it]=function(){return this[o].is(":visible")},t[H][v]=function(){i[r][l][ue](this[o])},t[H][w]=function(){this[o][Ee]()&&i[r][B][ue](this[o])},t[H].resume=function(t){this[ee]()&&(this[o][Ve](rt).each(function(){i.parseResume(e(this))}),this[n][ne]||this[st](t))},t[H].suspend=function(){this[ee]()&&(this[o][s](),this[o][Ve](rt).each(function(){i.parseSuspend(e(this))}),this[D]&&this[Ae]())},i={cache:{visibleWrapper:I,body:I,exclusiveLayer:I,html:I,htmlbody:I,hiddenWrapper:I,layers:{},window:I,wrapper:I},config:{baseZIndex:1e4,layers:{},speed:250,transform:N,transformBreakpoints:I,transformTest:I},eventType:"click touchend",show:function(e){i._[Be](function(){i[r][de][e][st]()})},hide:function(e){i._[Be](function(){i[r][de][e][Ae]()})},toggle:function(e){i._[Be](function(){var t=i[r][de][e];t[it]()?t[Ae]():t[st]()})},getBaseFontSize:function(){return i._.vars.IEVersion<9?16.5:parseFloat(getComputedStyle(i[r][Je].get(0)).fontSize)},getHalf:function(e){var t=parseInt(e);return"string"==typeof e&&"%"==e.charAt(e[$]-1)?Math.floor(t/2)+"%":Math.floor(t/2)+Ke},lockView:function(e){i[r][be]._skel_layers_scrollPos=i[r][be][F](),e==lt&&i[r][ht][x](L,ne),i[r][E].on(O,function(e){e[We](),e[ge](),i[r][u]&&i[r][u][Ae]()}),i[r][be].on(ye,function(e){i[r][u]&&i[r][u][Ae]()}),i._.vars.isMobile||window[_](function(){i[r][be].on(pe,function(e){i[r][u]&&i[r][u][Ae]()})},i[n][ve]+50)},parseInit:function(t){var n,s,a,o,c=t.get(0),l=t[Ce]("data-action"),h=t[Ce]("data-args");switch(l&&h&&(h=h.split(",")),l){case"toggleLayer":case"layerToggle":t[x](U,De)[x]("cursor","pointer"),n=function(t){if(t[We](),t[ge](),i[r][u])return i[r][u][Ae](),P;var n=(e(this),i[r][de][h[0]]);n[it]()?n[Ae]():n[st]()},t.on(i.eventType,n);break;case"navList":a=e(ct+h[0]),n=a[Ve]("a"),s=[],n.each(function(){var t,i,n=e(this);t=Math.max(0,n.parents("li")[$]-1),i=n[Ce]("href"),s.push('<a class="link depth-'+t+'"'+(typeof i!==ke&&""!=i?' href="'+i+'"':"")+'><span class="indent-'+t+'"></span>'+n.text()+"</a>")}),s[$]>0&&t[Xe]("<nav>"+s.join("")+"</nav>");break;case"copyText":a=e(ct+h[0]),t[Xe](a.text());break;case"copyHTML":a=e(ct+h[0]),t[Xe](a[Xe]());break;case"moveElementContents":a=e(ct+h[0]),c[f]=function(){a[V]().each(function(){var i=e(this);t[ue](i),i[Le](S)})},c[z]=function(){t[V]().each(function(){var t=e(this);a[ue](t),t[Ze](S),i.refresh(t)})},c[f]();break;case"moveElement":a=e(ct+h[0]),c[f]=function(){e(Z+a[Ce]("id")+'" />').insertBefore(a),t[ue](a),a[Le](S)},c[z]=function(){e(le+a[Ce]("id")).replaceWith(a),a[Ze](S),i.refresh(a)},c[f]();break;case"moveCell":a=e(ct+h[0]),o=e(ct+h[1]),c[f]=function(){e(Z+a[Ce]("id")+'" />').insertBefore(a),t[ue](a),a[x](g,je),o&&o[He]()},c[z]=function(){e(le+a[Ce]("id")).replaceWith(a),a[x](g,""),o&&o[x](g,"")},c[f]()}},parseResume:function(e){var t=e.get(0);t[f]&&t[f]()},parseSuspend:function(e){var t=e.get(0);t[z]&&t[z]()},recalc:function(e,t){var n,s=i._.parseMeasurement(e);switch(s[1]){case"%":n=Math.floor(t*(s[0]/100));break;case"em":n=i.getBaseFontSize()*s[0];break;default:case Ke:n=s[0]}return n},recalcH:function(t){return i.recalc(t,e(window)[Y]())},recalcW:function(t){return i.recalc(t,e(window)[g]())},refresh:function(t){var s;i[n][A]&&(s=t?t.filter(j):e(j),s[M]()[Ne](i[r][l]))},unlockView:function(e){e==lt&&i[r][ht][x](L,D),i[r][E].off(O),i[r][be].off(ye),i._.vars.isMobile||i[r][be].off(pe)},init:function(){n in i[n]&&(i._.extend(i[n],i[n][n]),delete i[n][n]),i._[Pe](i[n],function(e){i[n][e]&&typeof i[n][e]==Qe&&m in i[n][e]&&(i[n][de][e]=i[n][e],delete i[n][e])}),i[n][at]&&(i[n][A]=i[n][at]()),i[n][A]&&(("android"==i._.vars[Me]&&i._.vars.deviceVersion<4||"wp"==i._.vars[Me])&&(i[n][A]=P),i._.vars.IEVersion<10&&(i[n][A]=P),i[n][Ye]&&!i._.hasActive(i._[ot](i[n][Ye]))&&(i[n][A]=P)),i.initObjects(),i.initTransforms(),i._[Be](function(){i.initLayers(),i.initIncludes(),i._.updateState(),i.refresh()})},initIncludes:function(){e(".skel-layers-include").each(function(){i.parseInit(e(this))})},initLayers:function(){var s,a=1;i._[Pe](i[n][de],function(o){var c;m in i[n][de][o]&&(i[n][de][o][Xe]||0!=(c=e(ct+o))[$])&&(s=new t(o,i[n][de][o],a++),i[r][de][o]=s,c&&(c[V]()[Ne](s[X]),c.remove()))})},initObjects:function(){i[r][be]=e(window),i._[Be](function(){i[r][Xe]=e(Xe),i[r][Je]=e(Je),i[r][ht]=e("html,body"),i[r][Je].wrapInner('<div id="skel-layers-wrapper" />'),i[r][E]=e("#skel-layers-wrapper"),i[r][E][x](m,nt)[x](W,"0")[x](k,"0")[x](R,"0")[M](),i[r][B]=e('<div id="skel-layers-hiddenWrapper" />')[Ne](i[r][Je]),i[r][B][x](Y,"100%"),i[r][l]=e('<div id="skel-layers-visibleWrapper" />')[Ne](i[r][Je]),i[r][l][x](m,nt),i._[_e](ce,i[r][B][0]),i._[_e]("skel_layers_visibleWrapper",i[r][l][0]),i._[_e]("skel_layers_wrapper",i[r][E][0]),e("[autofocus]").focus()})},initTransforms:function(){if(i[n][A])e.fn[s]=function(){return e(this)[c](0,0)},e.fn[c]=function(t,i){return e(this)[x](A,"translate("+t+"px, "+i+"px)")},e.fn[M]=function(){return e(this)[x]("backface-visibility",ne)[x]("perspective","500")[Re]("transition","transform "+i[n][ve]/1e3+"s ease-in-out")};else{var o=[];i[r][be].resize(function(){if(0!=i[n][ve]){var e=i[n][ve];i[n][ve]=0,window[_](function(){i[n][ve]=e,o=[]},e)}}),e.fn[s]=function(){for(var t=0;t<this[$];t++){var s=this[t],a=e(s);o[s.id]&&a.animate(o[s.id],i[n][ve],"swing",function(){i._[Pe](o[s.id],function(e){a[x](e,o[s.id][e])}),i[r][Je][x](L,D),i[r][E][x](g,je)[x](K,0)})}return e(this)},e.fn[c]=function(s,c){var l,h,f;for(s=parseInt(s),c=parseInt(c),0!=s?(i[r][Je][x](L,ne),i[r][E][x](g,i[r][be][g]())):h=function(){i[r][Je][x](L,D),i[r][E][x](g,je)},0>c?i[r][E][x](K,Math.abs(c)):f=function(){i[r][E][x](K,0)},l=0;l<this[$];l++){var d,u=this[l],p=e(u);if(!o[u.id])if(d=t[H][Ie][p.data(re)]){switch(o[u.id]={},d.v){case T:case R:o[u.id][R]=parseInt(p[x](R));break;case y:o[u.id][y]=parseInt(p[x](y))}switch(d.h){case T:case W:o[u.id][W]=parseInt(p[x](W));break;case k:o[u.id][k]=parseInt(p[x](k))}}else d=p[m](),o[u.id]={top:d[R],left:d[W]};a={},i._[Pe](o[u.id],function(e){var t;switch(e){case R:t=i[Ue](o[u.id][e])+c;break;case y:t=i[Ue](o[u.id][e])-c;break;case W:t=i[G](o[u.id][e])+s;break;case k:t=i[G](o[u.id][e])-s}a[e]=t}),p.animate(a,i[n][ve],"swing",function(){h&&h(),f&&f()})}return e(this)},e.fn[M]=function(){return e(this)[x](m,"absolute")}}}})}(jQuery));
!function(e){skel.init({reset:"full",breakpoints:{global:{range:"*",href:"/themes/alpha/css/style.css",containers:"60em",grid:{gutters:["2em",0]}},wide:{range:"-1680",href:"/themes/alpha/css/style-wide.css"},normal:{range:"-1280",href:"/themes/alpha/css/style-normal.css",viewport:{scalable:!1}},narrow:{range:"-980",href:"/themes/alpha/css/style-narrow.css",containers:"90%"},narrower:{range:"-840",href:"/themes/alpha/css/style-narrower.css",containers:"90%!",grid:{zoom:2}},mobile:{range:"-736",href:"/themes/alpha/css/style-mobile.css",containers:"100%!",grid:{zoom:2}},mobilep:{range:"-480",href:"/themes/alpha/css/style-mobilep.css",grid:{zoom:5,gutters:["1em",0]}}},plugins:{layers:{config:{transformTest:function(){return skel.vars.isMobile}},navPanel:{animation:"pushX",breakpoints:"narrower",clickToHide:!0,height:"100%",hidden:!0,html:'<div data-action="navList" data-args="nav"></div>',orientation:"vertical",position:"top-left",side:"left",width:250},navButton:{breakpoints:"narrower",height:"4em",html:'<span class="toggle" data-action="toggleLayer" data-args="navPanel"></span>',position:"top-left",side:"top",width:"6em"}}}}),e(function(){var a=e(window),t=(e("body"),e("#header")),r=e("#banner"),n=e("form");n.length>0&&(n.find(".form-button-submit").on("click",function(){return e(this).parents("form").submit(),!1}),skel.vars.IEVersion<10&&(e.fn.n33_formerize=function(){var a=new Array,t=e(this);return t.find("input[type=text],textarea").each(function(){var a=e(this);(""==a.val()||a.val()==a.attr("placeholder"))&&(a.addClass("formerize-placeholder"),a.val(a.attr("placeholder")))}).blur(function(){var a=e(this);a.attr("name").match(/_fakeformerizefield$/)||""==a.val()&&(a.addClass("formerize-placeholder"),a.val(a.attr("placeholder")))}).focus(function(){var a=e(this);a.attr("name").match(/_fakeformerizefield$/)||a.val()==a.attr("placeholder")&&(a.removeClass("formerize-placeholder"),a.val(""))}),t.find("input[type=password]").each(function(){var a=e(this),t=e(e("<div>").append(a.clone()).remove().html().replace(/type="password"/i,'type="text"').replace(/type=password/i,"type=text"));""!=a.attr("id")&&t.attr("id",a.attr("id")+"_fakeformerizefield"),""!=a.attr("name")&&t.attr("name",a.attr("name")+"_fakeformerizefield"),t.addClass("formerize-placeholder").val(t.attr("placeholder")).insertAfter(a),""==a.val()?a.hide():t.hide(),a.blur(function(a){a.preventDefault();var t=e(this),r=t.parent().find("input[name="+t.attr("name")+"_fakeformerizefield]");""==t.val()&&(t.hide(),r.show())}),t.focus(function(a){a.preventDefault();var t=e(this),r=t.parent().find("input[name="+t.attr("name").replace("_fakeformerizefield","")+"]");t.hide(),r.show().focus()}),t.keypress(function(e){e.preventDefault(),t.val("")})}),t.submit(function(){e(this).find("input[type=text],input[type=password],textarea").each(function(a){var t=e(this);t.attr("name").match(/_fakeformerizefield$/)&&t.attr("name",""),t.val()==t.attr("placeholder")&&(t.removeClass("formerize-placeholder"),t.val(""))})}).bind("reset",function(t){t.preventDefault(),e(this).find("select").val(e("option:first").val()),e(this).find("input,textarea").each(function(){var a,t=e(this);switch(t.removeClass("formerize-placeholder"),this.type){case"submit":case"reset":break;case"password":t.val(t.attr("defaultValue")),a=t.parent().find("input[name="+t.attr("name")+"_fakeformerizefield]"),""==t.val()?(t.hide(),a.show()):(t.show(),a.hide());break;case"checkbox":case"radio":t.attr("checked",t.attr("defaultValue"));break;case"text":case"textarea":t.val(t.attr("defaultValue")),""==t.val()&&(t.addClass("formerize-placeholder"),t.val(t.attr("placeholder")));break;default:t.val(t.attr("defaultValue"))}}),window.setTimeout(function(){for(x in a)a[x].trigger("formerize_sync")},10)}),t},n.n33_formerize())),e("#nav > ul").dropotron({alignment:"right"}),!skel.vars.isMobile&&t.hasClass("alt")&&r.length>0&&a.on("load",function(){r.scrollwatch({delay:0,range:.5,anchor:"top",on:function(){t.addClass("alt reveal")},off:function(){t.removeClass("alt")}})})}),e(document).ready(function(){e.localScroll({target:"body",hash:!0})})}(jQuery);