...
@section('content-header')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">{{ trans('module::modules.title.edit module') }}</li>
    </ol>
@stop
...
@section('content')
    {!! Form::open(['route' => ['admin.module.module.update', $module->id], 'method' => 'put']) !!}
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('module::admin.modules.partials.edit-fields', ['lang' => $locale])
                        </div>
                    @endforeach
